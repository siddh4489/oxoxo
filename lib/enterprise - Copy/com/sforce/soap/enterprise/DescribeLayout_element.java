...
public class DescribeLayout_element implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo layoutName__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","layoutName","http://www.w3.org/2001/XMLSchema","string",1,1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, layoutName__typeInfo)) {
      setLayoutName((java.lang.String)__typeMapper.readString(__in, layoutName__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(layoutName)+"'\n");

...
public class DescribeSoftphoneLayoutCallType implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo infoFields__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","infoFields","urn:enterprise.soap.sforce.com","DescribeSoftphoneLayoutInfoField",1,-1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo screenPopOptions__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","screenPopOptions","urn:enterprise.soap.sforce.com","DescribeSoftphoneScreenPopOption",0,-1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo screenPopsOpenWithin__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","screenPopsOpenWithin","http://www.w3.org/2001/XMLSchema","string",0,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo sections__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","sections","urn:enterprise.soap.sforce.com","DescribeSoftphoneLayoutSection",0,-1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, infoFields__typeInfo)) {
      setInfoFields((com.sforce.soap.enterprise.DescribeSoftphoneLayoutInfoField[])__typeMapper.readObject(__in, infoFields__typeInfo, com.sforce.soap.enterprise.DescribeSoftphoneLayoutInfoField[].class));
    }
    __in.peekTag();
    ...
    if (__typeMapper.isElement(__in, screenPopOptions__typeInfo)) {
      setScreenPopOptions((com.sforce.soap.enterprise.DescribeSoftphoneScreenPopOption[])__typeMapper.readObject(__in, screenPopOptions__typeInfo, com.sforce.soap.enterprise.DescribeSoftphoneScreenPopOption[].class));
    }
    __in.peekTag();
    ...
    if (__typeMapper.isElement(__in, sections__typeInfo)) {
      setSections((com.sforce.soap.enterprise.DescribeSoftphoneLayoutSection[])__typeMapper.readObject(__in, sections__typeInfo, com.sforce.soap.enterprise.DescribeSoftphoneLayoutSection[].class));
    }
  }

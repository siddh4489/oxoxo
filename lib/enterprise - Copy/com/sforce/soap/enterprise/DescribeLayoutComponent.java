...
public class DescribeLayoutComponent implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo displayLines__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","displayLines","http://www.w3.org/2001/XMLSchema","int",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo tabOrder__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","tabOrder","http://www.w3.org/2001/XMLSchema","int",1,1,true);
  ...
  /**
   * element  : type of type {urn:enterprise.soap.sforce.com}layoutComponentType
   * java type: com.sforce.soap.enterprise.LayoutComponentType
   */
  private static final com.sforce.ws.bind.TypeInfo type__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","type","urn:enterprise.soap.sforce.com","layoutComponentType",1,1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, type__typeInfo)) {
      setType((com.sforce.soap.enterprise.LayoutComponentType)__typeMapper.readObject(__in, type__typeInfo, com.sforce.soap.enterprise.LayoutComponentType.class));
    }
    __in.peekTag();

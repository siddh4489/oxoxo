...
public class FindDuplicatesResult implements com.sforce.ws.bind.XMLizable {
   ...
   */
  private static final com.sforce.ws.bind.TypeInfo duplicateResults__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","duplicateResults","urn:enterprise.soap.sforce.com","DuplicateResult",0,-1,true);
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
    ...
    __typeMapper.writeObject(__out, duplicateResults__typeInfo, duplicateResults, duplicateResults__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, duplicateResults__typeInfo)) {
      setDuplicateResults((com.sforce.soap.enterprise.DuplicateResult[])__typeMapper.readObject(__in, duplicateResults__typeInfo, com.sforce.soap.enterprise.DuplicateResult[].class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" duplicateResults=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(duplicateResults)+"'\n");
    sb.append(" errors=");

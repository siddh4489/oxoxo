...
public class DescribeSoftphoneLayoutSection implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo entityApiName__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","entityApiName","http://www.w3.org/2001/XMLSchema","string",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo items__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","items","urn:enterprise.soap.sforce.com","DescribeSoftphoneLayoutItem",1,-1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, items__typeInfo)) {
      setItems((com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem[])__typeMapper.readObject(__in, items__typeInfo, com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem[].class));
    }
  }

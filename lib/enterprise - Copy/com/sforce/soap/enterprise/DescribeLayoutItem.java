...
public class DescribeLayoutItem implements com.sforce.ws.bind.XMLizable {
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, editableForNew__typeInfo)) {
      setEditableForNew((boolean)__typeMapper.readBoolean(__in, editableForNew__typeInfo, boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.verifyElement(__in, editableForUpdate__typeInfo)) {
      setEditableForUpdate((boolean)__typeMapper.readBoolean(__in, editableForUpdate__typeInfo, boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(editableForNew)+"'\n");
    sb.append(" editableForUpdate=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(editableForUpdate)+"'\n");
    sb.append(" label=");

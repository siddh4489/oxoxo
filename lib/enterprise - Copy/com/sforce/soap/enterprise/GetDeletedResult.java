...
public class GetDeletedResult implements com.sforce.ws.bind.XMLizable {
  ...
  /**
   * element  : deletedRecords of type {urn:enterprise.soap.sforce.com}DeletedRecord
   * java type: com.sforce.soap.enterprise.DeletedRecord[]
   */
  private static final com.sforce.ws.bind.TypeInfo deletedRecords__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","deletedRecords","urn:enterprise.soap.sforce.com","DeletedRecord",0,-1,true);

  private boolean deletedRecords__is_set = false;

  private com.sforce.soap.enterprise.DeletedRecord[] deletedRecords = new com.sforce.soap.enterprise.DeletedRecord[0];
  ...
  private static final com.sforce.ws.bind.TypeInfo earliestDateAvailable__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","earliestDateAvailable","http://www.w3.org/2001/XMLSchema","dateTime",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo latestDateCovered__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","latestDateCovered","http://www.w3.org/2001/XMLSchema","dateTime",1,1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, deletedRecords__typeInfo)) {
      setDeletedRecords((com.sforce.soap.enterprise.DeletedRecord[])__typeMapper.readObject(__in, deletedRecords__typeInfo, com.sforce.soap.enterprise.DeletedRecord[].class));
    }
    __in.peekTag();

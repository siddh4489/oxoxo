...
public class DescribeDataCategoryGroupStructureResult implements com.sforce.ws.bind.XMLizable {
  ...
  /**
   * element  : topCategories of type {urn:enterprise.soap.sforce.com}DataCategory
  ...
  private static final com.sforce.ws.bind.TypeInfo topCategories__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","topCategories","urn:enterprise.soap.sforce.com","DataCategory",0,-1,true);

  private boolean topCategories__is_set = false;

  private com.sforce.soap.enterprise.DataCategory[] topCategories = new com.sforce.soap.enterprise.DataCategory[0];
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, topCategories__typeInfo)) {
      setTopCategories((com.sforce.soap.enterprise.DataCategory[])__typeMapper.readObject(__in, topCategories__typeInfo, com.sforce.soap.enterprise.DataCategory[].class));
    }
  }

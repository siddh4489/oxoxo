...
public class PerformQuickActionsResponse_element implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo result__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","result","urn:enterprise.soap.sforce.com","PerformQuickActionResult",0,-1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, result__typeInfo)) {
      setResult((com.sforce.soap.enterprise.PerformQuickActionResult[])__typeMapper.readObject(__in, result__typeInfo, com.sforce.soap.enterprise.PerformQuickActionResult[].class));
    }
  }

 ...
 */
public class Almond__TML_Answer_Sequence__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__TML_Answer_Sequence__c() {
  }
  ...
  /**
   * element  : almond__Internal_Notes__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Internal_Notes__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Internal_Notes__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean almond__Internal_Notes__c__is_set = false;

  private java.lang.String almond__Internal_Notes__c;

  public java.lang.String getAlmond__Internal_Notes__c() {
    return almond__Internal_Notes__c;
  }

  

  public void setAlmond__Internal_Notes__c(java.lang.String almond__Internal_Notes__c) {
    this.almond__Internal_Notes__c = almond__Internal_Notes__c;
    almond__Internal_Notes__c__is_set = true;
  }
  
  /**
   * element  : almond__TML_Answer_Sequence_Items__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo almond__TML_Answer_Sequence_Items__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__TML_Answer_Sequence_Items__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean almond__TML_Answer_Sequence_Items__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult almond__TML_Answer_Sequence_Items__r;

  public com.sforce.soap.enterprise.QueryResult getAlmond__TML_Answer_Sequence_Items__r() {
    return almond__TML_Answer_Sequence_Items__r;
  }

  

  public void setAlmond__TML_Answer_Sequence_Items__r(com.sforce.soap.enterprise.QueryResult almond__TML_Answer_Sequence_Items__r) {
    this.almond__TML_Answer_Sequence_Items__r = almond__TML_Answer_Sequence_Items__r;
    almond__TML_Answer_Sequence_Items__r__is_set = true;
  }
  
  /**
   * element  : almond__TML_Questions__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo almond__TML_Questions__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__TML_Questions__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean almond__TML_Questions__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult almond__TML_Questions__r;

  public com.sforce.soap.enterprise.QueryResult getAlmond__TML_Questions__r() {
    return almond__TML_Questions__r;
  }

  

  public void setAlmond__TML_Questions__r(com.sforce.soap.enterprise.QueryResult almond__TML_Questions__r) {
    this.almond__TML_Questions__r = almond__TML_Questions__r;
    almond__TML_Questions__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__TML_Answer_Sequence__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, almond__Internal_Notes__c__typeInfo, almond__Internal_Notes__c, almond__Internal_Notes__c__is_set);
    __typeMapper.writeObject(__out, almond__TML_Answer_Sequence_Items__r__typeInfo, almond__TML_Answer_Sequence_Items__r, almond__TML_Answer_Sequence_Items__r__is_set);
    __typeMapper.writeObject(__out, almond__TML_Questions__r__typeInfo, almond__TML_Questions__r, almond__TML_Questions__r__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Internal_Notes__c__typeInfo)) {
      setAlmond__Internal_Notes__c((java.lang.String)__typeMapper.readString(__in, almond__Internal_Notes__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__TML_Answer_Sequence_Items__r__typeInfo)) {
      setAlmond__TML_Answer_Sequence_Items__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, almond__TML_Answer_Sequence_Items__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__TML_Questions__r__typeInfo)) {
      setAlmond__TML_Questions__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, almond__TML_Questions__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
  }
  ...
  public String toString() {
    ...
    sb.append(" almond__Internal_Notes__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Internal_Notes__c)+"'\n");
    sb.append(" almond__TML_Answer_Sequence_Items__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__TML_Answer_Sequence_Items__r)+"'\n");
    sb.append(" almond__TML_Questions__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__TML_Questions__r)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
...
public class Solution extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, SolutionName__typeInfo)) {
      setSolutionName((java.lang.String)__typeMapper.readString(__in, SolutionName__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, SolutionNote__typeInfo)) {
      setSolutionNote((java.lang.String)__typeMapper.readString(__in, SolutionNote__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, SolutionNumber__typeInfo)) {
      setSolutionNumber((java.lang.String)__typeMapper.readString(__in, SolutionNumber__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" IsPublishedInPublicKb=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(IsPublishedInPublicKb)+"'\n");
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SolutionName)+"'\n");
    sb.append(" SolutionNote=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SolutionNote)+"'\n");
    sb.append(" SolutionNumber=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SolutionNumber)+"'\n");
    sb.append(" Status=");

 ...
 */
public class CollaborationGroupMemberRequest extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : Requester of type {urn:sobject.enterprise.soap.sforce.com}User
   * java type: com.sforce.soap.enterprise.sobject.User
   */
  private static final com.sforce.ws.bind.TypeInfo Requester__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Requester","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

  private boolean Requester__is_set = false;
  ...
  public void setRequester(com.sforce.soap.enterprise.sobject.User Requester) {
    ...
    Requester__is_set = true;
  }
  
  /**
   * element  : RequesterId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo RequesterId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","RequesterId","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean RequesterId__is_set = false;
  ...
  public void setRequesterId(java.lang.String RequesterId) {
    ...
    RequesterId__is_set = true;
  }
  
  /**
   * element  : ResponseMessage of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo ResponseMessage__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ResponseMessage","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean ResponseMessage__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "CollaborationGroupMemberRequest");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Requester__typeInfo, Requester, Requester__is_set);
    __typeMapper.writeString(__out, RequesterId__typeInfo, RequesterId, RequesterId__is_set);
    __typeMapper.writeString(__out, ResponseMessage__typeInfo, ResponseMessage, ResponseMessage__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Requester__typeInfo)) {
      setRequester((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, Requester__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, RequesterId__typeInfo)) {
      setRequesterId((java.lang.String)__typeMapper.readString(__in, RequesterId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, ResponseMessage__typeInfo)) {
      setResponseMessage((java.lang.String)__typeMapper.readString(__in, ResponseMessage__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[CollaborationGroupMemberRequest ");
    ...
    sb.append(" Requester=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Requester)+"'\n");
    sb.append(" RequesterId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(RequesterId)+"'\n");
    sb.append(" ResponseMessage=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ResponseMessage)+"'\n");
    sb.append(" Status=");

 ...
 */
public class Almond__Training_Plan_Category__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__Training_Plan_Category__c() {
  }
  ...
  /**
   * element  : almond__Learning_Category__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Learning_Category__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Learning_Category__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean almond__Learning_Category__c__is_set = false;

  private java.lang.String almond__Learning_Category__c;

  public java.lang.String getAlmond__Learning_Category__c() {
    return almond__Learning_Category__c;
  }

  

  public void setAlmond__Learning_Category__c(java.lang.String almond__Learning_Category__c) {
    this.almond__Learning_Category__c = almond__Learning_Category__c;
    almond__Learning_Category__c__is_set = true;
  }
  
  /**
   * element  : almond__Learning_Category__r of type {urn:sobject.enterprise.soap.sforce.com}almond__Learning_Category__c
   * java type: com.sforce.soap.enterprise.sobject.Almond__Learning_Category__c
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Learning_Category__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Learning_Category__r","urn:sobject.enterprise.soap.sforce.com","almond__Learning_Category__c",0,1,true);

  private boolean almond__Learning_Category__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Almond__Learning_Category__c almond__Learning_Category__r;

  public com.sforce.soap.enterprise.sobject.Almond__Learning_Category__c getAlmond__Learning_Category__r() {
    return almond__Learning_Category__r;
  }

  

  public void setAlmond__Learning_Category__r(com.sforce.soap.enterprise.sobject.Almond__Learning_Category__c almond__Learning_Category__r) {
    this.almond__Learning_Category__r = almond__Learning_Category__r;
    almond__Learning_Category__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__Training_Plan_Category__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, almond__Learning_Category__c__typeInfo, almond__Learning_Category__c, almond__Learning_Category__c__is_set);
    __typeMapper.writeObject(__out, almond__Learning_Category__r__typeInfo, almond__Learning_Category__r, almond__Learning_Category__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Learning_Category__c__typeInfo)) {
      setAlmond__Learning_Category__c((java.lang.String)__typeMapper.readString(__in, almond__Learning_Category__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Learning_Category__r__typeInfo)) {
      setAlmond__Learning_Category__r((com.sforce.soap.enterprise.sobject.Almond__Learning_Category__c)__typeMapper.readObject(__in, almond__Learning_Category__r__typeInfo, com.sforce.soap.enterprise.sobject.Almond__Learning_Category__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Almond__Training_Plan_Category__c ");
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Learning_Category__c)+"'\n");
    sb.append(" almond__Learning_Category__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Learning_Category__r)+"'\n");

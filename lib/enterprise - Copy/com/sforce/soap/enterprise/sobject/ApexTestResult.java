...
public class ApexTestResult extends com.sforce.soap.enterprise.sobject.SObject {
   ...
   */
  private static final com.sforce.ws.bind.TypeInfo ApexLog__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ApexLog","urn:sobject.enterprise.soap.sforce.com","ApexLog",0,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo ApexLogId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ApexLogId","urn:enterprise.soap.sforce.com","ID",0,1,true);
   ...
   */
  private static final com.sforce.ws.bind.TypeInfo ApexTestResults__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ApexTestResults","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);
   ...
   */
  private static final com.sforce.ws.bind.TypeInfo ApexTestRunResult__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ApexTestRunResult","urn:sobject.enterprise.soap.sforce.com","ApexTestRunResult",0,1,true);
   ...
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo ApexTestRunResultId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ApexTestRunResultId","urn:enterprise.soap.sforce.com","ID",0,1,true);
   ...
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Outcome__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Outcome","http://www.w3.org/2001/XMLSchema","string",0,1,true);
   ...
   */
  private static final com.sforce.ws.bind.TypeInfo QueueItem__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","QueueItem","urn:sobject.enterprise.soap.sforce.com","ApexTestQueueItem",0,1,true);
   ...
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo QueueItemId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","QueueItemId","urn:enterprise.soap.sforce.com","ID",0,1,true);
   ...
   */
  private static final com.sforce.ws.bind.TypeInfo RunTime__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","RunTime","http://www.w3.org/2001/XMLSchema","int",0,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo StackTrace__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","StackTrace","http://www.w3.org/2001/XMLSchema","string",0,1,true);
   ...
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo TestTimestamp__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","TestTimestamp","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, ApexLog__typeInfo, ApexLog, ApexLog__is_set);
    __typeMapper.writeString(__out, ApexLogId__typeInfo, ApexLogId, ApexLogId__is_set);
    __typeMapper.writeObject(__out, ApexTestResults__typeInfo, ApexTestResults, ApexTestResults__is_set);
    __typeMapper.writeObject(__out, ApexTestRunResult__typeInfo, ApexTestRunResult, ApexTestRunResult__is_set);
    __typeMapper.writeString(__out, ApexTestRunResultId__typeInfo, ApexTestRunResultId, ApexTestRunResultId__is_set);
    ...
    __typeMapper.writeString(__out, Outcome__typeInfo, Outcome, Outcome__is_set);
    __typeMapper.writeObject(__out, QueueItem__typeInfo, QueueItem, QueueItem__is_set);
    __typeMapper.writeString(__out, QueueItemId__typeInfo, QueueItemId, QueueItemId__is_set);
    __typeMapper.writeObject(__out, RunTime__typeInfo, RunTime, RunTime__is_set);
    __typeMapper.writeString(__out, StackTrace__typeInfo, StackTrace, StackTrace__is_set);
    __typeMapper.writeObject(__out, SystemModstamp__typeInfo, SystemModstamp, SystemModstamp__is_set);
    __typeMapper.writeObject(__out, TestTimestamp__typeInfo, TestTimestamp, TestTimestamp__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, ApexLog__typeInfo)) {
      setApexLog((com.sforce.soap.enterprise.sobject.ApexLog)__typeMapper.readObject(__in, ApexLog__typeInfo, com.sforce.soap.enterprise.sobject.ApexLog.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, ApexLogId__typeInfo)) {
      setApexLogId((java.lang.String)__typeMapper.readString(__in, ApexLogId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, ApexTestResults__typeInfo)) {
      setApexTestResults((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, ApexTestResults__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, ApexTestRunResult__typeInfo)) {
      setApexTestRunResult((com.sforce.soap.enterprise.sobject.ApexTestRunResult)__typeMapper.readObject(__in, ApexTestRunResult__typeInfo, com.sforce.soap.enterprise.sobject.ApexTestRunResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, ApexTestRunResultId__typeInfo)) {
      setApexTestRunResultId((java.lang.String)__typeMapper.readString(__in, ApexTestRunResultId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Outcome__typeInfo)) {
      setOutcome((java.lang.String)__typeMapper.readString(__in, Outcome__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, QueueItem__typeInfo)) {
      setQueueItem((com.sforce.soap.enterprise.sobject.ApexTestQueueItem)__typeMapper.readObject(__in, QueueItem__typeInfo, com.sforce.soap.enterprise.sobject.ApexTestQueueItem.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, QueueItemId__typeInfo)) {
      setQueueItemId((java.lang.String)__typeMapper.readString(__in, QueueItemId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, RunTime__typeInfo)) {
      setRunTime((java.lang.Integer)__typeMapper.readObject(__in, RunTime__typeInfo, java.lang.Integer.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, StackTrace__typeInfo)) {
      setStackTrace((java.lang.String)__typeMapper.readString(__in, StackTrace__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, TestTimestamp__typeInfo)) {
      setTestTimestamp((java.util.Calendar)__typeMapper.readObject(__in, TestTimestamp__typeInfo, java.util.Calendar.class));
    }
  }
  ...
  public String toString() {
    ...
    sb.append(" ApexLog=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ApexLog)+"'\n");
    sb.append(" ApexLogId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ApexLogId)+"'\n");
    sb.append(" ApexTestResults=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ApexTestResults)+"'\n");
    sb.append(" ApexTestRunResult=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ApexTestRunResult)+"'\n");
    sb.append(" ApexTestRunResultId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ApexTestRunResultId)+"'\n");
    ...
    sb.append(" Outcome=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Outcome)+"'\n");
    sb.append(" QueueItem=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(QueueItem)+"'\n");
    sb.append(" QueueItemId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(QueueItemId)+"'\n");
    sb.append(" RunTime=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(RunTime)+"'\n");
    sb.append(" StackTrace=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(StackTrace)+"'\n");
    sb.append(" SystemModstamp=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SystemModstamp)+"'\n");
    sb.append(" TestTimestamp=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(TestTimestamp)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
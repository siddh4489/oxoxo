 ...
 */
public class Broadcast_Contact__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Broadcast_Contact__c() {
  }
  ...
  /**
   * element  : Broadcast__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Broadcast__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Broadcast__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Broadcast__c__is_set = false;

  private java.lang.String Broadcast__c;

  public java.lang.String getBroadcast__c() {
    return Broadcast__c;
  }

  

  public void setBroadcast__c(java.lang.String Broadcast__c) {
    this.Broadcast__c = Broadcast__c;
    Broadcast__c__is_set = true;
  }
  
  /**
   * element  : Broadcast__r of type {urn:sobject.enterprise.soap.sforce.com}Broadcast__c
   * java type: com.sforce.soap.enterprise.sobject.Broadcast__c
   */
  private static final com.sforce.ws.bind.TypeInfo Broadcast__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Broadcast__r","urn:sobject.enterprise.soap.sforce.com","Broadcast__c",0,1,true);

  private boolean Broadcast__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Broadcast__c Broadcast__r;

  public com.sforce.soap.enterprise.sobject.Broadcast__c getBroadcast__r() {
    return Broadcast__r;
  }

  

  public void setBroadcast__r(com.sforce.soap.enterprise.sobject.Broadcast__c Broadcast__r) {
    this.Broadcast__r = Broadcast__r;
    Broadcast__r__is_set = true;
  }
  
  /**
   * element  : Call_Result__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Call_Result__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Call_Result__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Call_Result__c__is_set = false;

  private java.lang.Double Call_Result__c;

  public java.lang.Double getCall_Result__c() {
    return Call_Result__c;
  }

  

  public void setCall_Result__c(java.lang.Double Call_Result__c) {
  ...
  /**
   * element  : Last_Call_Time__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Last_Call_Time__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Last_Call_Time__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Last_Call_Time__c__is_set = false;

  private java.lang.String Last_Call_Time__c;

  public java.lang.String getLast_Call_Time__c() {
    return Last_Call_Time__c;
  }

  

  public void setLast_Call_Time__c(java.lang.String Last_Call_Time__c) {
    this.Last_Call_Time__c = Last_Call_Time__c;
    Last_Call_Time__c__is_set = true;
  }
  ...
  /**
   * element  : Number_of_Attempts__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Number_of_Attempts__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Number_of_Attempts__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Number_of_Attempts__c__is_set = false;

  private java.lang.Double Number_of_Attempts__c;

  public java.lang.Double getNumber_of_Attempts__c() {
    return Number_of_Attempts__c;
  }

  

  public void setNumber_of_Attempts__c(java.lang.Double Number_of_Attempts__c) {
    this.Number_of_Attempts__c = Number_of_Attempts__c;
    Number_of_Attempts__c__is_set = true;
  }
  ...
  /**
   * element  : Survey_Result__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Survey_Result__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Survey_Result__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Survey_Result__c__is_set = false;

  private java.lang.String Survey_Result__c;

  public java.lang.String getSurvey_Result__c() {
    return Survey_Result__c;
  }

  

  public void setSurvey_Result__c(java.lang.String Survey_Result__c) {
    this.Survey_Result__c = Survey_Result__c;
    Survey_Result__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Broadcast_Contact__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Broadcast__c__typeInfo, Broadcast__c, Broadcast__c__is_set);
    __typeMapper.writeObject(__out, Broadcast__r__typeInfo, Broadcast__r, Broadcast__r__is_set);
    __typeMapper.writeObject(__out, Call_Result__c__typeInfo, Call_Result__c, Call_Result__c__is_set);
    ...
    __typeMapper.writeString(__out, Last_Call_Time__c__typeInfo, Last_Call_Time__c, Last_Call_Time__c__is_set);
    ...
    __typeMapper.writeObject(__out, Number_of_Attempts__c__typeInfo, Number_of_Attempts__c, Number_of_Attempts__c__is_set);
    ...
    __typeMapper.writeString(__out, Survey_Result__c__typeInfo, Survey_Result__c, Survey_Result__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Broadcast__c__typeInfo)) {
      setBroadcast__c((java.lang.String)__typeMapper.readString(__in, Broadcast__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Broadcast__r__typeInfo)) {
      setBroadcast__r((com.sforce.soap.enterprise.sobject.Broadcast__c)__typeMapper.readObject(__in, Broadcast__r__typeInfo, com.sforce.soap.enterprise.sobject.Broadcast__c.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Call_Result__c__typeInfo)) {
      setCall_Result__c((java.lang.Double)__typeMapper.readObject(__in, Call_Result__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Last_Call_Time__c__typeInfo)) {
      setLast_Call_Time__c((java.lang.String)__typeMapper.readString(__in, Last_Call_Time__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Number_of_Attempts__c__typeInfo)) {
      setNumber_of_Attempts__c((java.lang.Double)__typeMapper.readObject(__in, Number_of_Attempts__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Survey_Result__c__typeInfo)) {
      setSurvey_Result__c((java.lang.String)__typeMapper.readString(__in, Survey_Result__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Broadcast_Contact__c ");
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Broadcast__c)+"'\n");
    sb.append(" Broadcast__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Broadcast__r)+"'\n");
    ...
    sb.append(" Last_Call_Time__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Last_Call_Time__c)+"'\n");
    ...
    sb.append(" Number_of_Attempts__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Number_of_Attempts__c)+"'\n");
    ...
    sb.append(" Survey_Result__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Survey_Result__c)+"'\n");

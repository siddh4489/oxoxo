 ...
 */
public class Personal_Certification__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Personal_Certification__c() {
  }
  ...
  /**
   * element  : Issued_By__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Issued_By__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Issued_By__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Issued_By__c__is_set = false;

  private java.lang.String Issued_By__c;

  public java.lang.String getIssued_By__c() {
    return Issued_By__c;
  }

  

  public void setIssued_By__c(java.lang.String Issued_By__c) {
    this.Issued_By__c = Issued_By__c;
    Issued_By__c__is_set = true;
  }
  ...
  /**
   * element  : Personal_Trade__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Personal_Trade__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Personal_Trade__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Personal_Trade__c__is_set = false;

  private java.lang.String Personal_Trade__c;

  public java.lang.String getPersonal_Trade__c() {
    return Personal_Trade__c;
  }

  

  public void setPersonal_Trade__c(java.lang.String Personal_Trade__c) {
    this.Personal_Trade__c = Personal_Trade__c;
    Personal_Trade__c__is_set = true;
  }
  
  /**
   * element  : Personal_Trade__r of type {urn:sobject.enterprise.soap.sforce.com}Personal_Trade__c
   * java type: com.sforce.soap.enterprise.sobject.Personal_Trade__c
   */
  private static final com.sforce.ws.bind.TypeInfo Personal_Trade__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Personal_Trade__r","urn:sobject.enterprise.soap.sforce.com","Personal_Trade__c",0,1,true);

  private boolean Personal_Trade__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Personal_Trade__c Personal_Trade__r;

  public com.sforce.soap.enterprise.sobject.Personal_Trade__c getPersonal_Trade__r() {
    return Personal_Trade__r;
  }

  

  public void setPersonal_Trade__r(com.sforce.soap.enterprise.sobject.Personal_Trade__c Personal_Trade__r) {
    this.Personal_Trade__r = Personal_Trade__r;
    Personal_Trade__r__is_set = true;
  }
  ...
  /**
   * element  : Trade_Certification__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Trade_Certification__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Trade_Certification__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Trade_Certification__c__is_set = false;

  private java.lang.String Trade_Certification__c;

  public java.lang.String getTrade_Certification__c() {
    return Trade_Certification__c;
  }

  

  public void setTrade_Certification__c(java.lang.String Trade_Certification__c) {
    this.Trade_Certification__c = Trade_Certification__c;
    Trade_Certification__c__is_set = true;
  }
  
  /**
   * element  : Trade_Certification__r of type {urn:sobject.enterprise.soap.sforce.com}Trade_Certification__c
   * java type: com.sforce.soap.enterprise.sobject.Trade_Certification__c
   */
  private static final com.sforce.ws.bind.TypeInfo Trade_Certification__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Trade_Certification__r","urn:sobject.enterprise.soap.sforce.com","Trade_Certification__c",0,1,true);

  private boolean Trade_Certification__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Trade_Certification__c Trade_Certification__r;

  public com.sforce.soap.enterprise.sobject.Trade_Certification__c getTrade_Certification__r() {
    return Trade_Certification__r;
  }

  

  public void setTrade_Certification__r(com.sforce.soap.enterprise.sobject.Trade_Certification__c Trade_Certification__r) {
    this.Trade_Certification__r = Trade_Certification__r;
    Trade_Certification__r__is_set = true;
  }
  
  /**
   * element  : Trade_Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Trade_Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Trade_Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Trade_Name__c__is_set = false;

  private java.lang.String Trade_Name__c;

  public java.lang.String getTrade_Name__c() {
    return Trade_Name__c;
  }

  

  public void setTrade_Name__c(java.lang.String Trade_Name__c) {
    this.Trade_Name__c = Trade_Name__c;
    Trade_Name__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Personal_Certification__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Issued_By__c__typeInfo, Issued_By__c, Issued_By__c__is_set);
    ...
    __typeMapper.writeString(__out, Personal_Trade__c__typeInfo, Personal_Trade__c, Personal_Trade__c__is_set);
    __typeMapper.writeObject(__out, Personal_Trade__r__typeInfo, Personal_Trade__r, Personal_Trade__r__is_set);
    ...
    __typeMapper.writeString(__out, Trade_Certification__c__typeInfo, Trade_Certification__c, Trade_Certification__c__is_set);
    __typeMapper.writeObject(__out, Trade_Certification__r__typeInfo, Trade_Certification__r, Trade_Certification__r__is_set);
    __typeMapper.writeString(__out, Trade_Name__c__typeInfo, Trade_Name__c, Trade_Name__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Issued_By__c__typeInfo)) {
      setIssued_By__c((java.lang.String)__typeMapper.readString(__in, Issued_By__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Personal_Trade__c__typeInfo)) {
      setPersonal_Trade__c((java.lang.String)__typeMapper.readString(__in, Personal_Trade__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Personal_Trade__r__typeInfo)) {
      setPersonal_Trade__r((com.sforce.soap.enterprise.sobject.Personal_Trade__c)__typeMapper.readObject(__in, Personal_Trade__r__typeInfo, com.sforce.soap.enterprise.sobject.Personal_Trade__c.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Trade_Certification__c__typeInfo)) {
      setTrade_Certification__c((java.lang.String)__typeMapper.readString(__in, Trade_Certification__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Trade_Certification__r__typeInfo)) {
      setTrade_Certification__r((com.sforce.soap.enterprise.sobject.Trade_Certification__c)__typeMapper.readObject(__in, Trade_Certification__r__typeInfo, com.sforce.soap.enterprise.sobject.Trade_Certification__c.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Trade_Name__c__typeInfo)) {
      setTrade_Name__c((java.lang.String)__typeMapper.readString(__in, Trade_Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Personal_Certification__c ");
    ...
    sb.append(" Issued_By__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Issued_By__c)+"'\n");
    ...
    sb.append(" Personal_Trade__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Personal_Trade__c)+"'\n");
    sb.append(" Personal_Trade__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Personal_Trade__r)+"'\n");
    ...
    sb.append(" Trade_Certification__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Trade_Certification__c)+"'\n");
    sb.append(" Trade_Certification__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Trade_Certification__r)+"'\n");
    sb.append(" Trade_Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Trade_Name__c)+"'\n");

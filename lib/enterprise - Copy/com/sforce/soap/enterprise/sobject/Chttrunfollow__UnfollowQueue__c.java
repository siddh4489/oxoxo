 ...
 */
public class Chttrunfollow__UnfollowQueue__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Chttrunfollow__UnfollowQueue__c() {
  }
  ...
  /**
   * element  : chttrunfollow__CriteriaMetDate__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo chttrunfollow__CriteriaMetDate__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","chttrunfollow__CriteriaMetDate__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean chttrunfollow__CriteriaMetDate__c__is_set = false;

  private java.util.Calendar chttrunfollow__CriteriaMetDate__c;

  public java.util.Calendar getChttrunfollow__CriteriaMetDate__c() {
    return chttrunfollow__CriteriaMetDate__c;
  }

  

  public void setChttrunfollow__CriteriaMetDate__c(java.util.Calendar chttrunfollow__CriteriaMetDate__c) {
    this.chttrunfollow__CriteriaMetDate__c = chttrunfollow__CriteriaMetDate__c;
    chttrunfollow__CriteriaMetDate__c__is_set = true;
  }
  ...
  /**
   * element  : chttrunfollow__ScheduledUnfollowDate__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo chttrunfollow__ScheduledUnfollowDate__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","chttrunfollow__ScheduledUnfollowDate__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean chttrunfollow__ScheduledUnfollowDate__c__is_set = false;

  private java.util.Calendar chttrunfollow__ScheduledUnfollowDate__c;

  public java.util.Calendar getChttrunfollow__ScheduledUnfollowDate__c() {
    return chttrunfollow__ScheduledUnfollowDate__c;
  }

  

  public void setChttrunfollow__ScheduledUnfollowDate__c(java.util.Calendar chttrunfollow__ScheduledUnfollowDate__c) {
    this.chttrunfollow__ScheduledUnfollowDate__c = chttrunfollow__ScheduledUnfollowDate__c;
    chttrunfollow__ScheduledUnfollowDate__c__is_set = true;
  }
  
  /**
   * element  : chttrunfollow__recordId__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo chttrunfollow__recordId__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","chttrunfollow__recordId__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean chttrunfollow__recordId__c__is_set = false;

  private java.lang.String chttrunfollow__recordId__c;

  public java.lang.String getChttrunfollow__recordId__c() {
    return chttrunfollow__recordId__c;
  }

  

  public void setChttrunfollow__recordId__c(java.lang.String chttrunfollow__recordId__c) {
    this.chttrunfollow__recordId__c = chttrunfollow__recordId__c;
    chttrunfollow__recordId__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "chttrunfollow__UnfollowQueue__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, chttrunfollow__CriteriaMetDate__c__typeInfo, chttrunfollow__CriteriaMetDate__c, chttrunfollow__CriteriaMetDate__c__is_set);
    ...
    __typeMapper.writeObject(__out, chttrunfollow__ScheduledUnfollowDate__c__typeInfo, chttrunfollow__ScheduledUnfollowDate__c, chttrunfollow__ScheduledUnfollowDate__c__is_set);
    __typeMapper.writeString(__out, chttrunfollow__recordId__c__typeInfo, chttrunfollow__recordId__c, chttrunfollow__recordId__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, chttrunfollow__CriteriaMetDate__c__typeInfo)) {
      setChttrunfollow__CriteriaMetDate__c((java.util.Calendar)__typeMapper.readObject(__in, chttrunfollow__CriteriaMetDate__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, chttrunfollow__ScheduledUnfollowDate__c__typeInfo)) {
      setChttrunfollow__ScheduledUnfollowDate__c((java.util.Calendar)__typeMapper.readObject(__in, chttrunfollow__ScheduledUnfollowDate__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, chttrunfollow__recordId__c__typeInfo)) {
      setChttrunfollow__recordId__c((java.lang.String)__typeMapper.readString(__in, chttrunfollow__recordId__c__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Chttrunfollow__UnfollowQueue__c ");
    ...
    sb.append(" chttrunfollow__CriteriaMetDate__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(chttrunfollow__CriteriaMetDate__c)+"'\n");
    sb.append(" chttrunfollow__DaysDelay__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(chttrunfollow__DaysDelay__c)+"'\n");
    sb.append(" chttrunfollow__ScheduledUnfollowDate__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(chttrunfollow__ScheduledUnfollowDate__c)+"'\n");
    sb.append(" chttrunfollow__recordId__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(chttrunfollow__recordId__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
 ...
 */
public class Smagicinteract__SMS_SenderId__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Smagicinteract__SMS_SenderId__c() {
  }
  ...
  /**
   * element  : smagicinteract__SenderId_Profile_Map__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo smagicinteract__SenderId_Profile_Map__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","smagicinteract__SenderId_Profile_Map__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean smagicinteract__SenderId_Profile_Map__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult smagicinteract__SenderId_Profile_Map__r;

  public com.sforce.soap.enterprise.QueryResult getSmagicinteract__SenderId_Profile_Map__r() {
    return smagicinteract__SenderId_Profile_Map__r;
  }

  

  public void setSmagicinteract__SenderId_Profile_Map__r(com.sforce.soap.enterprise.QueryResult smagicinteract__SenderId_Profile_Map__r) {
    this.smagicinteract__SenderId_Profile_Map__r = smagicinteract__SenderId_Profile_Map__r;
    smagicinteract__SenderId_Profile_Map__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "smagicinteract__SMS_SenderId__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, smagicinteract__SenderId_Profile_Map__r__typeInfo, smagicinteract__SenderId_Profile_Map__r, smagicinteract__SenderId_Profile_Map__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, smagicinteract__SenderId_Profile_Map__r__typeInfo)) {
      setSmagicinteract__SenderId_Profile_Map__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, smagicinteract__SenderId_Profile_Map__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Smagicinteract__SMS_SenderId__c ");
    ...
    sb.append(" smagicinteract__SenderId_Profile_Map__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(smagicinteract__SenderId_Profile_Map__r)+"'\n");

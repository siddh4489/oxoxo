 ...
 */
public class Division__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Division__c() {
  ...
  /**
   * element  : Default_Division__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo Default_Division__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Default_Division__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean Default_Division__c__is_set = false;

  private java.lang.Boolean Default_Division__c;

  public java.lang.Boolean getDefault_Division__c() {
    return Default_Division__c;
  }

  

  public void setDefault_Division__c(java.lang.Boolean Default_Division__c) {
    this.Default_Division__c = Default_Division__c;
    Default_Division__c__is_set = true;
  }
  ...
  /**
   * element  : EIN__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo EIN__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","EIN__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean EIN__c__is_set = false;

  private java.lang.String EIN__c;

  public java.lang.String getEIN__c() {
    return EIN__c;
  }

  

  public void setEIN__c(java.lang.String EIN__c) {
    this.EIN__c = EIN__c;
    EIN__c__is_set = true;
  }
  ...
  /**
   * element  : Legal_Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Legal_Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Legal_Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Legal_Name__c__is_set = false;

  private java.lang.String Legal_Name__c;

  public java.lang.String getLegal_Name__c() {
    return Legal_Name__c;
  }

  

  public void setLegal_Name__c(java.lang.String Legal_Name__c) {
    this.Legal_Name__c = Legal_Name__c;
    Legal_Name__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Division__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Default_Division__c__typeInfo, Default_Division__c, Default_Division__c__is_set);
    ...
    __typeMapper.writeString(__out, EIN__c__typeInfo, EIN__c, EIN__c__is_set);
    ...
    __typeMapper.writeString(__out, Legal_Name__c__typeInfo, Legal_Name__c, Legal_Name__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Default_Division__c__typeInfo)) {
      setDefault_Division__c((java.lang.Boolean)__typeMapper.readObject(__in, Default_Division__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, EIN__c__typeInfo)) {
      setEIN__c((java.lang.String)__typeMapper.readString(__in, EIN__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Legal_Name__c__typeInfo)) {
      setLegal_Name__c((java.lang.String)__typeMapper.readString(__in, Legal_Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Default_Division__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Default_Division__c)+"'\n");
    ...
    sb.append(" EIN__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(EIN__c)+"'\n");
    sb.append(" Emails=");
    ...
    sb.append(" Legal_Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Legal_Name__c)+"'\n");

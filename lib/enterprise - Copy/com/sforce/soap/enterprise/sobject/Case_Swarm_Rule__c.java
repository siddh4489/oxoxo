 ...
 */
public class Case_Swarm_Rule__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Case_Swarm_Rule__c() {
  }
  ...
  /**
   * element  : Case_Priority__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Case_Priority__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Case_Priority__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Case_Priority__c__is_set = false;

  private java.lang.String Case_Priority__c;

  public java.lang.String getCase_Priority__c() {
    return Case_Priority__c;
  }

  

  public void setCase_Priority__c(java.lang.String Case_Priority__c) {
    this.Case_Priority__c = Case_Priority__c;
    Case_Priority__c__is_set = true;
  }
  
  /**
   * element  : Case_Status__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Case_Status__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Case_Status__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Case_Status__c__is_set = false;
  ...
  public void setCase_Status__c(java.lang.String Case_Status__c) {
    ...
    Case_Status__c__is_set = true;
  }
  
  /**
   * element  : Case_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Case_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Case_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Case_Type__c__is_set = false;

  private java.lang.String Case_Type__c;

  public java.lang.String getCase_Type__c() {
    return Case_Type__c;
  }

  

  public void setCase_Type__c(java.lang.String Case_Type__c) {
    this.Case_Type__c = Case_Type__c;
    Case_Type__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Case_Swarm_Rule__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Case_Priority__c__typeInfo, Case_Priority__c, Case_Priority__c__is_set);
    __typeMapper.writeString(__out, Case_Status__c__typeInfo, Case_Status__c, Case_Status__c__is_set);
    __typeMapper.writeString(__out, Case_Type__c__typeInfo, Case_Type__c, Case_Type__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Case_Priority__c__typeInfo)) {
      setCase_Priority__c((java.lang.String)__typeMapper.readString(__in, Case_Priority__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Case_Status__c__typeInfo)) {
      setCase_Status__c((java.lang.String)__typeMapper.readString(__in, Case_Status__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Case_Type__c__typeInfo)) {
      setCase_Type__c((java.lang.String)__typeMapper.readString(__in, Case_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Case_Priority__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Case_Priority__c)+"'\n");
    sb.append(" Case_Status__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Case_Status__c)+"'\n");
    sb.append(" Case_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Case_Type__c)+"'\n");

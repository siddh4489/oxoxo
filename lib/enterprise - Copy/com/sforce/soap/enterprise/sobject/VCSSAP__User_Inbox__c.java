 ...
 */
public class VCSSAP__User_Inbox__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public VCSSAP__User_Inbox__c() {
  }
  ...
  /**
   * element  : VCSSAP__Active__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo VCSSAP__Active__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","VCSSAP__Active__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean VCSSAP__Active__c__is_set = false;

  private java.lang.Boolean VCSSAP__Active__c;

  public java.lang.Boolean getVCSSAP__Active__c() {
    return VCSSAP__Active__c;
  }

  

  public void setVCSSAP__Active__c(java.lang.Boolean VCSSAP__Active__c) {
    this.VCSSAP__Active__c = VCSSAP__Active__c;
    VCSSAP__Active__c__is_set = true;
  }
  
  /**
   * element  : VCSSAP__Display_Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo VCSSAP__Display_Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","VCSSAP__Display_Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean VCSSAP__Display_Name__c__is_set = false;

  private java.lang.String VCSSAP__Display_Name__c;

  public java.lang.String getVCSSAP__Display_Name__c() {
    return VCSSAP__Display_Name__c;
  }

  

  public void setVCSSAP__Display_Name__c(java.lang.String VCSSAP__Display_Name__c) {
    this.VCSSAP__Display_Name__c = VCSSAP__Display_Name__c;
    VCSSAP__Display_Name__c__is_set = true;
  }
  
  /**
   * element  : VCSSAP__Email__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo VCSSAP__Email__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","VCSSAP__Email__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean VCSSAP__Email__c__is_set = false;

  private java.lang.String VCSSAP__Email__c;

  public java.lang.String getVCSSAP__Email__c() {
    return VCSSAP__Email__c;
  }

  

  public void setVCSSAP__Email__c(java.lang.String VCSSAP__Email__c) {
    this.VCSSAP__Email__c = VCSSAP__Email__c;
    VCSSAP__Email__c__is_set = true;
  }
  
  /**
   * element  : VCSSAP__User__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo VCSSAP__User__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","VCSSAP__User__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean VCSSAP__User__c__is_set = false;

  private java.lang.String VCSSAP__User__c;

  public java.lang.String getVCSSAP__User__c() {
    return VCSSAP__User__c;
  }

  

  public void setVCSSAP__User__c(java.lang.String VCSSAP__User__c) {
    this.VCSSAP__User__c = VCSSAP__User__c;
    VCSSAP__User__c__is_set = true;
  }
  
  /**
   * element  : VCSSAP__User__r of type {urn:sobject.enterprise.soap.sforce.com}User
   * java type: com.sforce.soap.enterprise.sobject.User
   */
  private static final com.sforce.ws.bind.TypeInfo VCSSAP__User__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","VCSSAP__User__r","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

  private boolean VCSSAP__User__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.User VCSSAP__User__r;

  public com.sforce.soap.enterprise.sobject.User getVCSSAP__User__r() {
    return VCSSAP__User__r;
  }

  

  public void setVCSSAP__User__r(com.sforce.soap.enterprise.sobject.User VCSSAP__User__r) {
    this.VCSSAP__User__r = VCSSAP__User__r;
    VCSSAP__User__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "VCSSAP__User_Inbox__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, VCSSAP__Active__c__typeInfo, VCSSAP__Active__c, VCSSAP__Active__c__is_set);
    __typeMapper.writeString(__out, VCSSAP__Display_Name__c__typeInfo, VCSSAP__Display_Name__c, VCSSAP__Display_Name__c__is_set);
    __typeMapper.writeString(__out, VCSSAP__Email__c__typeInfo, VCSSAP__Email__c, VCSSAP__Email__c__is_set);
    __typeMapper.writeString(__out, VCSSAP__User__c__typeInfo, VCSSAP__User__c, VCSSAP__User__c__is_set);
    __typeMapper.writeObject(__out, VCSSAP__User__r__typeInfo, VCSSAP__User__r, VCSSAP__User__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, VCSSAP__Active__c__typeInfo)) {
      setVCSSAP__Active__c((java.lang.Boolean)__typeMapper.readObject(__in, VCSSAP__Active__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, VCSSAP__Display_Name__c__typeInfo)) {
      setVCSSAP__Display_Name__c((java.lang.String)__typeMapper.readString(__in, VCSSAP__Display_Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, VCSSAP__Email__c__typeInfo)) {
      setVCSSAP__Email__c((java.lang.String)__typeMapper.readString(__in, VCSSAP__Email__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, VCSSAP__User__c__typeInfo)) {
      setVCSSAP__User__c((java.lang.String)__typeMapper.readString(__in, VCSSAP__User__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, VCSSAP__User__r__typeInfo)) {
      setVCSSAP__User__r((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, VCSSAP__User__r__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[VCSSAP__User_Inbox__c ");
    ...
    sb.append(" VCSSAP__Active__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(VCSSAP__Active__c)+"'\n");
    sb.append(" VCSSAP__Display_Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(VCSSAP__Display_Name__c)+"'\n");
    sb.append(" VCSSAP__Email__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(VCSSAP__Email__c)+"'\n");
    sb.append(" VCSSAP__User__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(VCSSAP__User__c)+"'\n");
    sb.append(" VCSSAP__User__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(VCSSAP__User__r)+"'\n");

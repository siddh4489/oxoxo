 ...
 */
public class LeadTag extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public LeadTag() {
  ...
  /**
   * element  : Item of type {urn:sobject.enterprise.soap.sforce.com}Lead
   * java type: com.sforce.soap.enterprise.sobject.Lead
   */
  private static final com.sforce.ws.bind.TypeInfo Item__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Item","urn:sobject.enterprise.soap.sforce.com","Lead",0,1,true);

  private boolean Item__is_set = false;

  private com.sforce.soap.enterprise.sobject.Lead Item;

  public com.sforce.soap.enterprise.sobject.Lead getItem() {
    return Item;
  }

  

  public void setItem(com.sforce.soap.enterprise.sobject.Lead Item) {
    this.Item = Item;
    Item__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "LeadTag");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Item__typeInfo)) {
      setItem((com.sforce.soap.enterprise.sobject.Lead)__typeMapper.readObject(__in, Item__typeInfo, com.sforce.soap.enterprise.sobject.Lead.class));
    }
    __in.peekTag();

 ...
 */
public class QuestionSubscription extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : QuestionCreatedDate of type {http://www.w3.org/2001/XMLSchema}dateTime
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo QuestionCreatedDate__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","QuestionCreatedDate","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

  private boolean QuestionCreatedDate__is_set = false;

  private java.util.Calendar QuestionCreatedDate;

  public java.util.Calendar getQuestionCreatedDate() {
    return QuestionCreatedDate;
  }

  

  public void setQuestionCreatedDate(java.util.Calendar QuestionCreatedDate) {
    this.QuestionCreatedDate = QuestionCreatedDate;
    QuestionCreatedDate__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "QuestionSubscription");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, QuestionCreatedDate__typeInfo, QuestionCreatedDate, QuestionCreatedDate__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, QuestionCreatedDate__typeInfo)) {
      setQuestionCreatedDate((java.util.Calendar)__typeMapper.readObject(__in, QuestionCreatedDate__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[QuestionSubscription ");
    ...
    sb.append(" QuestionCreatedDate=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(QuestionCreatedDate)+"'\n");

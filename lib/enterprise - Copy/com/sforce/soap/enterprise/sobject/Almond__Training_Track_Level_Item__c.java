 ...
 */
public class Almond__Training_Track_Level_Item__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__Training_Track_Level_Item__c() {
  }
  ...
  /**
   * element  : almond__Training_Track_Level__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Training_Track_Level__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Training_Track_Level__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean almond__Training_Track_Level__c__is_set = false;

  private java.lang.String almond__Training_Track_Level__c;

  public java.lang.String getAlmond__Training_Track_Level__c() {
    return almond__Training_Track_Level__c;
  }

  

  public void setAlmond__Training_Track_Level__c(java.lang.String almond__Training_Track_Level__c) {
    this.almond__Training_Track_Level__c = almond__Training_Track_Level__c;
    almond__Training_Track_Level__c__is_set = true;
  }
  
  /**
   * element  : almond__Training_Track_Level__r of type {urn:sobject.enterprise.soap.sforce.com}almond__Training_Track_Level__c
   * java type: com.sforce.soap.enterprise.sobject.Almond__Training_Track_Level__c
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Training_Track_Level__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Training_Track_Level__r","urn:sobject.enterprise.soap.sforce.com","almond__Training_Track_Level__c",0,1,true);

  private boolean almond__Training_Track_Level__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Almond__Training_Track_Level__c almond__Training_Track_Level__r;

  public com.sforce.soap.enterprise.sobject.Almond__Training_Track_Level__c getAlmond__Training_Track_Level__r() {
    return almond__Training_Track_Level__r;
  }

  

  public void setAlmond__Training_Track_Level__r(com.sforce.soap.enterprise.sobject.Almond__Training_Track_Level__c almond__Training_Track_Level__r) {
    this.almond__Training_Track_Level__r = almond__Training_Track_Level__r;
    almond__Training_Track_Level__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__Training_Track_Level_Item__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, almond__Training_Track_Level__c__typeInfo, almond__Training_Track_Level__c, almond__Training_Track_Level__c__is_set);
    __typeMapper.writeObject(__out, almond__Training_Track_Level__r__typeInfo, almond__Training_Track_Level__r, almond__Training_Track_Level__r__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Training_Track_Level__c__typeInfo)) {
      setAlmond__Training_Track_Level__c((java.lang.String)__typeMapper.readString(__in, almond__Training_Track_Level__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Training_Track_Level__r__typeInfo)) {
      setAlmond__Training_Track_Level__r((com.sforce.soap.enterprise.sobject.Almond__Training_Track_Level__c)__typeMapper.readObject(__in, almond__Training_Track_Level__r__typeInfo, com.sforce.soap.enterprise.sobject.Almond__Training_Track_Level__c.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Almond__Training_Track_Level_Item__c ");
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Training_Track_Level__c)+"'\n");
    sb.append(" almond__Training_Track_Level__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Training_Track_Level__r)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
 ...
 */
public class Trade_Skill__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Trade_Skill__c() {
  }
  ...
  /**
   * element  : Personal_Skill__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo Personal_Skill__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Personal_Skill__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean Personal_Skill__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult Personal_Skill__r;

  public com.sforce.soap.enterprise.QueryResult getPersonal_Skill__r() {
    return Personal_Skill__r;
  }

  

  public void setPersonal_Skill__r(com.sforce.soap.enterprise.QueryResult Personal_Skill__r) {
    this.Personal_Skill__r = Personal_Skill__r;
    Personal_Skill__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Trade_Skill__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Personal_Skill__r__typeInfo, Personal_Skill__r, Personal_Skill__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Personal_Skill__r__typeInfo)) {
      setPersonal_Skill__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Personal_Skill__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Personal_Skill__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Personal_Skill__r)+"'\n");

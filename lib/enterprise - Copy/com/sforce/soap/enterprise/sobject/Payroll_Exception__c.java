 ...
 */
public class Payroll_Exception__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Payroll_Exception__c() {
  }
  ...
  /**
   * element  : New_Deduction_Needed__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo New_Deduction_Needed__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","New_Deduction_Needed__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean New_Deduction_Needed__c__is_set = false;

  private java.lang.Boolean New_Deduction_Needed__c;

  public java.lang.Boolean getNew_Deduction_Needed__c() {
    return New_Deduction_Needed__c;
  }

  

  public void setNew_Deduction_Needed__c(java.lang.Boolean New_Deduction_Needed__c) {
    this.New_Deduction_Needed__c = New_Deduction_Needed__c;
    New_Deduction_Needed__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Payroll_Exception__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, New_Deduction_Needed__c__typeInfo, New_Deduction_Needed__c, New_Deduction_Needed__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, New_Deduction_Needed__c__typeInfo)) {
      setNew_Deduction_Needed__c((java.lang.Boolean)__typeMapper.readObject(__in, New_Deduction_Needed__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Payroll_Exception__c ");
    ...
    sb.append(" New_Deduction_Needed__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(New_Deduction_Needed__c)+"'\n");
    sb.append(" Notes=");

 ...
 */
public class Export__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Export__c() {
  ...
  /**
   * element  : Date_Exported__c of type {http://www.w3.org/2001/XMLSchema}dateTime
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_Exported__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_Exported__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

  private boolean Date_Exported__c__is_set = false;

  private java.util.Calendar Date_Exported__c;

  public java.util.Calendar getDate_Exported__c() {
    return Date_Exported__c;
  }

  

  public void setDate_Exported__c(java.util.Calendar Date_Exported__c) {
    this.Date_Exported__c = Date_Exported__c;
    Date_Exported__c__is_set = true;
  }
  
  /**
   * element  : Date_Queued__c of type {http://www.w3.org/2001/XMLSchema}dateTime
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_Queued__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_Queued__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

  private boolean Date_Queued__c__is_set = false;

  private java.util.Calendar Date_Queued__c;

  public java.util.Calendar getDate_Queued__c() {
    return Date_Queued__c;
  }

  

  public void setDate_Queued__c(java.util.Calendar Date_Queued__c) {
    this.Date_Queued__c = Date_Queued__c;
    Date_Queued__c__is_set = true;
  }
  ...
  /**
   * element  : Export_Details__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo Export_Details__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Export_Details__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean Export_Details__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult Export_Details__r;

  public com.sforce.soap.enterprise.QueryResult getExport_Details__r() {
    return Export_Details__r;
  }

  

  public void setExport_Details__r(com.sforce.soap.enterprise.QueryResult Export_Details__r) {
    this.Export_Details__r = Export_Details__r;
    Export_Details__r__is_set = true;
  }
  
  /**
   * element  : Export_Filename__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Export_Filename__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Export_Filename__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Export_Filename__c__is_set = false;

  private java.lang.String Export_Filename__c;

  public java.lang.String getExport_Filename__c() {
    return Export_Filename__c;
  }

  

  public void setExport_Filename__c(java.lang.String Export_Filename__c) {
    this.Export_Filename__c = Export_Filename__c;
    Export_Filename__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Export__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Date_Exported__c__typeInfo, Date_Exported__c, Date_Exported__c__is_set);
    __typeMapper.writeObject(__out, Date_Queued__c__typeInfo, Date_Queued__c, Date_Queued__c__is_set);
    ...
    __typeMapper.writeObject(__out, Export_Details__r__typeInfo, Export_Details__r, Export_Details__r__is_set);
    __typeMapper.writeString(__out, Export_Filename__c__typeInfo, Export_Filename__c, Export_Filename__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_Exported__c__typeInfo)) {
      setDate_Exported__c((java.util.Calendar)__typeMapper.readObject(__in, Date_Exported__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_Queued__c__typeInfo)) {
      setDate_Queued__c((java.util.Calendar)__typeMapper.readObject(__in, Date_Queued__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Export_Details__r__typeInfo)) {
      setExport_Details__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Export_Details__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Export_Filename__c__typeInfo)) {
      setExport_Filename__c((java.lang.String)__typeMapper.readString(__in, Export_Filename__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    if (__typeMapper.isElement(__in, Source__c__typeInfo)) {
      setSource__c((java.lang.String)__typeMapper.readString(__in, Source__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Date_Exported__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_Exported__c)+"'\n");
    sb.append(" Date_Queued__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_Queued__c)+"'\n");
    ...
    sb.append(" Export_Details__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Export_Details__r)+"'\n");
    sb.append(" Export_Filename__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Export_Filename__c)+"'\n");
    ...
    sb.append(" Source__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Source__c)+"'\n");
    sb.append(" Status__c=");

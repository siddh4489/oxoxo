 ...
 */
public class Dupcheck__dc3Log__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Dupcheck__dc3Log__c() {
  }
  ...
  /**
   * element  : dupcheck__Object__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__Object__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__Object__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__Object__c__is_set = false;

  private java.lang.String dupcheck__Object__c;

  public java.lang.String getDupcheck__Object__c() {
    return dupcheck__Object__c;
  }

  

  public void setDupcheck__Object__c(java.lang.String dupcheck__Object__c) {
    this.dupcheck__Object__c = dupcheck__Object__c;
    dupcheck__Object__c__is_set = true;
  }
  
  /**
   * element  : dupcheck__Record__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__Record__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__Record__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__Record__c__is_set = false;

  private java.lang.String dupcheck__Record__c;

  public java.lang.String getDupcheck__Record__c() {
    return dupcheck__Record__c;
  }

  

  public void setDupcheck__Record__c(java.lang.String dupcheck__Record__c) {
    this.dupcheck__Record__c = dupcheck__Record__c;
    dupcheck__Record__c__is_set = true;
  }
  ...
  /**
   * element  : dupcheck__data__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__data__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__data__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__data__c__is_set = false;

  private java.lang.String dupcheck__data__c;

  public java.lang.String getDupcheck__data__c() {
    return dupcheck__data__c;
  }

  

  public void setDupcheck__data__c(java.lang.String dupcheck__data__c) {
    this.dupcheck__data__c = dupcheck__data__c;
    dupcheck__data__c__is_set = true;
  }
  
  /**
   * element  : dupcheck__dc3Job__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__dc3Job__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__dc3Job__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean dupcheck__dc3Job__c__is_set = false;

  private java.lang.String dupcheck__dc3Job__c;

  public java.lang.String getDupcheck__dc3Job__c() {
    return dupcheck__dc3Job__c;
  }

  

  public void setDupcheck__dc3Job__c(java.lang.String dupcheck__dc3Job__c) {
    this.dupcheck__dc3Job__c = dupcheck__dc3Job__c;
    dupcheck__dc3Job__c__is_set = true;
  }
  
  /**
   * element  : dupcheck__dc3Job__r of type {urn:sobject.enterprise.soap.sforce.com}dupcheck__dcJob__c
   * java type: com.sforce.soap.enterprise.sobject.Dupcheck__dcJob__c
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__dc3Job__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__dc3Job__r","urn:sobject.enterprise.soap.sforce.com","dupcheck__dcJob__c",0,1,true);

  private boolean dupcheck__dc3Job__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Dupcheck__dcJob__c dupcheck__dc3Job__r;

  public com.sforce.soap.enterprise.sobject.Dupcheck__dcJob__c getDupcheck__dc3Job__r() {
    return dupcheck__dc3Job__r;
  }

  

  public void setDupcheck__dc3Job__r(com.sforce.soap.enterprise.sobject.Dupcheck__dcJob__c dupcheck__dc3Job__r) {
    this.dupcheck__dc3Job__r = dupcheck__dc3Job__r;
    dupcheck__dc3Job__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "dupcheck__dc3Log__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, dupcheck__Object__c__typeInfo, dupcheck__Object__c, dupcheck__Object__c__is_set);
    __typeMapper.writeString(__out, dupcheck__Record__c__typeInfo, dupcheck__Record__c, dupcheck__Record__c__is_set);
    __typeMapper.writeString(__out, dupcheck__Type__c__typeInfo, dupcheck__Type__c, dupcheck__Type__c__is_set);
    __typeMapper.writeString(__out, dupcheck__data__c__typeInfo, dupcheck__data__c, dupcheck__data__c__is_set);
    __typeMapper.writeString(__out, dupcheck__dc3Job__c__typeInfo, dupcheck__dc3Job__c, dupcheck__dc3Job__c__is_set);
    __typeMapper.writeObject(__out, dupcheck__dc3Job__r__typeInfo, dupcheck__dc3Job__r, dupcheck__dc3Job__r__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__Object__c__typeInfo)) {
      setDupcheck__Object__c((java.lang.String)__typeMapper.readString(__in, dupcheck__Object__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__Record__c__typeInfo)) {
      setDupcheck__Record__c((java.lang.String)__typeMapper.readString(__in, dupcheck__Record__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__data__c__typeInfo)) {
      setDupcheck__data__c((java.lang.String)__typeMapper.readString(__in, dupcheck__data__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__dc3Job__c__typeInfo)) {
      setDupcheck__dc3Job__c((java.lang.String)__typeMapper.readString(__in, dupcheck__dc3Job__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__dc3Job__r__typeInfo)) {
      setDupcheck__dc3Job__r((com.sforce.soap.enterprise.sobject.Dupcheck__dcJob__c)__typeMapper.readObject(__in, dupcheck__dc3Job__r__typeInfo, com.sforce.soap.enterprise.sobject.Dupcheck__dcJob__c.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Dupcheck__dc3Log__c ");
    ...
    sb.append(" dupcheck__Object__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__Object__c)+"'\n");
    sb.append(" dupcheck__Record__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__Record__c)+"'\n");
    sb.append(" dupcheck__Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__Type__c)+"'\n");
    sb.append(" dupcheck__data__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__data__c)+"'\n");
    sb.append(" dupcheck__dc3Job__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__dc3Job__c)+"'\n");
    sb.append(" dupcheck__dc3Job__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__dc3Job__r)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
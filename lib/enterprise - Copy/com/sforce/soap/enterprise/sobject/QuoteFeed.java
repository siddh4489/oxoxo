 ...
 */
public class QuoteFeed extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public QuoteFeed() {
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}Quote
   * java type: com.sforce.soap.enterprise.sobject.Quote
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","Quote",0,1,true);

  private boolean Parent__is_set = false;

  private com.sforce.soap.enterprise.sobject.Quote Parent;

  public com.sforce.soap.enterprise.sobject.Quote getParent() {
    return Parent;
  }

  

  public void setParent(com.sforce.soap.enterprise.sobject.Quote Parent) {
    this.Parent = Parent;
    Parent__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "QuoteFeed");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.Quote)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.Quote.class));
    }
    __in.peekTag();

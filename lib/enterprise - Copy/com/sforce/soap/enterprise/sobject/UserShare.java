...
public class UserShare extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, UserAccessLevel__typeInfo)) {
      setUserAccessLevel((java.lang.String)__typeMapper.readString(__in, UserAccessLevel__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(UserAccessLevel)+"'\n");
    sb.append(" UserId=");

 ...
 */
public class PartnerRole extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public PartnerRole() {
  ...
  private static final com.sforce.ws.bind.TypeInfo ReverseRole__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ReverseRole","http://www.w3.org/2001/XMLSchema","string",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "PartnerRole");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, ReverseRole__typeInfo)) {
      setReverseRole((java.lang.String)__typeMapper.readString(__in, ReverseRole__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" ReverseRole=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ReverseRole)+"'\n");
    sb.append(" SortOrder=");

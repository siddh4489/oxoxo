 ...
 */
public class Dupcheck__dcGroup__Tag extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Dupcheck__dcGroup__Tag() {
  }
  ...
  /**
   * element  : Item of type {urn:sobject.enterprise.soap.sforce.com}dupcheck__dcGroup__c
  ...
  private static final com.sforce.ws.bind.TypeInfo Item__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Item","urn:sobject.enterprise.soap.sforce.com","dupcheck__dcGroup__c",0,1,true);

  private boolean Item__is_set = false;

  private com.sforce.soap.enterprise.sobject.Dupcheck__dcGroup__c Item;

  public com.sforce.soap.enterprise.sobject.Dupcheck__dcGroup__c getItem() {
    return Item;
  }

  

  public void setItem(com.sforce.soap.enterprise.sobject.Dupcheck__dcGroup__c Item) {
    this.Item = Item;
    Item__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "dupcheck__dcGroup__Tag");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Item__typeInfo)) {
      setItem((com.sforce.soap.enterprise.sobject.Dupcheck__dcGroup__c)__typeMapper.readObject(__in, Item__typeInfo, com.sforce.soap.enterprise.sobject.Dupcheck__dcGroup__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Dupcheck__dcGroup__Tag ");

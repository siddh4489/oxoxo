 ...
 */
public class UE_Claim_Charges__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public UE_Claim_Charges__c() {
  }
  ...
  /**
   * element  : Charge__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Charge__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Charge__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Charge__c__is_set = false;

  private java.lang.Double Charge__c;

  public java.lang.Double getCharge__c() {
    return Charge__c;
  }

  

  public void setCharge__c(java.lang.Double Charge__c) {
  ...
  /**
   * element  : Statement_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Statement_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Statement_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Statement_Date__c__is_set = false;

  private java.util.Calendar Statement_Date__c;

  public java.util.Calendar getStatement_Date__c() {
    return Statement_Date__c;
  }

  

  public void setStatement_Date__c(java.util.Calendar Statement_Date__c) {
    this.Statement_Date__c = Statement_Date__c;
    Statement_Date__c__is_set = true;
  }
  ...
  /**
   * element  : Unemployment_Claim__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Unemployment_Claim__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Unemployment_Claim__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Unemployment_Claim__c__is_set = false;

  private java.lang.String Unemployment_Claim__c;

  public java.lang.String getUnemployment_Claim__c() {
    return Unemployment_Claim__c;
  }

  

  public void setUnemployment_Claim__c(java.lang.String Unemployment_Claim__c) {
    this.Unemployment_Claim__c = Unemployment_Claim__c;
    Unemployment_Claim__c__is_set = true;
  }
  
  /**
   * element  : Unemployment_Claim__r of type {urn:sobject.enterprise.soap.sforce.com}Unemployment_Claims__c
   * java type: com.sforce.soap.enterprise.sobject.Unemployment_Claims__c
   */
  private static final com.sforce.ws.bind.TypeInfo Unemployment_Claim__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Unemployment_Claim__r","urn:sobject.enterprise.soap.sforce.com","Unemployment_Claims__c",0,1,true);

  private boolean Unemployment_Claim__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Unemployment_Claims__c Unemployment_Claim__r;

  public com.sforce.soap.enterprise.sobject.Unemployment_Claims__c getUnemployment_Claim__r() {
    return Unemployment_Claim__r;
  }

  

  public void setUnemployment_Claim__r(com.sforce.soap.enterprise.sobject.Unemployment_Claims__c Unemployment_Claim__r) {
    this.Unemployment_Claim__r = Unemployment_Claim__r;
    Unemployment_Claim__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "UE_Claim_Charges__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Charge__c__typeInfo, Charge__c, Charge__c__is_set);
    ...
    __typeMapper.writeObject(__out, Statement_Date__c__typeInfo, Statement_Date__c, Statement_Date__c__is_set);
    ...
    __typeMapper.writeString(__out, Unemployment_Claim__c__typeInfo, Unemployment_Claim__c, Unemployment_Claim__c__is_set);
    __typeMapper.writeObject(__out, Unemployment_Claim__r__typeInfo, Unemployment_Claim__r, Unemployment_Claim__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Charge__c__typeInfo)) {
      setCharge__c((java.lang.Double)__typeMapper.readObject(__in, Charge__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Statement_Date__c__typeInfo)) {
      setStatement_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Statement_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    if (__typeMapper.isElement(__in, Unemployment_Claim__c__typeInfo)) {
      setUnemployment_Claim__c((java.lang.String)__typeMapper.readString(__in, Unemployment_Claim__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Unemployment_Claim__r__typeInfo)) {
      setUnemployment_Claim__r((com.sforce.soap.enterprise.sobject.Unemployment_Claims__c)__typeMapper.readObject(__in, Unemployment_Claim__r__typeInfo, com.sforce.soap.enterprise.sobject.Unemployment_Claims__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Statement_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Statement_Date__c)+"'\n");
    ...
    sb.append(" Unemployment_Claim__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Unemployment_Claim__r)+"'\n");

 ...
 */
public class ProfileSkill extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public ProfileSkill() {
  ...
  /**
   * element  : ProfileSkillUserChildren of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo ProfileSkillUserChildren__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ProfileSkillUserChildren","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean ProfileSkillUserChildren__is_set = false;

  private com.sforce.soap.enterprise.QueryResult ProfileSkillUserChildren;

  public com.sforce.soap.enterprise.QueryResult getProfileSkillUserChildren() {
    return ProfileSkillUserChildren;
  }

  

  public void setProfileSkillUserChildren(com.sforce.soap.enterprise.QueryResult ProfileSkillUserChildren) {
    this.ProfileSkillUserChildren = ProfileSkillUserChildren;
    ProfileSkillUserChildren__is_set = true;
  }
  ...
  /**
   * element  : UserCount of type {http://www.w3.org/2001/XMLSchema}int
   * java type: java.lang.Integer
   */
  private static final com.sforce.ws.bind.TypeInfo UserCount__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","UserCount","http://www.w3.org/2001/XMLSchema","int",0,1,true);

  private boolean UserCount__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "ProfileSkill");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, ProfileSkillUserChildren__typeInfo, ProfileSkillUserChildren, ProfileSkillUserChildren__is_set);
    __typeMapper.writeObject(__out, SystemModstamp__typeInfo, SystemModstamp, SystemModstamp__is_set);
    __typeMapper.writeObject(__out, UserCount__typeInfo, UserCount, UserCount__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, ProfileSkillUserChildren__typeInfo)) {
      setProfileSkillUserChildren((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, ProfileSkillUserChildren__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, UserCount__typeInfo)) {
      setUserCount((java.lang.Integer)__typeMapper.readObject(__in, UserCount__typeInfo, java.lang.Integer.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" ProfileSkillUserChildren=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ProfileSkillUserChildren)+"'\n");
    sb.append(" SystemModstamp=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SystemModstamp)+"'\n");
    sb.append(" UserCount=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(UserCount)+"'\n");

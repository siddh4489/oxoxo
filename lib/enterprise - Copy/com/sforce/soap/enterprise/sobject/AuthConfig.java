...
public class AuthConfig extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  public String toString() {
    ...
    sb.append(" AuthOptionsAuthProvider=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AuthOptionsAuthProvider)+"'\n");
    sb.append(" AuthOptionsSaml=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AuthOptionsSaml)+"'\n");
    sb.append(" AuthOptionsUsernamePassword=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AuthOptionsUsernamePassword)+"'\n");
    sb.append(" AuthProvidersForConfig=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AuthProvidersForConfig)+"'\n");
    sb.append(" CreatedBy=");

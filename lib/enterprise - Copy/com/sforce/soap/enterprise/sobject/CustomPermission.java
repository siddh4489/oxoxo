...
public class CustomPermission extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  public String toString() {
    ...
    sb.append(" CustomPermissionDependencyItem=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CustomPermissionDependencyItem)+"'\n");
    sb.append(" CustomPermissionItem=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CustomPermissionItem)+"'\n");

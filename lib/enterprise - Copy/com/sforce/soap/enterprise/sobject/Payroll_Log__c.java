 ...
 */
public class Payroll_Log__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Payroll_Log__c() {
  }
    
  
  /**
   * element  : ACH_Total__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo ACH_Total__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ACH_Total__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean ACH_Total__c__is_set = false;

  private java.lang.Double ACH_Total__c;

  public java.lang.Double getACH_Total__c() {
    return ACH_Total__c;
  }

  

  public void setACH_Total__c(java.lang.Double ACH_Total__c) {
    this.ACH_Total__c = ACH_Total__c;
    ACH_Total__c__is_set = true;
  }
  ...
  /**
   * element  : Batch_Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Batch_Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Batch_Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Batch_Name__c__is_set = false;

  private java.lang.String Batch_Name__c;

  public java.lang.String getBatch_Name__c() {
    return Batch_Name__c;
  }

  

  public void setBatch_Name__c(java.lang.String Batch_Name__c) {
    this.Batch_Name__c = Batch_Name__c;
    Batch_Name__c__is_set = true;
  }
  
  /**
   * element  : Batch_Total__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Batch_Total__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Batch_Total__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Batch_Total__c__is_set = false;

  private java.lang.Double Batch_Total__c;

  public java.lang.Double getBatch_Total__c() {
    return Batch_Total__c;
  }

  

  public void setBatch_Total__c(java.lang.Double Batch_Total__c) {
    this.Batch_Total__c = Batch_Total__c;
    Batch_Total__c__is_set = true;
  }
  
  /**
   * element  : Check_Count__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Check_Count__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Check_Count__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Check_Count__c__is_set = false;

  private java.lang.Double Check_Count__c;

  public java.lang.Double getCheck_Count__c() {
    return Check_Count__c;
  }

  

  public void setCheck_Count__c(java.lang.Double Check_Count__c) {
    this.Check_Count__c = Check_Count__c;
    Check_Count__c__is_set = true;
  }
  ...
  /**
   * element  : Direct_Deposit_Count__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Direct_Deposit_Count__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Direct_Deposit_Count__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Direct_Deposit_Count__c__is_set = false;

  private java.lang.Double Direct_Deposit_Count__c;

  public java.lang.Double getDirect_Deposit_Count__c() {
    return Direct_Deposit_Count__c;
  }

  

  public void setDirect_Deposit_Count__c(java.lang.Double Direct_Deposit_Count__c) {
    this.Direct_Deposit_Count__c = Direct_Deposit_Count__c;
    Direct_Deposit_Count__c__is_set = true;
  }
  ...
  /**
   * element  : Timecard_Count__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Timecard_Count__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Timecard_Count__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Timecard_Count__c__is_set = false;

  private java.lang.Double Timecard_Count__c;

  public java.lang.Double getTimecard_Count__c() {
    return Timecard_Count__c;
  }

  

  public void setTimecard_Count__c(java.lang.Double Timecard_Count__c) {
    this.Timecard_Count__c = Timecard_Count__c;
    Timecard_Count__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Payroll_Log__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeObject(__out, ACH_Total__c__typeInfo, ACH_Total__c, ACH_Total__c__is_set);
    ...
    __typeMapper.writeString(__out, Batch_Name__c__typeInfo, Batch_Name__c, Batch_Name__c__is_set);
    __typeMapper.writeObject(__out, Batch_Total__c__typeInfo, Batch_Total__c, Batch_Total__c__is_set);
    __typeMapper.writeObject(__out, Check_Count__c__typeInfo, Check_Count__c, Check_Count__c__is_set);
    ...
    __typeMapper.writeObject(__out, Direct_Deposit_Count__c__typeInfo, Direct_Deposit_Count__c, Direct_Deposit_Count__c__is_set);
    ...
    __typeMapper.writeObject(__out, Timecard_Count__c__typeInfo, Timecard_Count__c, Timecard_Count__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, ACH_Total__c__typeInfo)) {
      setACH_Total__c((java.lang.Double)__typeMapper.readObject(__in, ACH_Total__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Batch_Name__c__typeInfo)) {
      setBatch_Name__c((java.lang.String)__typeMapper.readString(__in, Batch_Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Batch_Total__c__typeInfo)) {
      setBatch_Total__c((java.lang.Double)__typeMapper.readObject(__in, Batch_Total__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Check_Count__c__typeInfo)) {
      setCheck_Count__c((java.lang.Double)__typeMapper.readObject(__in, Check_Count__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Direct_Deposit_Count__c__typeInfo)) {
      setDirect_Deposit_Count__c((java.lang.Double)__typeMapper.readObject(__in, Direct_Deposit_Count__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Timecard_Count__c__typeInfo)) {
      setTimecard_Count__c((java.lang.Double)__typeMapper.readObject(__in, Timecard_Count__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Payroll_Log__c ");
    sb.append(super.toString());
    sb.append(" ACH_Total__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ACH_Total__c)+"'\n");
    ...
    sb.append(" Batch_Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Batch_Name__c)+"'\n");
    sb.append(" Batch_Total__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Batch_Total__c)+"'\n");
    sb.append(" Check_Count__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Check_Count__c)+"'\n");
    ...
    sb.append(" Direct_Deposit_Count__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Direct_Deposit_Count__c)+"'\n");
    ...
    sb.append(" Timecard_Count__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Timecard_Count__c)+"'\n");

 ...
 */
public class LTATW__CS_LTAY_Windspeed__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public LTATW__CS_LTAY_Windspeed__c() {
  }
  ...
  /**
   * element  : LTATW__description__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo LTATW__description__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","LTATW__description__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean LTATW__description__c__is_set = false;

  private java.lang.String LTATW__description__c;

  public java.lang.String getLTATW__description__c() {
    return LTATW__description__c;
  }

  

  public void setLTATW__description__c(java.lang.String LTATW__description__c) {
    this.LTATW__description__c = LTATW__description__c;
    LTATW__description__c__is_set = true;
  }
  
  /**
   * element  : LTATW__max__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo LTATW__max__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","LTATW__max__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean LTATW__max__c__is_set = false;

  private java.lang.Double LTATW__max__c;

  public java.lang.Double getLTATW__max__c() {
    return LTATW__max__c;
  }

  

  public void setLTATW__max__c(java.lang.Double LTATW__max__c) {
    this.LTATW__max__c = LTATW__max__c;
    LTATW__max__c__is_set = true;
  }
  
  /**
   * element  : LTATW__min__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo LTATW__min__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","LTATW__min__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean LTATW__min__c__is_set = false;

  private java.lang.Double LTATW__min__c;

  public java.lang.Double getLTATW__min__c() {
    return LTATW__min__c;
  }

  

  public void setLTATW__min__c(java.lang.Double LTATW__min__c) {
    this.LTATW__min__c = LTATW__min__c;
    LTATW__min__c__is_set = true;
  }
  
  /**
   * element  : LTATW__rank__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo LTATW__rank__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","LTATW__rank__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean LTATW__rank__c__is_set = false;

  private java.lang.Double LTATW__rank__c;

  public java.lang.Double getLTATW__rank__c() {
    return LTATW__rank__c;
  }

  

  public void setLTATW__rank__c(java.lang.Double LTATW__rank__c) {
    this.LTATW__rank__c = LTATW__rank__c;
    LTATW__rank__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "LTATW__CS_LTAY_Windspeed__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, LTATW__description__c__typeInfo, LTATW__description__c, LTATW__description__c__is_set);
    __typeMapper.writeObject(__out, LTATW__max__c__typeInfo, LTATW__max__c, LTATW__max__c__is_set);
    __typeMapper.writeObject(__out, LTATW__min__c__typeInfo, LTATW__min__c, LTATW__min__c__is_set);
    __typeMapper.writeObject(__out, LTATW__rank__c__typeInfo, LTATW__rank__c, LTATW__rank__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, LTATW__description__c__typeInfo)) {
      setLTATW__description__c((java.lang.String)__typeMapper.readString(__in, LTATW__description__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, LTATW__max__c__typeInfo)) {
      setLTATW__max__c((java.lang.Double)__typeMapper.readObject(__in, LTATW__max__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, LTATW__min__c__typeInfo)) {
      setLTATW__min__c((java.lang.Double)__typeMapper.readObject(__in, LTATW__min__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, LTATW__rank__c__typeInfo)) {
      setLTATW__rank__c((java.lang.Double)__typeMapper.readObject(__in, LTATW__rank__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[LTATW__CS_LTAY_Windspeed__c ");
    ...
    sb.append(" LTATW__description__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(LTATW__description__c)+"'\n");
    sb.append(" LTATW__max__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(LTATW__max__c)+"'\n");
    sb.append(" LTATW__min__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(LTATW__min__c)+"'\n");
    sb.append(" LTATW__rank__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(LTATW__rank__c)+"'\n");

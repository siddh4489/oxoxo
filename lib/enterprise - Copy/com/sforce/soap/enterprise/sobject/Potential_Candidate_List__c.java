 ...
 */
public class Potential_Candidate_List__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Potential_Candidate_List__c() {
  }
  ...
  /**
   * element  : Expiration_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Expiration_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Expiration_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Expiration_Date__c__is_set = false;

  private java.util.Calendar Expiration_Date__c;

  public java.util.Calendar getExpiration_Date__c() {
    return Expiration_Date__c;
  }

  

  public void setExpiration_Date__c(java.util.Calendar Expiration_Date__c) {
    this.Expiration_Date__c = Expiration_Date__c;
    Expiration_Date__c__is_set = true;
  }
  ...
  /**
   * element  : Unemployment_Claim__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Unemployment_Claim__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Unemployment_Claim__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Potential_Candidate_List__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Expiration_Date__c__typeInfo, Expiration_Date__c, Expiration_Date__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Email__c__typeInfo)) {
      setEmail__c((java.lang.String)__typeMapper.readString(__in, Email__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Expiration_Date__c__typeInfo)) {
      setExpiration_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Expiration_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Potential_Candidate_List__c ");
    ...
    sb.append(" Expiration_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Expiration_Date__c)+"'\n");

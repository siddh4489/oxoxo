 ...
 */
public class DashboardFeed extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}Dashboard
   * java type: com.sforce.soap.enterprise.sobject.Dashboard
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","Dashboard",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "DashboardFeed");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.Dashboard)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.Dashboard.class));
    }
    __in.peekTag();

 ...
 */
public class Trade__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Trade__c() {
  ...
  /**
   * element  : DivisionType__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo DivisionType__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","DivisionType__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean DivisionType__c__is_set = false;

  private java.lang.String DivisionType__c;

  public java.lang.String getDivisionType__c() {
    return DivisionType__c;
  }

  

  public void setDivisionType__c(java.lang.String DivisionType__c) {
    this.DivisionType__c = DivisionType__c;
    DivisionType__c__is_set = true;
  }
  
  /**
   * element  : Division_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Division_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Division_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Division_Type__c__is_set = false;

  private java.lang.String Division_Type__c;

  public java.lang.String getDivision_Type__c() {
    return Division_Type__c;
  }

  

  public void setDivision_Type__c(java.lang.String Division_Type__c) {
    this.Division_Type__c = Division_Type__c;
    Division_Type__c__is_set = true;
  }
  ...
  /**
   * element  : National_ID_Code__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo National_ID_Code__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","National_ID_Code__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean National_ID_Code__c__is_set = false;

  private java.lang.String National_ID_Code__c;

  public java.lang.String getNational_ID_Code__c() {
    return National_ID_Code__c;
  }

  

  public void setNational_ID_Code__c(java.lang.String National_ID_Code__c) {
    this.National_ID_Code__c = National_ID_Code__c;
    National_ID_Code__c__is_set = true;
  }
  ...
  /**
   * element  : Skills__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo Skills__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Skills__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean Skills__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult Skills__r;

  public com.sforce.soap.enterprise.QueryResult getSkills__r() {
    return Skills__r;
  }

  

  public void setSkills__r(com.sforce.soap.enterprise.QueryResult Skills__r) {
    this.Skills__r = Skills__r;
    Skills__r__is_set = true;
  }
  ...
  /**
   * element  : Trade_Certifications__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo Trade_Certifications__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Trade_Certifications__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean Trade_Certifications__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult Trade_Certifications__r;

  public com.sforce.soap.enterprise.QueryResult getTrade_Certifications__r() {
    return Trade_Certifications__r;
  }

  

  public void setTrade_Certifications__r(com.sforce.soap.enterprise.QueryResult Trade_Certifications__r) {
    this.Trade_Certifications__r = Trade_Certifications__r;
    Trade_Certifications__r__is_set = true;
  }
  ...
  /**
   * element  : WC_Coverage_States__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo WC_Coverage_States__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WC_Coverage_States__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean WC_Coverage_States__c__is_set = false;

  private java.lang.String WC_Coverage_States__c;

  public java.lang.String getWC_Coverage_States__c() {
    return WC_Coverage_States__c;
  }

  

  public void setWC_Coverage_States__c(java.lang.String WC_Coverage_States__c) {
    this.WC_Coverage_States__c = WC_Coverage_States__c;
    WC_Coverage_States__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Trade__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, DivisionType__c__typeInfo, DivisionType__c, DivisionType__c__is_set);
    __typeMapper.writeString(__out, Division_Type__c__typeInfo, Division_Type__c, Division_Type__c__is_set);
    ...
    __typeMapper.writeString(__out, National_ID_Code__c__typeInfo, National_ID_Code__c, National_ID_Code__c__is_set);
    ...
    __typeMapper.writeObject(__out, Skills__r__typeInfo, Skills__r, Skills__r__is_set);
    ...
    __typeMapper.writeObject(__out, Trade_Certifications__r__typeInfo, Trade_Certifications__r, Trade_Certifications__r__is_set);
    __typeMapper.writeObject(__out, UserRecordAccess__typeInfo, UserRecordAccess, UserRecordAccess__is_set);
    __typeMapper.writeString(__out, WC_Coverage_States__c__typeInfo, WC_Coverage_States__c, WC_Coverage_States__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, DivisionType__c__typeInfo)) {
      setDivisionType__c((java.lang.String)__typeMapper.readString(__in, DivisionType__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Division_Type__c__typeInfo)) {
      setDivision_Type__c((java.lang.String)__typeMapper.readString(__in, Division_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, National_ID_Code__c__typeInfo)) {
      setNational_ID_Code__c((java.lang.String)__typeMapper.readString(__in, National_ID_Code__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Skills__r__typeInfo)) {
      setSkills__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Skills__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Trade_Certifications__r__typeInfo)) {
      setTrade_Certifications__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, Trade_Certifications__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, WC_Coverage_States__c__typeInfo)) {
      setWC_Coverage_States__c((java.lang.String)__typeMapper.readString(__in, WC_Coverage_States__c__typeInfo, java.lang.String.class));
    }
  }
  ...
  public String toString() {
    ...
    sb.append(" DivisionType__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(DivisionType__c)+"'\n");
    sb.append(" Division_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Division_Type__c)+"'\n");
    ...
    sb.append(" National_ID_Code__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(National_ID_Code__c)+"'\n");
    sb.append(" Notes=");
    ...
    sb.append(" Skills__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Skills__r)+"'\n");
    ...
    sb.append(" Trade_Certifications__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Trade_Certifications__r)+"'\n");
    sb.append(" UserRecordAccess=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(UserRecordAccess)+"'\n");
    sb.append(" WC_Coverage_States__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(WC_Coverage_States__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
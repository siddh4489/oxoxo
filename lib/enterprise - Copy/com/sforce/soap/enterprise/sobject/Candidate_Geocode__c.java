 ...
 */
public class Candidate_Geocode__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Candidate_Geocode__c() {
  }
  ...
  /**
   * element  : Distance__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Distance__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Distance__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Distance__c__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Candidate_Geocode__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Distance__c__typeInfo, Distance__c, Distance__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Distance__c__typeInfo)) {
      setDistance__c((java.lang.Double)__typeMapper.readObject(__in, Distance__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Candidate_Geocode__c ");
    ...
    sb.append(" Distance__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Distance__c)+"'\n");

 ...
 */
public class Guarantee__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Guarantee__c() {
  ...
  /**
   * element  : Number_of_Hours__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Number_of_Hours__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Number_of_Hours__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Number_of_Hours__c__is_set = false;

  private java.lang.Double Number_of_Hours__c;

  public java.lang.Double getNumber_of_Hours__c() {
    return Number_of_Hours__c;
  }

  

  public void setNumber_of_Hours__c(java.lang.Double Number_of_Hours__c) {
    this.Number_of_Hours__c = Number_of_Hours__c;
    Number_of_Hours__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Guarantee__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Number_of_Hours__c__typeInfo, Number_of_Hours__c, Number_of_Hours__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Number_of_Hours__c__typeInfo)) {
      setNumber_of_Hours__c((java.lang.Double)__typeMapper.readObject(__in, Number_of_Hours__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Number_of_Hours__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Number_of_Hours__c)+"'\n");

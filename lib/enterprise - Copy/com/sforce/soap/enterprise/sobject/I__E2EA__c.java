 ...
 */
public class I__E2EA__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public I__E2EA__c() {
  ...
  /**
   * element  : i__BothIds__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__BothIds__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__BothIds__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean i__BothIds__c__is_set = false;

  private java.lang.String i__BothIds__c;

  public java.lang.String getI__BothIds__c() {
    return i__BothIds__c;
  }

  

  public void setI__BothIds__c(java.lang.String i__BothIds__c) {
    this.i__BothIds__c = i__BothIds__c;
    i__BothIds__c__is_set = true;
  }
  
  /**
   * element  : i__EmailAddr__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__EmailAddr__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__EmailAddr__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean i__EmailAddr__c__is_set = false;

  private java.lang.String i__EmailAddr__c;

  public java.lang.String getI__EmailAddr__c() {
    return i__EmailAddr__c;
  }

  

  public void setI__EmailAddr__c(java.lang.String i__EmailAddr__c) {
    this.i__EmailAddr__c = i__EmailAddr__c;
    i__EmailAddr__c__is_set = true;
  }
  
  /**
   * element  : i__EmailAddr__r of type {urn:sobject.enterprise.soap.sforce.com}i__EmailAddr__c
   * java type: com.sforce.soap.enterprise.sobject.I__EmailAddr__c
   */
  private static final com.sforce.ws.bind.TypeInfo i__EmailAddr__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__EmailAddr__r","urn:sobject.enterprise.soap.sforce.com","i__EmailAddr__c",0,1,true);

  private boolean i__EmailAddr__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.I__EmailAddr__c i__EmailAddr__r;

  public com.sforce.soap.enterprise.sobject.I__EmailAddr__c getI__EmailAddr__r() {
    return i__EmailAddr__r;
  }

  

  public void setI__EmailAddr__r(com.sforce.soap.enterprise.sobject.I__EmailAddr__c i__EmailAddr__r) {
    this.i__EmailAddr__r = i__EmailAddr__r;
    i__EmailAddr__r__is_set = true;
  }
  
  /**
   * element  : i__Email__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__Email__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Email__c","urn:enterprise.soap.sforce.com","ID",0,1,true);
  ...
  /**
   * element  : i__Email__r of type {urn:sobject.enterprise.soap.sforce.com}i__Email__c
   * java type: com.sforce.soap.enterprise.sobject.I__Email__c
   */
  private static final com.sforce.ws.bind.TypeInfo i__Email__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Email__r","urn:sobject.enterprise.soap.sforce.com","i__Email__c",0,1,true);

  private boolean i__Email__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.I__Email__c i__Email__r;

  public com.sforce.soap.enterprise.sobject.I__Email__c getI__Email__r() {
    return i__Email__r;
  }

  

  public void setI__Email__r(com.sforce.soap.enterprise.sobject.I__Email__c i__Email__r) {
    this.i__Email__r = i__Email__r;
    i__Email__r__is_set = true;
  }
  ...
  /**
   * element  : i__PenPal__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__PenPal__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__PenPal__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean i__PenPal__c__is_set = false;

  private java.lang.String i__PenPal__c;

  public java.lang.String getI__PenPal__c() {
    return i__PenPal__c;
  }

  

  public void setI__PenPal__c(java.lang.String i__PenPal__c) {
    this.i__PenPal__c = i__PenPal__c;
    i__PenPal__c__is_set = true;
  }
  
  /**
   * element  : i__PenPal__r of type {urn:sobject.enterprise.soap.sforce.com}i__PenPal__c
   * java type: com.sforce.soap.enterprise.sobject.I__PenPal__c
   */
  private static final com.sforce.ws.bind.TypeInfo i__PenPal__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__PenPal__r","urn:sobject.enterprise.soap.sforce.com","i__PenPal__c",0,1,true);

  private boolean i__PenPal__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.I__PenPal__c i__PenPal__r;

  public com.sforce.soap.enterprise.sobject.I__PenPal__c getI__PenPal__r() {
    return i__PenPal__r;
  }

  

  public void setI__PenPal__r(com.sforce.soap.enterprise.sobject.I__PenPal__c i__PenPal__r) {
    this.i__PenPal__r = i__PenPal__r;
    i__PenPal__r__is_set = true;
  }
  
  /**
   * element  : i__Sender__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__Sender__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Sender__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean i__Sender__c__is_set = false;

  private java.lang.String i__Sender__c;

  public java.lang.String getI__Sender__c() {
    return i__Sender__c;
  }

  

  public void setI__Sender__c(java.lang.String i__Sender__c) {
    this.i__Sender__c = i__Sender__c;
    i__Sender__c__is_set = true;
  }
  
  /**
   * element  : i__Sender__r of type {urn:sobject.enterprise.soap.sforce.com}i__EmailAddr__c
   * java type: com.sforce.soap.enterprise.sobject.I__EmailAddr__c
   */
  private static final com.sforce.ws.bind.TypeInfo i__Sender__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Sender__r","urn:sobject.enterprise.soap.sforce.com","i__EmailAddr__c",0,1,true);

  private boolean i__Sender__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.I__EmailAddr__c i__Sender__r;

  public com.sforce.soap.enterprise.sobject.I__EmailAddr__c getI__Sender__r() {
    return i__Sender__r;
  }

  

  public void setI__Sender__r(com.sforce.soap.enterprise.sobject.I__EmailAddr__c i__Sender__r) {
    this.i__Sender__r = i__Sender__r;
    i__Sender__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "i__E2EA__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, i__BothIds__c__typeInfo, i__BothIds__c, i__BothIds__c__is_set);
    __typeMapper.writeString(__out, i__EmailAddr__c__typeInfo, i__EmailAddr__c, i__EmailAddr__c__is_set);
    __typeMapper.writeObject(__out, i__EmailAddr__r__typeInfo, i__EmailAddr__r, i__EmailAddr__r__is_set);
    __typeMapper.writeString(__out, i__Email__c__typeInfo, i__Email__c, i__Email__c__is_set);
    __typeMapper.writeObject(__out, i__Email__r__typeInfo, i__Email__r, i__Email__r__is_set);
    __typeMapper.writeString(__out, i__MsgDigest__c__typeInfo, i__MsgDigest__c, i__MsgDigest__c__is_set);
    __typeMapper.writeString(__out, i__PenPal__c__typeInfo, i__PenPal__c, i__PenPal__c__is_set);
    __typeMapper.writeObject(__out, i__PenPal__r__typeInfo, i__PenPal__r, i__PenPal__r__is_set);
    __typeMapper.writeString(__out, i__Sender__c__typeInfo, i__Sender__c, i__Sender__c__is_set);
    __typeMapper.writeObject(__out, i__Sender__r__typeInfo, i__Sender__r, i__Sender__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__BothIds__c__typeInfo)) {
      setI__BothIds__c((java.lang.String)__typeMapper.readString(__in, i__BothIds__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__EmailAddr__c__typeInfo)) {
      setI__EmailAddr__c((java.lang.String)__typeMapper.readString(__in, i__EmailAddr__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__EmailAddr__r__typeInfo)) {
      setI__EmailAddr__r((com.sforce.soap.enterprise.sobject.I__EmailAddr__c)__typeMapper.readObject(__in, i__EmailAddr__r__typeInfo, com.sforce.soap.enterprise.sobject.I__EmailAddr__c.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Email__r__typeInfo)) {
      setI__Email__r((com.sforce.soap.enterprise.sobject.I__Email__c)__typeMapper.readObject(__in, i__Email__r__typeInfo, com.sforce.soap.enterprise.sobject.I__Email__c.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__PenPal__c__typeInfo)) {
      setI__PenPal__c((java.lang.String)__typeMapper.readString(__in, i__PenPal__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__PenPal__r__typeInfo)) {
      setI__PenPal__r((com.sforce.soap.enterprise.sobject.I__PenPal__c)__typeMapper.readObject(__in, i__PenPal__r__typeInfo, com.sforce.soap.enterprise.sobject.I__PenPal__c.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Sender__c__typeInfo)) {
      setI__Sender__c((java.lang.String)__typeMapper.readString(__in, i__Sender__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Sender__r__typeInfo)) {
      setI__Sender__r((com.sforce.soap.enterprise.sobject.I__EmailAddr__c)__typeMapper.readObject(__in, i__Sender__r__typeInfo, com.sforce.soap.enterprise.sobject.I__EmailAddr__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" i__BothIds__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__BothIds__c)+"'\n");
    sb.append(" i__EmailAddr__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__EmailAddr__c)+"'\n");
    sb.append(" i__EmailAddr__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__EmailAddr__r)+"'\n");
    sb.append(" i__Email__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Email__c)+"'\n");
    sb.append(" i__Email__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Email__r)+"'\n");
    sb.append(" i__MsgDigest__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__MsgDigest__c)+"'\n");
    sb.append(" i__PenPal__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__PenPal__c)+"'\n");
    sb.append(" i__PenPal__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__PenPal__r)+"'\n");
    sb.append(" i__Sender__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Sender__c)+"'\n");
    sb.append(" i__Sender__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Sender__r)+"'\n");

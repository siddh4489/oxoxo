 ...
 */
public class Dupcheck__dcIndex__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Dupcheck__dcIndex__c() {
  }
  ...
  /**
   * element  : dupcheck__RecordType__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__RecordType__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__RecordType__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__RecordType__c__is_set = false;

  private java.lang.String dupcheck__RecordType__c;

  public java.lang.String getDupcheck__RecordType__c() {
    return dupcheck__RecordType__c;
  }

  

  public void setDupcheck__RecordType__c(java.lang.String dupcheck__RecordType__c) {
    this.dupcheck__RecordType__c = dupcheck__RecordType__c;
    dupcheck__RecordType__c__is_set = true;
  }
  
  /**
   * element  : dupcheck__index__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__index__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__index__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__index__c__is_set = false;

  private java.lang.String dupcheck__index__c;

  public java.lang.String getDupcheck__index__c() {
    return dupcheck__index__c;
  }

  

  public void setDupcheck__index__c(java.lang.String dupcheck__index__c) {
    this.dupcheck__index__c = dupcheck__index__c;
    dupcheck__index__c__is_set = true;
  }
  
  /**
   * element  : dupcheck__objectPrefix__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__objectPrefix__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__objectPrefix__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__objectPrefix__c__is_set = false;

  private java.lang.String dupcheck__objectPrefix__c;

  public java.lang.String getDupcheck__objectPrefix__c() {
    return dupcheck__objectPrefix__c;
  }

  

  public void setDupcheck__objectPrefix__c(java.lang.String dupcheck__objectPrefix__c) {
    this.dupcheck__objectPrefix__c = dupcheck__objectPrefix__c;
    dupcheck__objectPrefix__c__is_set = true;
  }
  
  /**
   * element  : dupcheck__personAccount__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__personAccount__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__personAccount__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean dupcheck__personAccount__c__is_set = false;

  private java.lang.Boolean dupcheck__personAccount__c;

  public java.lang.Boolean getDupcheck__personAccount__c() {
    return dupcheck__personAccount__c;
  }

  

  public void setDupcheck__personAccount__c(java.lang.Boolean dupcheck__personAccount__c) {
    this.dupcheck__personAccount__c = dupcheck__personAccount__c;
    dupcheck__personAccount__c__is_set = true;
  }
  
  /**
   * element  : dupcheck__recordTypeId__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__recordTypeId__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__recordTypeId__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__recordTypeId__c__is_set = false;

  private java.lang.String dupcheck__recordTypeId__c;

  public java.lang.String getDupcheck__recordTypeId__c() {
    return dupcheck__recordTypeId__c;
  }

  

  public void setDupcheck__recordTypeId__c(java.lang.String dupcheck__recordTypeId__c) {
    this.dupcheck__recordTypeId__c = dupcheck__recordTypeId__c;
    dupcheck__recordTypeId__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "dupcheck__dcIndex__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, dupcheck__RecordType__c__typeInfo, dupcheck__RecordType__c, dupcheck__RecordType__c__is_set);
    __typeMapper.writeString(__out, dupcheck__index__c__typeInfo, dupcheck__index__c, dupcheck__index__c__is_set);
    __typeMapper.writeString(__out, dupcheck__objectPrefix__c__typeInfo, dupcheck__objectPrefix__c, dupcheck__objectPrefix__c__is_set);
    __typeMapper.writeObject(__out, dupcheck__personAccount__c__typeInfo, dupcheck__personAccount__c, dupcheck__personAccount__c__is_set);
    __typeMapper.writeString(__out, dupcheck__recordTypeId__c__typeInfo, dupcheck__recordTypeId__c, dupcheck__recordTypeId__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__RecordType__c__typeInfo)) {
      setDupcheck__RecordType__c((java.lang.String)__typeMapper.readString(__in, dupcheck__RecordType__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__index__c__typeInfo)) {
      setDupcheck__index__c((java.lang.String)__typeMapper.readString(__in, dupcheck__index__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__objectPrefix__c__typeInfo)) {
      setDupcheck__objectPrefix__c((java.lang.String)__typeMapper.readString(__in, dupcheck__objectPrefix__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__personAccount__c__typeInfo)) {
      setDupcheck__personAccount__c((java.lang.Boolean)__typeMapper.readObject(__in, dupcheck__personAccount__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__recordTypeId__c__typeInfo)) {
      setDupcheck__recordTypeId__c((java.lang.String)__typeMapper.readString(__in, dupcheck__recordTypeId__c__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Dupcheck__dcIndex__c ");
    ...
    sb.append(" dupcheck__RecordType__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__RecordType__c)+"'\n");
    sb.append(" dupcheck__index__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__index__c)+"'\n");
    sb.append(" dupcheck__objectPrefix__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__objectPrefix__c)+"'\n");
    sb.append(" dupcheck__personAccount__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__personAccount__c)+"'\n");
    sb.append(" dupcheck__recordTypeId__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__recordTypeId__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
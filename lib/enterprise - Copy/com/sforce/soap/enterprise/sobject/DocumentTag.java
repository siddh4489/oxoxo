 ...
 */
public class DocumentTag extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public DocumentTag() {
  ...
  /**
   * element  : Item of type {urn:sobject.enterprise.soap.sforce.com}Document
   * java type: com.sforce.soap.enterprise.sobject.Document
   */
  private static final com.sforce.ws.bind.TypeInfo Item__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Item","urn:sobject.enterprise.soap.sforce.com","Document",0,1,true);

  private boolean Item__is_set = false;

  private com.sforce.soap.enterprise.sobject.Document Item;

  public com.sforce.soap.enterprise.sobject.Document getItem() {
    return Item;
  }

  

  public void setItem(com.sforce.soap.enterprise.sobject.Document Item) {
    this.Item = Item;
    Item__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "DocumentTag");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Item__typeInfo)) {
      setItem((com.sforce.soap.enterprise.sobject.Document)__typeMapper.readObject(__in, Item__typeInfo, com.sforce.soap.enterprise.sobject.Document.class));
    }
    __in.peekTag();

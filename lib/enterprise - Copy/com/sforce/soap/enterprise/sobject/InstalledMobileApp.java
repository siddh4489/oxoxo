...
public class InstalledMobileApp extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  /**
   * element  : ConnectedApplication of type {urn:sobject.enterprise.soap.sforce.com}ConnectedApplication
   * java type: com.sforce.soap.enterprise.sobject.ConnectedApplication
   */
  private static final com.sforce.ws.bind.TypeInfo ConnectedApplication__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ConnectedApplication","urn:sobject.enterprise.soap.sforce.com","ConnectedApplication",0,1,true);

  private boolean ConnectedApplication__is_set = false;
  ...
  public void setConnectedApplication(com.sforce.soap.enterprise.sobject.ConnectedApplication ConnectedApplication) {
    ...
    ConnectedApplication__is_set = true;
  }
  
  /**
   * element  : ConnectedApplicationId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo ConnectedApplicationId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ConnectedApplicationId","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean ConnectedApplicationId__is_set = false;
  ...
  public void setConnectedApplicationId(java.lang.String ConnectedApplicationId) {
    ...
    ConnectedApplicationId__is_set = true;
  }
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeObject(__out, ConnectedApplication__typeInfo, ConnectedApplication, ConnectedApplication__is_set);
    __typeMapper.writeString(__out, ConnectedApplicationId__typeInfo, ConnectedApplicationId, ConnectedApplicationId__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, ConnectedApplication__typeInfo)) {
      setConnectedApplication((com.sforce.soap.enterprise.sobject.ConnectedApplication)__typeMapper.readObject(__in, ConnectedApplication__typeInfo, com.sforce.soap.enterprise.sobject.ConnectedApplication.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, ConnectedApplicationId__typeInfo)) {
      setConnectedApplicationId((java.lang.String)__typeMapper.readString(__in, ConnectedApplicationId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ConnectedApplication)+"'\n");
    sb.append(" ConnectedApplicationId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ConnectedApplicationId)+"'\n");
    sb.append(" CreatedBy=");

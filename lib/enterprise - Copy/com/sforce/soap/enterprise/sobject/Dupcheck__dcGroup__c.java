 ...
 */
public class Dupcheck__dcGroup__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Dupcheck__dcGroup__c() {
  }
  ...
  /**
   * element  : dupcheck__highScore__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__highScore__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__highScore__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean dupcheck__highScore__c__is_set = false;

  private java.lang.Double dupcheck__highScore__c;

  public java.lang.Double getDupcheck__highScore__c() {
    return dupcheck__highScore__c;
  }

  

  public void setDupcheck__highScore__c(java.lang.Double dupcheck__highScore__c) {
    this.dupcheck__highScore__c = dupcheck__highScore__c;
    dupcheck__highScore__c__is_set = true;
  }
  ...
  /**
   * element  : dupcheck__mergeData__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__mergeData__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__mergeData__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__mergeData__c__is_set = false;

  private java.lang.String dupcheck__mergeData__c;

  public java.lang.String getDupcheck__mergeData__c() {
    return dupcheck__mergeData__c;
  }

  

  public void setDupcheck__mergeData__c(java.lang.String dupcheck__mergeData__c) {
    this.dupcheck__mergeData__c = dupcheck__mergeData__c;
    dupcheck__mergeData__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "dupcheck__dcGroup__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, dupcheck__highScore__c__typeInfo, dupcheck__highScore__c, dupcheck__highScore__c__is_set);
    __typeMapper.writeObject(__out, dupcheck__lowScore__c__typeInfo, dupcheck__lowScore__c, dupcheck__lowScore__c__is_set);
    __typeMapper.writeString(__out, dupcheck__mergeData__c__typeInfo, dupcheck__mergeData__c, dupcheck__mergeData__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__highScore__c__typeInfo)) {
      setDupcheck__highScore__c((java.lang.Double)__typeMapper.readObject(__in, dupcheck__highScore__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__mergeData__c__typeInfo)) {
      setDupcheck__mergeData__c((java.lang.String)__typeMapper.readString(__in, dupcheck__mergeData__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" dupcheck__highScore__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__highScore__c)+"'\n");
    sb.append(" dupcheck__lowScore__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__lowScore__c)+"'\n");
    sb.append(" dupcheck__mergeData__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__mergeData__c)+"'\n");

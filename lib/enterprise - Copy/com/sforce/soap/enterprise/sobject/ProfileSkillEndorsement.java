 ...
 */
public class ProfileSkillEndorsement extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public ProfileSkillEndorsement() {
  }
  ...
  /**
   * element  : ProfileSkillUser of type {urn:sobject.enterprise.soap.sforce.com}ProfileSkillUser
   * java type: com.sforce.soap.enterprise.sobject.ProfileSkillUser
   */
  private static final com.sforce.ws.bind.TypeInfo ProfileSkillUser__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ProfileSkillUser","urn:sobject.enterprise.soap.sforce.com","ProfileSkillUser",0,1,true);

  private boolean ProfileSkillUser__is_set = false;

  private com.sforce.soap.enterprise.sobject.ProfileSkillUser ProfileSkillUser;

  public com.sforce.soap.enterprise.sobject.ProfileSkillUser getProfileSkillUser() {
    return ProfileSkillUser;
  }

  

  public void setProfileSkillUser(com.sforce.soap.enterprise.sobject.ProfileSkillUser ProfileSkillUser) {
    this.ProfileSkillUser = ProfileSkillUser;
    ProfileSkillUser__is_set = true;
  }
  
  /**
   * element  : ProfileSkillUserId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo ProfileSkillUserId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ProfileSkillUserId","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean ProfileSkillUserId__is_set = false;

  private java.lang.String ProfileSkillUserId;

  public java.lang.String getProfileSkillUserId() {
    return ProfileSkillUserId;
  }

  

  public void setProfileSkillUserId(java.lang.String ProfileSkillUserId) {
    this.ProfileSkillUserId = ProfileSkillUserId;
    ProfileSkillUserId__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "ProfileSkillEndorsement");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, ProfileSkillUser__typeInfo, ProfileSkillUser, ProfileSkillUser__is_set);
    __typeMapper.writeString(__out, ProfileSkillUserId__typeInfo, ProfileSkillUserId, ProfileSkillUserId__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, ProfileSkillUser__typeInfo)) {
      setProfileSkillUser((com.sforce.soap.enterprise.sobject.ProfileSkillUser)__typeMapper.readObject(__in, ProfileSkillUser__typeInfo, com.sforce.soap.enterprise.sobject.ProfileSkillUser.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, ProfileSkillUserId__typeInfo)) {
      setProfileSkillUserId((java.lang.String)__typeMapper.readString(__in, ProfileSkillUserId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ProfileSkillUser)+"'\n");
    sb.append(" ProfileSkillUserId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ProfileSkillUserId)+"'\n");

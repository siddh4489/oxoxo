...
public class UserAppMenuCustomization extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  /**
   * element  : Application of type {urn:sobject.enterprise.soap.sforce.com}Name
   * java type: com.sforce.soap.enterprise.sobject.Name
   */
  private static final com.sforce.ws.bind.TypeInfo Application__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Application","urn:sobject.enterprise.soap.sforce.com","Name",0,1,true);
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeObject(__out, Application__typeInfo, Application, Application__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Application__typeInfo)) {
      setApplication((com.sforce.soap.enterprise.sobject.Name)__typeMapper.readObject(__in, Application__typeInfo, com.sforce.soap.enterprise.sobject.Name.class));
    }
    __in.peekTag();

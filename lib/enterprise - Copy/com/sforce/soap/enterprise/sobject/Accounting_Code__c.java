 ...
 */
public class Accounting_Code__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Accounting_Code__c() {
  }
  ...
  /**
   * element  : Default_Bill_Factor__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Default_Bill_Factor__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Default_Bill_Factor__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Default_Bill_Factor__c__is_set = false;

  private java.lang.Double Default_Bill_Factor__c;

  public java.lang.Double getDefault_Bill_Factor__c() {
    return Default_Bill_Factor__c;
  }

  

  public void setDefault_Bill_Factor__c(java.lang.Double Default_Bill_Factor__c) {
    this.Default_Bill_Factor__c = Default_Bill_Factor__c;
    Default_Bill_Factor__c__is_set = true;
  }
  
  /**
   * element  : Default_Pay_Factor__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Default_Pay_Factor__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Default_Pay_Factor__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Default_Pay_Factor__c__is_set = false;

  private java.lang.Double Default_Pay_Factor__c;

  public java.lang.Double getDefault_Pay_Factor__c() {
    return Default_Pay_Factor__c;
  }

  

  public void setDefault_Pay_Factor__c(java.lang.Double Default_Pay_Factor__c) {
    this.Default_Pay_Factor__c = Default_Pay_Factor__c;
    Default_Pay_Factor__c__is_set = true;
  }
  ...
  /**
   * element  : Expense__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo Expense__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Expense__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean Expense__c__is_set = false;

  private java.lang.Boolean Expense__c;

  public java.lang.Boolean getExpense__c() {
    return Expense__c;
  }

  

  public void setExpense__c(java.lang.Boolean Expense__c) {
    this.Expense__c = Expense__c;
    Expense__c__is_set = true;
  }
  ...
  /**
   * element  : Great_Plains_Code__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Great_Plains_Code__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Great_Plains_Code__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Great_Plains_Code__c__is_set = false;

  private java.lang.String Great_Plains_Code__c;

  public java.lang.String getGreat_Plains_Code__c() {
    return Great_Plains_Code__c;
  }

  

  public void setGreat_Plains_Code__c(java.lang.String Great_Plains_Code__c) {
    this.Great_Plains_Code__c = Great_Plains_Code__c;
    Great_Plains_Code__c__is_set = true;
  }
  ...
  /**
   * element  : Sequence_ID__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Sequence_ID__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Sequence_ID__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Sequence_ID__c__is_set = false;

  private java.lang.Double Sequence_ID__c;

  public java.lang.Double getSequence_ID__c() {
    return Sequence_ID__c;
  }

  

  public void setSequence_ID__c(java.lang.Double Sequence_ID__c) {
    this.Sequence_ID__c = Sequence_ID__c;
    Sequence_ID__c__is_set = true;
  }
  ...
  /**
   * element  : Subject_to_Burden__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo Subject_to_Burden__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Subject_to_Burden__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean Subject_to_Burden__c__is_set = false;

  private java.lang.Boolean Subject_to_Burden__c;

  public java.lang.Boolean getSubject_to_Burden__c() {
    return Subject_to_Burden__c;
  }

  

  public void setSubject_to_Burden__c(java.lang.Boolean Subject_to_Burden__c) {
    this.Subject_to_Burden__c = Subject_to_Burden__c;
    Subject_to_Burden__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Accounting_Code__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Default_Bill_Factor__c__typeInfo, Default_Bill_Factor__c, Default_Bill_Factor__c__is_set);
    __typeMapper.writeObject(__out, Default_Pay_Factor__c__typeInfo, Default_Pay_Factor__c, Default_Pay_Factor__c__is_set);
    ...
    __typeMapper.writeObject(__out, Expense__c__typeInfo, Expense__c, Expense__c__is_set);
    ...
    __typeMapper.writeString(__out, Great_Plains_Code__c__typeInfo, Great_Plains_Code__c, Great_Plains_Code__c__is_set);
    ...
    __typeMapper.writeObject(__out, Sequence_ID__c__typeInfo, Sequence_ID__c, Sequence_ID__c__is_set);
    __typeMapper.writeObject(__out, Shares__typeInfo, Shares, Shares__is_set);
    __typeMapper.writeObject(__out, Subject_to_Burden__c__typeInfo, Subject_to_Burden__c, Subject_to_Burden__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Default_Bill_Factor__c__typeInfo)) {
      setDefault_Bill_Factor__c((java.lang.Double)__typeMapper.readObject(__in, Default_Bill_Factor__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Default_Pay_Factor__c__typeInfo)) {
      setDefault_Pay_Factor__c((java.lang.Double)__typeMapper.readObject(__in, Default_Pay_Factor__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Expense__c__typeInfo)) {
      setExpense__c((java.lang.Boolean)__typeMapper.readObject(__in, Expense__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Great_Plains_Code__c__typeInfo)) {
      setGreat_Plains_Code__c((java.lang.String)__typeMapper.readString(__in, Great_Plains_Code__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Sequence_ID__c__typeInfo)) {
      setSequence_ID__c((java.lang.Double)__typeMapper.readObject(__in, Sequence_ID__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Subject_to_Burden__c__typeInfo)) {
      setSubject_to_Burden__c((java.lang.Boolean)__typeMapper.readObject(__in, Subject_to_Burden__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Default_Bill_Factor__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Default_Bill_Factor__c)+"'\n");
    sb.append(" Default_Pay_Factor__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Default_Pay_Factor__c)+"'\n");
    ...
    sb.append(" Expense__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Expense__c)+"'\n");
    sb.append(" FeedSubscriptionsForEntity=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(FeedSubscriptionsForEntity)+"'\n");
    sb.append(" Great_Plains_Code__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Great_Plains_Code__c)+"'\n");
    sb.append(" Histories=");
    ...
    sb.append(" Sequence_ID__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Sequence_ID__c)+"'\n");
    sb.append(" Shares=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Shares)+"'\n");
    sb.append(" Subject_to_Burden__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Subject_to_Burden__c)+"'\n");

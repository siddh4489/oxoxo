 ...
 */
public class Approval extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Approval() {
  ...
  /**
   * element  : ApproveComment of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo ApproveComment__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ApproveComment","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean ApproveComment__is_set = false;
  ...
  /**
   * element  : RequestComment of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo RequestComment__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","RequestComment","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean RequestComment__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Approval");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeString(__out, ApproveComment__typeInfo, ApproveComment, ApproveComment__is_set);
    ...
    __typeMapper.writeString(__out, RequestComment__typeInfo, RequestComment, RequestComment__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, ApproveComment__typeInfo)) {
      setApproveComment((java.lang.String)__typeMapper.readString(__in, ApproveComment__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, RequestComment__typeInfo)) {
      setRequestComment((java.lang.String)__typeMapper.readString(__in, RequestComment__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ApproveComment)+"'\n");
    sb.append(" CreatedBy=");
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(RequestComment)+"'\n");
    sb.append(" Status=");

 ...
 */
public class Vr__VR_Email_History_Lead__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Vr__VR_Email_History_Lead__c() {
  }
  ...
  /**
   * element  : vr__Lead__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo vr__Lead__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","vr__Lead__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean vr__Lead__c__is_set = false;

  private java.lang.String vr__Lead__c;

  public java.lang.String getVr__Lead__c() {
    return vr__Lead__c;
  }

  

  public void setVr__Lead__c(java.lang.String vr__Lead__c) {
    this.vr__Lead__c = vr__Lead__c;
    vr__Lead__c__is_set = true;
  }
  
  /**
   * element  : vr__Lead__r of type {urn:sobject.enterprise.soap.sforce.com}Lead
   * java type: com.sforce.soap.enterprise.sobject.Lead
   */
  private static final com.sforce.ws.bind.TypeInfo vr__Lead__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","vr__Lead__r","urn:sobject.enterprise.soap.sforce.com","Lead",0,1,true);

  private boolean vr__Lead__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Lead vr__Lead__r;

  public com.sforce.soap.enterprise.sobject.Lead getVr__Lead__r() {
    return vr__Lead__r;
  }

  

  public void setVr__Lead__r(com.sforce.soap.enterprise.sobject.Lead vr__Lead__r) {
    this.vr__Lead__r = vr__Lead__r;
    vr__Lead__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "vr__VR_Email_History_Lead__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, vr__Lead__c__typeInfo, vr__Lead__c, vr__Lead__c__is_set);
    __typeMapper.writeObject(__out, vr__Lead__r__typeInfo, vr__Lead__r, vr__Lead__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, vr__Lead__c__typeInfo)) {
      setVr__Lead__c((java.lang.String)__typeMapper.readString(__in, vr__Lead__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, vr__Lead__r__typeInfo)) {
      setVr__Lead__r((com.sforce.soap.enterprise.sobject.Lead)__typeMapper.readObject(__in, vr__Lead__r__typeInfo, com.sforce.soap.enterprise.sobject.Lead.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Vr__VR_Email_History_Lead__c ");
    ...
    sb.append(" vr__Lead__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(vr__Lead__c)+"'\n");
    sb.append(" vr__Lead__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(vr__Lead__r)+"'\n");

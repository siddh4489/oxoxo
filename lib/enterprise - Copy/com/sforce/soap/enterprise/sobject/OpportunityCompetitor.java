 ...
 */
public class OpportunityCompetitor extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : CompetitorName of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo CompetitorName__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CompetitorName","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean CompetitorName__is_set = false;
  ...
  /**
   * element  : Strengths of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Strengths__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Strengths","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Strengths__is_set = false;
  ...
  /**
   * element  : Weaknesses of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Weaknesses__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Weaknesses","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Weaknesses__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "OpportunityCompetitor");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeString(__out, CompetitorName__typeInfo, CompetitorName, CompetitorName__is_set);
    ...
    __typeMapper.writeString(__out, Strengths__typeInfo, Strengths, Strengths__is_set);
    __typeMapper.writeObject(__out, SystemModstamp__typeInfo, SystemModstamp, SystemModstamp__is_set);
    __typeMapper.writeString(__out, Weaknesses__typeInfo, Weaknesses, Weaknesses__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, CompetitorName__typeInfo)) {
      setCompetitorName((java.lang.String)__typeMapper.readString(__in, CompetitorName__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Strengths__typeInfo)) {
      setStrengths((java.lang.String)__typeMapper.readString(__in, Strengths__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Weaknesses__typeInfo)) {
      setWeaknesses((java.lang.String)__typeMapper.readString(__in, Weaknesses__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[OpportunityCompetitor ");
    sb.append(super.toString());
    sb.append(" CompetitorName=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CompetitorName)+"'\n");
    sb.append(" CreatedBy=");
    ...
    sb.append(" Strengths=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Strengths)+"'\n");
    sb.append(" SystemModstamp=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SystemModstamp)+"'\n");
    sb.append(" Weaknesses=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Weaknesses)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
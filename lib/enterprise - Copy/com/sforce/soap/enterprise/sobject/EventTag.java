 ...
 */
public class EventTag extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public EventTag() {
  ...
  /**
   * element  : Item of type {urn:sobject.enterprise.soap.sforce.com}Event
   * java type: com.sforce.soap.enterprise.sobject.Event
   */
  private static final com.sforce.ws.bind.TypeInfo Item__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Item","urn:sobject.enterprise.soap.sforce.com","Event",0,1,true);

  private boolean Item__is_set = false;

  private com.sforce.soap.enterprise.sobject.Event Item;

  public com.sforce.soap.enterprise.sobject.Event getItem() {
    return Item;
  }

  

  public void setItem(com.sforce.soap.enterprise.sobject.Event Item) {
    this.Item = Item;
    Item__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "EventTag");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Item__typeInfo)) {
      setItem((com.sforce.soap.enterprise.sobject.Event)__typeMapper.readObject(__in, Item__typeInfo, com.sforce.soap.enterprise.sobject.Event.class));
    }
    __in.peekTag();

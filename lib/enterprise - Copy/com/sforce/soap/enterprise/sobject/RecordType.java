 ...
 */
public class RecordType extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public RecordType() {
  ...
  /**
   * element  : BusinessProcessId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo BusinessProcessId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","BusinessProcessId","urn:enterprise.soap.sforce.com","ID",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "RecordType");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeString(__out, BusinessProcessId__typeInfo, BusinessProcessId, BusinessProcessId__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, BusinessProcessId__typeInfo)) {
      setBusinessProcessId((java.lang.String)__typeMapper.readString(__in, BusinessProcessId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(BusinessProcessId)+"'\n");
    sb.append(" CreatedBy=");

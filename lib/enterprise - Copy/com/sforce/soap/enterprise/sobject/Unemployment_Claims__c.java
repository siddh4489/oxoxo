 ...
 */
public class Unemployment_Claims__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Unemployment_Claims__c() {
  }
  ...
  /**
   * element  : Claim_Count__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Claim_Count__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Claim_Count__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Claim_Count__c__is_set = false;

  private java.lang.Double Claim_Count__c;

  public java.lang.Double getClaim_Count__c() {
    return Claim_Count__c;
  }

  

  public void setClaim_Count__c(java.lang.Double Claim_Count__c) {
    this.Claim_Count__c = Claim_Count__c;
    Claim_Count__c__is_set = true;
  }
  
  /**
   * element  : Claim_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Claim_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Claim_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Claim_Date__c__is_set = false;

  private java.util.Calendar Claim_Date__c;

  public java.util.Calendar getClaim_Date__c() {
    return Claim_Date__c;
  }

  

  public void setClaim_Date__c(java.util.Calendar Claim_Date__c) {
    this.Claim_Date__c = Claim_Date__c;
    Claim_Date__c__is_set = true;
  }
  
  /**
   * element  : Claim_Notice_Received__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Claim_Notice_Received__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Claim_Notice_Received__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Claim_Notice_Received__c__is_set = false;

  private java.util.Calendar Claim_Notice_Received__c;

  public java.util.Calendar getClaim_Notice_Received__c() {
    return Claim_Notice_Received__c;
  }

  

  public void setClaim_Notice_Received__c(java.util.Calendar Claim_Notice_Received__c) {
    this.Claim_Notice_Received__c = Claim_Notice_Received__c;
    Claim_Notice_Received__c__is_set = true;
  }
  
  /**
   * element  : Claim_State__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Claim_State__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Claim_State__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Claim_State__c__is_set = false;

  private java.lang.String Claim_State__c;

  public java.lang.String getClaim_State__c() {
    return Claim_State__c;
  }

  

  public void setClaim_State__c(java.lang.String Claim_State__c) {
    this.Claim_State__c = Claim_State__c;
    Claim_State__c__is_set = true;
  }
  
  /**
   * element  : Claim_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Claim_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Claim_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Claim_Type__c__is_set = false;

  private java.lang.String Claim_Type__c;

  public java.lang.String getClaim_Type__c() {
    return Claim_Type__c;
  }

  

  public void setClaim_Type__c(java.lang.String Claim_Type__c) {
    this.Claim_Type__c = Claim_Type__c;
    Claim_Type__c__is_set = true;
  }
  ...
  /**
   * element  : Company__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Company__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Company__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Company__c__is_set = false;
  ...
  /**
   * element  : Most_Recent_Charge__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Most_Recent_Charge__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Most_Recent_Charge__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Most_Recent_Charge__c__is_set = false;

  private java.util.Calendar Most_Recent_Charge__c;

  public java.util.Calendar getMost_Recent_Charge__c() {
    return Most_Recent_Charge__c;
  }

  

  public void setMost_Recent_Charge__c(java.util.Calendar Most_Recent_Charge__c) {
    this.Most_Recent_Charge__c = Most_Recent_Charge__c;
    Most_Recent_Charge__c__is_set = true;
  }
  ...
  /**
   * element  : UE_Account_Number__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo UE_Account_Number__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","UE_Account_Number__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean UE_Account_Number__c__is_set = false;

  private java.lang.String UE_Account_Number__c;

  public java.lang.String getUE_Account_Number__c() {
    return UE_Account_Number__c;
  }

  

  public void setUE_Account_Number__c(java.lang.String UE_Account_Number__c) {
    this.UE_Account_Number__c = UE_Account_Number__c;
    UE_Account_Number__c__is_set = true;
  }
  
  /**
   * element  : UE_Claim_Charges__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo UE_Claim_Charges__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","UE_Claim_Charges__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean UE_Claim_Charges__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult UE_Claim_Charges__r;

  public com.sforce.soap.enterprise.QueryResult getUE_Claim_Charges__r() {
    return UE_Claim_Charges__r;
  }

  

  public void setUE_Claim_Charges__r(com.sforce.soap.enterprise.QueryResult UE_Claim_Charges__r) {
    this.UE_Claim_Charges__r = UE_Claim_Charges__r;
    UE_Claim_Charges__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Unemployment_Claims__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Claim_Count__c__typeInfo, Claim_Count__c, Claim_Count__c__is_set);
    __typeMapper.writeObject(__out, Claim_Date__c__typeInfo, Claim_Date__c, Claim_Date__c__is_set);
    __typeMapper.writeObject(__out, Claim_Notice_Received__c__typeInfo, Claim_Notice_Received__c, Claim_Notice_Received__c__is_set);
    __typeMapper.writeString(__out, Claim_State__c__typeInfo, Claim_State__c, Claim_State__c__is_set);
    __typeMapper.writeString(__out, Claim_Type__c__typeInfo, Claim_Type__c, Claim_Type__c__is_set);
    __typeMapper.writeObject(__out, CombinedAttachments__typeInfo, CombinedAttachments, CombinedAttachments__is_set);
    __typeMapper.writeString(__out, Company__c__typeInfo, Company__c, Company__c__is_set);
    ...
    __typeMapper.writeObject(__out, Most_Recent_Charge__c__typeInfo, Most_Recent_Charge__c, Most_Recent_Charge__c__is_set);
    ...
    __typeMapper.writeString(__out, UE_Account_Number__c__typeInfo, UE_Account_Number__c, UE_Account_Number__c__is_set);
    __typeMapper.writeObject(__out, UE_Claim_Charges__r__typeInfo, UE_Claim_Charges__r, UE_Claim_Charges__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Claim_Count__c__typeInfo)) {
      setClaim_Count__c((java.lang.Double)__typeMapper.readObject(__in, Claim_Count__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Claim_Date__c__typeInfo)) {
      setClaim_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Claim_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Claim_Notice_Received__c__typeInfo)) {
      setClaim_Notice_Received__c((java.util.Calendar)__typeMapper.readObject(__in, Claim_Notice_Received__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Claim_State__c__typeInfo)) {
      setClaim_State__c((java.lang.String)__typeMapper.readString(__in, Claim_State__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Claim_Type__c__typeInfo)) {
      setClaim_Type__c((java.lang.String)__typeMapper.readString(__in, Claim_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Company__c__typeInfo)) {
      setCompany__c((java.lang.String)__typeMapper.readString(__in, Company__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Most_Recent_Charge__c__typeInfo)) {
      setMost_Recent_Charge__c((java.util.Calendar)__typeMapper.readObject(__in, Most_Recent_Charge__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, UE_Account_Number__c__typeInfo)) {
      setUE_Account_Number__c((java.lang.String)__typeMapper.readString(__in, UE_Account_Number__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, UE_Claim_Charges__r__typeInfo)) {
      setUE_Claim_Charges__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, UE_Claim_Charges__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Unemployment_Claims__c ");
    ...
    sb.append(" Claim_Count__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Claim_Count__c)+"'\n");
    sb.append(" Claim_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Claim_Date__c)+"'\n");
    sb.append(" Claim_Notice_Received__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Claim_Notice_Received__c)+"'\n");
    sb.append(" Claim_State__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Claim_State__c)+"'\n");
    sb.append(" Claim_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Claim_Type__c)+"'\n");
    sb.append(" CombinedAttachments=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CombinedAttachments)+"'\n");
    sb.append(" Company__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Company__c)+"'\n");
    ...
    sb.append(" Most_Recent_Charge__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Most_Recent_Charge__c)+"'\n");
    sb.append(" Name=");
    ...
    sb.append(" UE_Account_Number__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(UE_Account_Number__c)+"'\n");
    sb.append(" UE_Claim_Charges__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(UE_Claim_Charges__r)+"'\n");

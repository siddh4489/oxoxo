 ...
 */
public class Unverified_Time__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Unverified_Time__c() {
  }
  ...
  /**
   * element  : Assigned_To__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Assigned_To__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Assigned_To__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Assigned_To__c__is_set = false;

  private java.lang.String Assigned_To__c;

  public java.lang.String getAssigned_To__c() {
    return Assigned_To__c;
  }

  

  public void setAssigned_To__c(java.lang.String Assigned_To__c) {
    this.Assigned_To__c = Assigned_To__c;
    Assigned_To__c__is_set = true;
  }
  
  /**
   * element  : Assigned_To__r of type {urn:sobject.enterprise.soap.sforce.com}User
   * java type: com.sforce.soap.enterprise.sobject.User
   */
  private static final com.sforce.ws.bind.TypeInfo Assigned_To__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Assigned_To__r","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

  private boolean Assigned_To__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.User Assigned_To__r;

  public com.sforce.soap.enterprise.sobject.User getAssigned_To__r() {
    return Assigned_To__r;
  }

  

  public void setAssigned_To__r(com.sforce.soap.enterprise.sobject.User Assigned_To__r) {
    this.Assigned_To__r = Assigned_To__r;
    Assigned_To__r__is_set = true;
  }
  ...
  /**
   * element  : Client_Formula__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Client_Formula__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Client_Formula__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Client_Formula__c__is_set = false;

  private java.lang.String Client_Formula__c;

  public java.lang.String getClient_Formula__c() {
    return Client_Formula__c;
  }

  

  public void setClient_Formula__c(java.lang.String Client_Formula__c) {
    this.Client_Formula__c = Client_Formula__c;
    Client_Formula__c__is_set = true;
  }
  ...
  /**
   * element  : Forfeit_Notes__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Forfeit_Notes__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Forfeit_Notes__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Forfeit_Notes__c__is_set = false;

  private java.lang.String Forfeit_Notes__c;

  public java.lang.String getForfeit_Notes__c() {
    return Forfeit_Notes__c;
  }

  

  public void setForfeit_Notes__c(java.lang.String Forfeit_Notes__c) {
    this.Forfeit_Notes__c = Forfeit_Notes__c;
    Forfeit_Notes__c__is_set = true;
  }
  ...
  /**
   * element  : Hours__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Hours__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Hours__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Hours__c__is_set = false;
  ...
  /**
   * element  : Manual_Invoice_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Manual_Invoice_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Manual_Invoice_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Manual_Invoice_Date__c__is_set = false;

  private java.util.Calendar Manual_Invoice_Date__c;

  public java.util.Calendar getManual_Invoice_Date__c() {
    return Manual_Invoice_Date__c;
  }

  

  public void setManual_Invoice_Date__c(java.util.Calendar Manual_Invoice_Date__c) {
    this.Manual_Invoice_Date__c = Manual_Invoice_Date__c;
    Manual_Invoice_Date__c__is_set = true;
  }
  ...
  /**
   * element  : Number_of_Notes_and_Attachments__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Number_of_Notes_and_Attachments__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Number_of_Notes_and_Attachments__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Number_of_Notes_and_Attachments__c__is_set = false;

  private java.lang.Double Number_of_Notes_and_Attachments__c;

  public java.lang.Double getNumber_of_Notes_and_Attachments__c() {
    return Number_of_Notes_and_Attachments__c;
  }

  

  public void setNumber_of_Notes_and_Attachments__c(java.lang.Double Number_of_Notes_and_Attachments__c) {
    this.Number_of_Notes_and_Attachments__c = Number_of_Notes_and_Attachments__c;
    Number_of_Notes_and_Attachments__c__is_set = true;
  }
  ...
  /**
   * element  : Reason_for_hold__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Reason_for_hold__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Reason_for_hold__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Reason_for_hold__c__is_set = false;

  private java.lang.String Reason_for_hold__c;

  public java.lang.String getReason_for_hold__c() {
    return Reason_for_hold__c;
  }

  

  public void setReason_for_hold__c(java.lang.String Reason_for_hold__c) {
    this.Reason_for_hold__c = Reason_for_hold__c;
    Reason_for_hold__c__is_set = true;
  }
  ...
  /**
   * element  : Recruiter_Email_Address__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Recruiter_Email_Address__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Recruiter_Email_Address__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Recruiter_Email_Address__c__is_set = false;

  private java.lang.String Recruiter_Email_Address__c;

  public java.lang.String getRecruiter_Email_Address__c() {
    return Recruiter_Email_Address__c;
  }

  

  public void setRecruiter_Email_Address__c(java.lang.String Recruiter_Email_Address__c) {
    this.Recruiter_Email_Address__c = Recruiter_Email_Address__c;
    Recruiter_Email_Address__c__is_set = true;
  }
  ...
  /**
   * element  : Recruiter_on_Assignment__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Recruiter_on_Assignment__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Recruiter_on_Assignment__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Recruiter_on_Assignment__c__is_set = false;

  private java.lang.String Recruiter_on_Assignment__c;

  public java.lang.String getRecruiter_on_Assignment__c() {
    return Recruiter_on_Assignment__c;
  }

  

  public void setRecruiter_on_Assignment__c(java.lang.String Recruiter_on_Assignment__c) {
    this.Recruiter_on_Assignment__c = Recruiter_on_Assignment__c;
    Recruiter_on_Assignment__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Unverified_Time__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Assigned_To__c__typeInfo, Assigned_To__c, Assigned_To__c__is_set);
    __typeMapper.writeObject(__out, Assigned_To__r__typeInfo, Assigned_To__r, Assigned_To__r__is_set);
    ...
    __typeMapper.writeString(__out, Client_Formula__c__typeInfo, Client_Formula__c, Client_Formula__c__is_set);
    ...
    __typeMapper.writeString(__out, Forfeit_Notes__c__typeInfo, Forfeit_Notes__c, Forfeit_Notes__c__is_set);
    ...
    __typeMapper.writeObject(__out, Hours__c__typeInfo, Hours__c, Hours__c__is_set);
    ...
    __typeMapper.writeObject(__out, Manual_Invoice_Date__c__typeInfo, Manual_Invoice_Date__c, Manual_Invoice_Date__c__is_set);
    ...
    __typeMapper.writeObject(__out, Number_of_Notes_and_Attachments__c__typeInfo, Number_of_Notes_and_Attachments__c, Number_of_Notes_and_Attachments__c__is_set);
    ...
    __typeMapper.writeString(__out, Reason_for_hold__c__typeInfo, Reason_for_hold__c, Reason_for_hold__c__is_set);
    __typeMapper.writeObject(__out, RecordAssociatedGroups__typeInfo, RecordAssociatedGroups, RecordAssociatedGroups__is_set);
    __typeMapper.writeString(__out, Recruiter_Email_Address__c__typeInfo, Recruiter_Email_Address__c, Recruiter_Email_Address__c__is_set);
    __typeMapper.writeString(__out, Recruiter_Email__c__typeInfo, Recruiter_Email__c, Recruiter_Email__c__is_set);
    __typeMapper.writeString(__out, Recruiter_on_Assignment__c__typeInfo, Recruiter_on_Assignment__c, Recruiter_on_Assignment__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Assigned_To__c__typeInfo)) {
      setAssigned_To__c((java.lang.String)__typeMapper.readString(__in, Assigned_To__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Assigned_To__r__typeInfo)) {
      setAssigned_To__r((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, Assigned_To__r__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Client_Formula__c__typeInfo)) {
      setClient_Formula__c((java.lang.String)__typeMapper.readString(__in, Client_Formula__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Forfeit_Notes__c__typeInfo)) {
      setForfeit_Notes__c((java.lang.String)__typeMapper.readString(__in, Forfeit_Notes__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Hours__c__typeInfo)) {
      setHours__c((java.lang.Double)__typeMapper.readObject(__in, Hours__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Manual_Invoice_Date__c__typeInfo)) {
      setManual_Invoice_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Manual_Invoice_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Number_of_Notes_and_Attachments__c__typeInfo)) {
      setNumber_of_Notes_and_Attachments__c((java.lang.Double)__typeMapper.readObject(__in, Number_of_Notes_and_Attachments__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Reason_for_hold__c__typeInfo)) {
      setReason_for_hold__c((java.lang.String)__typeMapper.readString(__in, Reason_for_hold__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Recruiter_Email_Address__c__typeInfo)) {
      setRecruiter_Email_Address__c((java.lang.String)__typeMapper.readString(__in, Recruiter_Email_Address__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Recruiter_on_Assignment__c__typeInfo)) {
      setRecruiter_on_Assignment__c((java.lang.String)__typeMapper.readString(__in, Recruiter_on_Assignment__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Unverified_Time__c ");
    sb.append(super.toString());
    sb.append(" ActivityHistories=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ActivityHistories)+"'\n");
    sb.append(" Assigned_To__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Assigned_To__c)+"'\n");
    sb.append(" Assigned_To__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Assigned_To__r)+"'\n");
    ...
    sb.append(" Client_Formula__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Client_Formula__c)+"'\n");
    sb.append(" Client__c=");
    ...
    sb.append(" Forfeit_Notes__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Forfeit_Notes__c)+"'\n");
    ...
    sb.append(" Hours__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Hours__c)+"'\n");
    sb.append(" IsDeleted=");
    ...
    sb.append(" Manual_Invoice_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Manual_Invoice_Date__c)+"'\n");
    ...
    sb.append(" Number_of_Notes_and_Attachments__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Number_of_Notes_and_Attachments__c)+"'\n");
    ...
    sb.append(" Reason_for_hold__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Reason_for_hold__c)+"'\n");
    sb.append(" RecordAssociatedGroups=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(RecordAssociatedGroups)+"'\n");
    sb.append(" Recruiter_Email_Address__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Recruiter_Email_Address__c)+"'\n");
    sb.append(" Recruiter_Email__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Recruiter_Email__c)+"'\n");
    sb.append(" Recruiter_on_Assignment__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Recruiter_on_Assignment__c)+"'\n");
    sb.append(" Status__c=");

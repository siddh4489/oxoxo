 ...
 */
public class I__PenPal__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public I__PenPal__c() {
  ...
  /**
   * element  : i__LastMsgDigest__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__LastMsgDigest__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__LastMsgDigest__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean i__LastMsgDigest__c__is_set = false;

  private java.lang.String i__LastMsgDigest__c;

  public java.lang.String getI__LastMsgDigest__c() {
    return i__LastMsgDigest__c;
  }

  

  public void setI__LastMsgDigest__c(java.lang.String i__LastMsgDigest__c) {
    this.i__LastMsgDigest__c = i__LastMsgDigest__c;
    i__LastMsgDigest__c__is_set = true;
  }
  
  /**
   * element  : i__LastSent__c of type {http://www.w3.org/2001/XMLSchema}dateTime
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo i__LastSent__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__LastSent__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

  private boolean i__LastSent__c__is_set = false;

  private java.util.Calendar i__LastSent__c;

  public java.util.Calendar getI__LastSent__c() {
    return i__LastSent__c;
  }

  

  public void setI__LastSent__c(java.util.Calendar i__LastSent__c) {
    this.i__LastSent__c = i__LastSent__c;
    i__LastSent__c__is_set = true;
  }
  
  /**
   * element  : i__LatestMsgDigest__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__LatestMsgDigest__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__LatestMsgDigest__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean i__LatestMsgDigest__c__is_set = false;

  private java.lang.String i__LatestMsgDigest__c;

  public java.lang.String getI__LatestMsgDigest__c() {
    return i__LatestMsgDigest__c;
  }

  

  public void setI__LatestMsgDigest__c(java.lang.String i__LatestMsgDigest__c) {
    this.i__LatestMsgDigest__c = i__LatestMsgDigest__c;
    i__LatestMsgDigest__c__is_set = true;
  }
  
  /**
   * element  : i__RecipLinkCt__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo i__RecipLinkCt__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__RecipLinkCt__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean i__RecipLinkCt__c__is_set = false;

  private java.lang.Double i__RecipLinkCt__c;

  public java.lang.Double getI__RecipLinkCt__c() {
    return i__RecipLinkCt__c;
  }

  

  public void setI__RecipLinkCt__c(java.lang.Double i__RecipLinkCt__c) {
    this.i__RecipLinkCt__c = i__RecipLinkCt__c;
    i__RecipLinkCt__c__is_set = true;
  }
  
  /**
   * element  : i__Recip__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__Recip__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Recip__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean i__Recip__c__is_set = false;

  private java.lang.String i__Recip__c;

  public java.lang.String getI__Recip__c() {
    return i__Recip__c;
  }

  

  public void setI__Recip__c(java.lang.String i__Recip__c) {
    this.i__Recip__c = i__Recip__c;
    i__Recip__c__is_set = true;
  }
  
  /**
   * element  : i__Recip__r of type {urn:sobject.enterprise.soap.sforce.com}i__EmailAddr__c
   * java type: com.sforce.soap.enterprise.sobject.I__EmailAddr__c
   */
  private static final com.sforce.ws.bind.TypeInfo i__Recip__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Recip__r","urn:sobject.enterprise.soap.sforce.com","i__EmailAddr__c",0,1,true);

  private boolean i__Recip__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.I__EmailAddr__c i__Recip__r;

  public com.sforce.soap.enterprise.sobject.I__EmailAddr__c getI__Recip__r() {
    return i__Recip__r;
  }

  

  public void setI__Recip__r(com.sforce.soap.enterprise.sobject.I__EmailAddr__c i__Recip__r) {
    this.i__Recip__r = i__Recip__r;
    i__Recip__r__is_set = true;
  }
  
  /**
   * element  : i__SenderLinkCt__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo i__SenderLinkCt__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__SenderLinkCt__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean i__SenderLinkCt__c__is_set = false;

  private java.lang.Double i__SenderLinkCt__c;

  public java.lang.Double getI__SenderLinkCt__c() {
    return i__SenderLinkCt__c;
  }

  

  public void setI__SenderLinkCt__c(java.lang.Double i__SenderLinkCt__c) {
    this.i__SenderLinkCt__c = i__SenderLinkCt__c;
    i__SenderLinkCt__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "i__PenPal__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, i__LastMsgDigest__c__typeInfo, i__LastMsgDigest__c, i__LastMsgDigest__c__is_set);
    __typeMapper.writeObject(__out, i__LastSent__c__typeInfo, i__LastSent__c, i__LastSent__c__is_set);
    __typeMapper.writeString(__out, i__LatestMsgDigest__c__typeInfo, i__LatestMsgDigest__c, i__LatestMsgDigest__c__is_set);
    __typeMapper.writeObject(__out, i__RecipLinkCt__c__typeInfo, i__RecipLinkCt__c, i__RecipLinkCt__c__is_set);
    __typeMapper.writeString(__out, i__Recip__c__typeInfo, i__Recip__c, i__Recip__c__is_set);
    __typeMapper.writeObject(__out, i__Recip__r__typeInfo, i__Recip__r, i__Recip__r__is_set);
    __typeMapper.writeObject(__out, i__SenderLinkCt__c__typeInfo, i__SenderLinkCt__c, i__SenderLinkCt__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__LastMsgDigest__c__typeInfo)) {
      setI__LastMsgDigest__c((java.lang.String)__typeMapper.readString(__in, i__LastMsgDigest__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__LastSent__c__typeInfo)) {
      setI__LastSent__c((java.util.Calendar)__typeMapper.readObject(__in, i__LastSent__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__LatestMsgDigest__c__typeInfo)) {
      setI__LatestMsgDigest__c((java.lang.String)__typeMapper.readString(__in, i__LatestMsgDigest__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__RecipLinkCt__c__typeInfo)) {
      setI__RecipLinkCt__c((java.lang.Double)__typeMapper.readObject(__in, i__RecipLinkCt__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Recip__c__typeInfo)) {
      setI__Recip__c((java.lang.String)__typeMapper.readString(__in, i__Recip__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Recip__r__typeInfo)) {
      setI__Recip__r((com.sforce.soap.enterprise.sobject.I__EmailAddr__c)__typeMapper.readObject(__in, i__Recip__r__typeInfo, com.sforce.soap.enterprise.sobject.I__EmailAddr__c.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__SenderLinkCt__c__typeInfo)) {
      setI__SenderLinkCt__c((java.lang.Double)__typeMapper.readObject(__in, i__SenderLinkCt__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" i__LastMsgDigest__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__LastMsgDigest__c)+"'\n");
    sb.append(" i__LastSent__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__LastSent__c)+"'\n");
    sb.append(" i__LatestMsgDigest__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__LatestMsgDigest__c)+"'\n");
    sb.append(" i__RecipLinkCt__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__RecipLinkCt__c)+"'\n");
    sb.append(" i__Recip__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Recip__c)+"'\n");
    sb.append(" i__Recip__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Recip__r)+"'\n");
    sb.append(" i__SenderLinkCt__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__SenderLinkCt__c)+"'\n");

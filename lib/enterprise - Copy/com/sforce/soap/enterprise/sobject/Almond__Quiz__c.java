 ...
 */
public class Almond__Quiz__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__Quiz__c() {
  }
  ...
  /**
   * element  : almond__Max_Attempts__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Max_Attempts__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Max_Attempts__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean almond__Max_Attempts__c__is_set = false;

  private java.lang.Double almond__Max_Attempts__c;

  public java.lang.Double getAlmond__Max_Attempts__c() {
    return almond__Max_Attempts__c;
  }

  

  public void setAlmond__Max_Attempts__c(java.lang.Double almond__Max_Attempts__c) {
    this.almond__Max_Attempts__c = almond__Max_Attempts__c;
    almond__Max_Attempts__c__is_set = true;
  }
  
  /**
   * element  : almond__Passing_Score__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Passing_Score__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Passing_Score__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean almond__Passing_Score__c__is_set = false;

  private java.lang.Double almond__Passing_Score__c;

  public java.lang.Double getAlmond__Passing_Score__c() {
    return almond__Passing_Score__c;
  }

  

  public void setAlmond__Passing_Score__c(java.lang.Double almond__Passing_Score__c) {
    this.almond__Passing_Score__c = almond__Passing_Score__c;
    almond__Passing_Score__c__is_set = true;
  }
  
  /**
   * element  : almond__Question_Lines__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Question_Lines__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Question_Lines__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean almond__Question_Lines__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult almond__Question_Lines__r;

  public com.sforce.soap.enterprise.QueryResult getAlmond__Question_Lines__r() {
    return almond__Question_Lines__r;
  }

  

  public void setAlmond__Question_Lines__r(com.sforce.soap.enterprise.QueryResult almond__Question_Lines__r) {
    this.almond__Question_Lines__r = almond__Question_Lines__r;
    almond__Question_Lines__r__is_set = true;
  }
  
  /**
   * element  : almond__Total_Questions__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Total_Questions__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Total_Questions__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean almond__Total_Questions__c__is_set = false;

  private java.lang.Double almond__Total_Questions__c;

  public java.lang.Double getAlmond__Total_Questions__c() {
    return almond__Total_Questions__c;
  }

  

  public void setAlmond__Total_Questions__c(java.lang.Double almond__Total_Questions__c) {
    this.almond__Total_Questions__c = almond__Total_Questions__c;
    almond__Total_Questions__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__Quiz__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, almond__Max_Attempts__c__typeInfo, almond__Max_Attempts__c, almond__Max_Attempts__c__is_set);
    __typeMapper.writeObject(__out, almond__Passing_Score__c__typeInfo, almond__Passing_Score__c, almond__Passing_Score__c__is_set);
    __typeMapper.writeObject(__out, almond__Question_Lines__r__typeInfo, almond__Question_Lines__r, almond__Question_Lines__r__is_set);
    __typeMapper.writeObject(__out, almond__Total_Questions__c__typeInfo, almond__Total_Questions__c, almond__Total_Questions__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Max_Attempts__c__typeInfo)) {
      setAlmond__Max_Attempts__c((java.lang.Double)__typeMapper.readObject(__in, almond__Max_Attempts__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Passing_Score__c__typeInfo)) {
      setAlmond__Passing_Score__c((java.lang.Double)__typeMapper.readObject(__in, almond__Passing_Score__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Question_Lines__r__typeInfo)) {
      setAlmond__Question_Lines__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, almond__Question_Lines__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Total_Questions__c__typeInfo)) {
      setAlmond__Total_Questions__c((java.lang.Double)__typeMapper.readObject(__in, almond__Total_Questions__c__typeInfo, java.lang.Double.class));
    }
  }
  ...
  public String toString() {
    ...
    sb.append(" almond__Max_Attempts__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Max_Attempts__c)+"'\n");
    sb.append(" almond__Passing_Score__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Passing_Score__c)+"'\n");
    sb.append(" almond__Question_Lines__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Question_Lines__r)+"'\n");
    sb.append(" almond__Total_Questions__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Total_Questions__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
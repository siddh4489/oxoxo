 ...
 */
public class Admin_EE_Deductions__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Admin_EE_Deductions__c() {
  }
  ...
  /**
   * element  : Effective_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Effective_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Effective_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Effective_Date__c__is_set = false;

  private java.util.Calendar Effective_Date__c;

  public java.util.Calendar getEffective_Date__c() {
    return Effective_Date__c;
  }

  

  public void setEffective_Date__c(java.util.Calendar Effective_Date__c) {
    this.Effective_Date__c = Effective_Date__c;
    Effective_Date__c__is_set = true;
  }
  ...
  /**
   * element  : Received__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Received__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Received__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Received__c__is_set = false;

  private java.util.Calendar Received__c;

  public java.util.Calendar getReceived__c() {
    return Received__c;
  }

  

  public void setReceived__c(java.util.Calendar Received__c) {
    this.Received__c = Received__c;
    Received__c__is_set = true;
  }
  ...
  /**
   * element  : Weekly_Amount__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Weekly_Amount__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Weekly_Amount__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Weekly_Amount__c__is_set = false;

  private java.lang.Double Weekly_Amount__c;

  public java.lang.Double getWeekly_Amount__c() {
    return Weekly_Amount__c;
  }

  

  public void setWeekly_Amount__c(java.lang.Double Weekly_Amount__c) {
    this.Weekly_Amount__c = Weekly_Amount__c;
    Weekly_Amount__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Admin_EE_Deductions__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Effective_Date__c__typeInfo, Effective_Date__c, Effective_Date__c__is_set);
    ...
    __typeMapper.writeObject(__out, Received__c__typeInfo, Received__c, Received__c__is_set);
    ...
    __typeMapper.writeObject(__out, Weekly_Amount__c__typeInfo, Weekly_Amount__c, Weekly_Amount__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Effective_Date__c__typeInfo)) {
      setEffective_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Effective_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Received__c__typeInfo)) {
      setReceived__c((java.util.Calendar)__typeMapper.readObject(__in, Received__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Weekly_Amount__c__typeInfo)) {
      setWeekly_Amount__c((java.lang.Double)__typeMapper.readObject(__in, Weekly_Amount__c__typeInfo, java.lang.Double.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Admin_EE_Deductions__c ");
    ...
    sb.append(" Effective_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Effective_Date__c)+"'\n");
    sb.append(" Emails=");
    ...
    sb.append(" Received__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Received__c)+"'\n");
    ...
    sb.append(" Weekly_Amount__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Weekly_Amount__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
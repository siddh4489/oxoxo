 ...
 */
public class Payroll_Detail__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Payroll_Detail__c() {
  }
  ...
  /**
   * element  : GP_Record_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo GP_Record_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","GP_Record_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean GP_Record_Type__c__is_set = false;

  private java.lang.String GP_Record_Type__c;

  public java.lang.String getGP_Record_Type__c() {
    return GP_Record_Type__c;
  }

  

  public void setGP_Record_Type__c(java.lang.String GP_Record_Type__c) {
    this.GP_Record_Type__c = GP_Record_Type__c;
    GP_Record_Type__c__is_set = true;
  }
  ...
  /**
   * element  : PayTypeDesc__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo PayTypeDesc__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","PayTypeDesc__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean PayTypeDesc__c__is_set = false;

  private java.lang.String PayTypeDesc__c;

  public java.lang.String getPayTypeDesc__c() {
    return PayTypeDesc__c;
  }

  

  public void setPayTypeDesc__c(java.lang.String PayTypeDesc__c) {
    this.PayTypeDesc__c = PayTypeDesc__c;
    PayTypeDesc__c__is_set = true;
  }
  
  /**
   * element  : PayTypeID__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo PayTypeID__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","PayTypeID__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean PayTypeID__c__is_set = false;

  private java.lang.String PayTypeID__c;

  public java.lang.String getPayTypeID__c() {
    return PayTypeID__c;
  }

  

  public void setPayTypeID__c(java.lang.String PayTypeID__c) {
    this.PayTypeID__c = PayTypeID__c;
    PayTypeID__c__is_set = true;
  }
  
  /**
   * element  : Pay_Rate__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Pay_Rate__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Pay_Rate__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Pay_Rate__c__is_set = false;

  private java.lang.Double Pay_Rate__c;

  public java.lang.Double getPay_Rate__c() {
    return Pay_Rate__c;
  }

  

  public void setPay_Rate__c(java.lang.Double Pay_Rate__c) {
    this.Pay_Rate__c = Pay_Rate__c;
    Pay_Rate__c__is_set = true;
  }
  
  /**
   * element  : Payroll_History__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Payroll_History__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Payroll_History__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Payroll_History__c__is_set = false;

  private java.lang.String Payroll_History__c;

  public java.lang.String getPayroll_History__c() {
    return Payroll_History__c;
  }

  

  public void setPayroll_History__c(java.lang.String Payroll_History__c) {
    this.Payroll_History__c = Payroll_History__c;
    Payroll_History__c__is_set = true;
  }
  
  /**
   * element  : Payroll_History__r of type {urn:sobject.enterprise.soap.sforce.com}Payroll_History__c
   * java type: com.sforce.soap.enterprise.sobject.Payroll_History__c
   */
  private static final com.sforce.ws.bind.TypeInfo Payroll_History__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Payroll_History__r","urn:sobject.enterprise.soap.sforce.com","Payroll_History__c",0,1,true);

  private boolean Payroll_History__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Payroll_History__c Payroll_History__r;

  public com.sforce.soap.enterprise.sobject.Payroll_History__c getPayroll_History__r() {
    return Payroll_History__r;
  }

  

  public void setPayroll_History__r(com.sforce.soap.enterprise.sobject.Payroll_History__c Payroll_History__r) {
  ...
  /**
   * element  : WC_Class__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo WC_Class__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WC_Class__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean WC_Class__c__is_set = false;

  private java.lang.String WC_Class__c;

  public java.lang.String getWC_Class__c() {
    return WC_Class__c;
  }

  

  public void setWC_Class__c(java.lang.String WC_Class__c) {
    this.WC_Class__c = WC_Class__c;
    WC_Class__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Payroll_Detail__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, GP_Record_Type__c__typeInfo, GP_Record_Type__c, GP_Record_Type__c__is_set);
    ...
    __typeMapper.writeString(__out, PayTypeDesc__c__typeInfo, PayTypeDesc__c, PayTypeDesc__c__is_set);
    __typeMapper.writeString(__out, PayTypeID__c__typeInfo, PayTypeID__c, PayTypeID__c__is_set);
    __typeMapper.writeObject(__out, Pay_Rate__c__typeInfo, Pay_Rate__c, Pay_Rate__c__is_set);
    __typeMapper.writeString(__out, Payroll_History__c__typeInfo, Payroll_History__c, Payroll_History__c__is_set);
    ...
    __typeMapper.writeString(__out, WC_Class__c__typeInfo, WC_Class__c, WC_Class__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, GP_Record_Type__c__typeInfo)) {
      setGP_Record_Type__c((java.lang.String)__typeMapper.readString(__in, GP_Record_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, PayTypeDesc__c__typeInfo)) {
      setPayTypeDesc__c((java.lang.String)__typeMapper.readString(__in, PayTypeDesc__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, PayTypeID__c__typeInfo)) {
      setPayTypeID__c((java.lang.String)__typeMapper.readString(__in, PayTypeID__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Pay_Rate__c__typeInfo)) {
      setPay_Rate__c((java.lang.Double)__typeMapper.readObject(__in, Pay_Rate__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Payroll_History__c__typeInfo)) {
      setPayroll_History__c((java.lang.String)__typeMapper.readString(__in, Payroll_History__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Payroll_History__r__typeInfo)) {
      setPayroll_History__r((com.sforce.soap.enterprise.sobject.Payroll_History__c)__typeMapper.readObject(__in, Payroll_History__r__typeInfo, com.sforce.soap.enterprise.sobject.Payroll_History__c.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, WC_Class__c__typeInfo)) {
      setWC_Class__c((java.lang.String)__typeMapper.readString(__in, WC_Class__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" GP_Record_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(GP_Record_Type__c)+"'\n");
    sb.append(" Histories=");
    ...
    sb.append(" PayTypeDesc__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(PayTypeDesc__c)+"'\n");
    sb.append(" PayTypeID__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(PayTypeID__c)+"'\n");
    sb.append(" Pay_Rate__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Pay_Rate__c)+"'\n");
    sb.append(" Payroll_History__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Payroll_History__c)+"'\n");
    ...
    sb.append(" WC_Class__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(WC_Class__c)+"'\n");

 ...
 */
public class Safety_Action__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Safety_Action__c() {
  }
  ...
  /**
   * element  : Administered_By__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Administered_By__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Administered_By__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Administered_By__c__is_set = false;

  private java.lang.String Administered_By__c;

  public java.lang.String getAdministered_By__c() {
    return Administered_By__c;
  }

  

  public void setAdministered_By__c(java.lang.String Administered_By__c) {
    this.Administered_By__c = Administered_By__c;
    Administered_By__c__is_set = true;
  }
  
  /**
   * element  : Administered_By__r of type {urn:sobject.enterprise.soap.sforce.com}User
   * java type: com.sforce.soap.enterprise.sobject.User
   */
  private static final com.sforce.ws.bind.TypeInfo Administered_By__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Administered_By__r","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

  private boolean Administered_By__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.User Administered_By__r;

  public com.sforce.soap.enterprise.sobject.User getAdministered_By__r() {
    return Administered_By__r;
  }

  

  public void setAdministered_By__r(com.sforce.soap.enterprise.sobject.User Administered_By__r) {
    this.Administered_By__r = Administered_By__r;
    Administered_By__r__is_set = true;
  }
  ...
  /**
   * element  : Content__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Content__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Content__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Content__c__is_set = false;

  private java.lang.String Content__c;

  public java.lang.String getContent__c() {
    return Content__c;
  }

  

  public void setContent__c(java.lang.String Content__c) {
    this.Content__c = Content__c;
    Content__c__is_set = true;
  }
  ...
  /**
   * element  : Date_of_Action__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_of_Action__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_of_Action__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Date_of_Action__c__is_set = false;

  private java.util.Calendar Date_of_Action__c;

  public java.util.Calendar getDate_of_Action__c() {
    return Date_of_Action__c;
  }

  

  public void setDate_of_Action__c(java.util.Calendar Date_of_Action__c) {
    this.Date_of_Action__c = Date_of_Action__c;
    Date_of_Action__c__is_set = true;
  }
  ...
  /**
   * element  : Number_of_Participants__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Number_of_Participants__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Number_of_Participants__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Number_of_Participants__c__is_set = false;

  private java.lang.Double Number_of_Participants__c;

  public java.lang.Double getNumber_of_Participants__c() {
    return Number_of_Participants__c;
  }

  

  public void setNumber_of_Participants__c(java.lang.Double Number_of_Participants__c) {
    this.Number_of_Participants__c = Number_of_Participants__c;
    Number_of_Participants__c__is_set = true;
  }
  ...
  /**
   * element  : Participant_Notes__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Participant_Notes__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Participant_Notes__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Participant_Notes__c__is_set = false;

  private java.lang.String Participant_Notes__c;

  public java.lang.String getParticipant_Notes__c() {
    return Participant_Notes__c;
  }

  

  public void setParticipant_Notes__c(java.lang.String Participant_Notes__c) {
    this.Participant_Notes__c = Participant_Notes__c;
    Participant_Notes__c__is_set = true;
  }
  
  /**
   * element  : Participants__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Participants__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Participants__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Participants__c__is_set = false;

  private java.lang.String Participants__c;

  public java.lang.String getParticipants__c() {
    return Participants__c;
  }

  

  public void setParticipants__c(java.lang.String Participants__c) {
    this.Participants__c = Participants__c;
    Participants__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Safety_Action__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Administered_By__c__typeInfo, Administered_By__c, Administered_By__c__is_set);
    __typeMapper.writeObject(__out, Administered_By__r__typeInfo, Administered_By__r, Administered_By__r__is_set);
    ...
    __typeMapper.writeString(__out, Content__c__typeInfo, Content__c, Content__c__is_set);
    __typeMapper.writeObject(__out, CreatedBy__typeInfo, CreatedBy, CreatedBy__is_set);
    __typeMapper.writeString(__out, CreatedById__typeInfo, CreatedById, CreatedById__is_set);
    __typeMapper.writeObject(__out, CreatedDate__typeInfo, CreatedDate, CreatedDate__is_set);
    __typeMapper.writeObject(__out, Date_of_Action__c__typeInfo, Date_of_Action__c, Date_of_Action__c__is_set);
    ...
    __typeMapper.writeObject(__out, Number_of_Participants__c__typeInfo, Number_of_Participants__c, Number_of_Participants__c__is_set);
    ...
    __typeMapper.writeString(__out, Participant_Notes__c__typeInfo, Participant_Notes__c, Participant_Notes__c__is_set);
    __typeMapper.writeString(__out, Participants__c__typeInfo, Participants__c, Participants__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Administered_By__c__typeInfo)) {
      setAdministered_By__c((java.lang.String)__typeMapper.readString(__in, Administered_By__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Administered_By__r__typeInfo)) {
      setAdministered_By__r((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, Administered_By__r__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Content__c__typeInfo)) {
      setContent__c((java.lang.String)__typeMapper.readString(__in, Content__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_of_Action__c__typeInfo)) {
      setDate_of_Action__c((java.util.Calendar)__typeMapper.readObject(__in, Date_of_Action__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Number_of_Participants__c__typeInfo)) {
      setNumber_of_Participants__c((java.lang.Double)__typeMapper.readObject(__in, Number_of_Participants__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Participant_Notes__c__typeInfo)) {
      setParticipant_Notes__c((java.lang.String)__typeMapper.readString(__in, Participant_Notes__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Participants__c__typeInfo)) {
      setParticipants__c((java.lang.String)__typeMapper.readString(__in, Participants__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Administered_By__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Administered_By__c)+"'\n");
    sb.append(" Administered_By__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Administered_By__r)+"'\n");
    ...
    sb.append(" Content__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Content__c)+"'\n");
    sb.append(" CreatedBy=");
    ...
    sb.append(" Date_of_Action__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_of_Action__c)+"'\n");
    ...
    sb.append(" Number_of_Participants__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Number_of_Participants__c)+"'\n");
    ...
    sb.append(" Participant_Notes__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Participant_Notes__c)+"'\n");
    sb.append(" Participants__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Participants__c)+"'\n");

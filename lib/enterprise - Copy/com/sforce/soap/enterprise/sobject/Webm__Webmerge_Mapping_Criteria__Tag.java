 ...
 */
public class Webm__Webmerge_Mapping_Criteria__Tag extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Webm__Webmerge_Mapping_Criteria__Tag() {
  }
  ...
  /**
   * element  : Item of type {urn:sobject.enterprise.soap.sforce.com}webm__Webmerge_Mapping_Criteria__c
   * java type: com.sforce.soap.enterprise.sobject.Webm__Webmerge_Mapping_Criteria__c
   */
  private static final com.sforce.ws.bind.TypeInfo Item__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Item","urn:sobject.enterprise.soap.sforce.com","webm__Webmerge_Mapping_Criteria__c",0,1,true);

  private boolean Item__is_set = false;

  private com.sforce.soap.enterprise.sobject.Webm__Webmerge_Mapping_Criteria__c Item;

  public com.sforce.soap.enterprise.sobject.Webm__Webmerge_Mapping_Criteria__c getItem() {
    return Item;
  }

  

  public void setItem(com.sforce.soap.enterprise.sobject.Webm__Webmerge_Mapping_Criteria__c Item) {
    this.Item = Item;
    Item__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "webm__Webmerge_Mapping_Criteria__Tag");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Item__typeInfo)) {
      setItem((com.sforce.soap.enterprise.sobject.Webm__Webmerge_Mapping_Criteria__c)__typeMapper.readObject(__in, Item__typeInfo, com.sforce.soap.enterprise.sobject.Webm__Webmerge_Mapping_Criteria__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Webm__Webmerge_Mapping_Criteria__Tag ");

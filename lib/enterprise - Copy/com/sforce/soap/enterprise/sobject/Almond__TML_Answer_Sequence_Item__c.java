 ...
 */
public class Almond__TML_Answer_Sequence_Item__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__TML_Answer_Sequence_Item__c() {
  }
  ...
  /**
   * element  : almond__Answer_Text__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Answer_Text__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Answer_Text__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean almond__Answer_Text__c__is_set = false;

  private java.lang.String almond__Answer_Text__c;

  public java.lang.String getAlmond__Answer_Text__c() {
    return almond__Answer_Text__c;
  }

  

  public void setAlmond__Answer_Text__c(java.lang.String almond__Answer_Text__c) {
    this.almond__Answer_Text__c = almond__Answer_Text__c;
    almond__Answer_Text__c__is_set = true;
  }
  
  /**
   * element  : almond__Is_Correct_Answer__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Is_Correct_Answer__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Is_Correct_Answer__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean almond__Is_Correct_Answer__c__is_set = false;

  private java.lang.Boolean almond__Is_Correct_Answer__c;

  public java.lang.Boolean getAlmond__Is_Correct_Answer__c() {
    return almond__Is_Correct_Answer__c;
  }

  

  public void setAlmond__Is_Correct_Answer__c(java.lang.Boolean almond__Is_Correct_Answer__c) {
    this.almond__Is_Correct_Answer__c = almond__Is_Correct_Answer__c;
    almond__Is_Correct_Answer__c__is_set = true;
  }
  
  /**
   * element  : almond__Item_Id__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Item_Id__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Item_Id__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean almond__Item_Id__c__is_set = false;

  private java.lang.String almond__Item_Id__c;

  public java.lang.String getAlmond__Item_Id__c() {
    return almond__Item_Id__c;
  }

  

  public void setAlmond__Item_Id__c(java.lang.String almond__Item_Id__c) {
    this.almond__Item_Id__c = almond__Item_Id__c;
    almond__Item_Id__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__TML_Answer_Sequence_Item__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, almond__Answer_Text__c__typeInfo, almond__Answer_Text__c, almond__Answer_Text__c__is_set);
    __typeMapper.writeObject(__out, almond__Is_Correct_Answer__c__typeInfo, almond__Is_Correct_Answer__c, almond__Is_Correct_Answer__c__is_set);
    __typeMapper.writeString(__out, almond__Item_Id__c__typeInfo, almond__Item_Id__c, almond__Item_Id__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Answer_Text__c__typeInfo)) {
      setAlmond__Answer_Text__c((java.lang.String)__typeMapper.readString(__in, almond__Answer_Text__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Is_Correct_Answer__c__typeInfo)) {
      setAlmond__Is_Correct_Answer__c((java.lang.Boolean)__typeMapper.readObject(__in, almond__Is_Correct_Answer__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Item_Id__c__typeInfo)) {
      setAlmond__Item_Id__c((java.lang.String)__typeMapper.readString(__in, almond__Item_Id__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Almond__TML_Answer_Sequence_Item__c ");
    ...
    sb.append(" almond__Answer_Text__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Answer_Text__c)+"'\n");
    sb.append(" almond__Is_Correct_Answer__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Is_Correct_Answer__c)+"'\n");
    sb.append(" almond__Item_Id__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Item_Id__c)+"'\n");

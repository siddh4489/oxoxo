...
public class DataCategory implements com.sforce.ws.bind.XMLizable {
  ...
  /**
   * element  : childCategories of type {urn:enterprise.soap.sforce.com}DataCategory
   * java type: com.sforce.soap.enterprise.DataCategory[]
   */
  private static final com.sforce.ws.bind.TypeInfo childCategories__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","childCategories","urn:enterprise.soap.sforce.com","DataCategory",0,-1,true);

  private boolean childCategories__is_set = false;

  private com.sforce.soap.enterprise.DataCategory[] childCategories = new com.sforce.soap.enterprise.DataCategory[0];
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, childCategories__typeInfo)) {
      setChildCategories((com.sforce.soap.enterprise.DataCategory[])__typeMapper.readObject(__in, childCategories__typeInfo, com.sforce.soap.enterprise.DataCategory[].class));
    }
    __in.peekTag();

 ...
 */
public class FlexipageContext implements com.sforce.ws.bind.XMLizable {
  /**
   * Constructor
   */
  ...
  /**
   * element  : type of type {urn:enterprise.soap.sforce.com}FlexipageContextTypeEnum
   * java type: com.sforce.soap.enterprise.FlexipageContextTypeEnum
   */
  private static final com.sforce.ws.bind.TypeInfo type__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","type","urn:enterprise.soap.sforce.com","FlexipageContextTypeEnum",1,1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, type__typeInfo)) {
      setType((com.sforce.soap.enterprise.FlexipageContextTypeEnum)__typeMapper.readObject(__in, type__typeInfo, com.sforce.soap.enterprise.FlexipageContextTypeEnum.class));
    }
    __in.peekTag();

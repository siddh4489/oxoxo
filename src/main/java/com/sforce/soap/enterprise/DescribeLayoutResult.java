...
public class DescribeLayoutResult implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo layouts__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","layouts","urn:enterprise.soap.sforce.com","DescribeLayout",1,-1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo recordTypeMappings__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","recordTypeMappings","urn:enterprise.soap.sforce.com","RecordTypeMapping",0,-1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo recordTypeSelectorRequired__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","recordTypeSelectorRequired","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, layouts__typeInfo)) {
      setLayouts((com.sforce.soap.enterprise.DescribeLayout[])__typeMapper.readObject(__in, layouts__typeInfo, com.sforce.soap.enterprise.DescribeLayout[].class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, recordTypeMappings__typeInfo)) {
      setRecordTypeMappings((com.sforce.soap.enterprise.RecordTypeMapping[])__typeMapper.readObject(__in, recordTypeMappings__typeInfo, com.sforce.soap.enterprise.RecordTypeMapping[].class));
    }
    __in.peekTag();

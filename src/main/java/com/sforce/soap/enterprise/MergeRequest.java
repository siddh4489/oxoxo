...
public class MergeRequest implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo masterRecord__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","masterRecord","urn:sobject.enterprise.soap.sforce.com","sObject",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo recordToMergeIds__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","recordToMergeIds","urn:enterprise.soap.sforce.com","ID",1,-1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, masterRecord__typeInfo)) {
      setMasterRecord((com.sforce.soap.enterprise.sobject.SObject)__typeMapper.readObject(__in, masterRecord__typeInfo, com.sforce.soap.enterprise.sobject.SObject.class));
    }
    __in.peekTag();

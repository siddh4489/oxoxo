...
public class DescribeGlobalResult implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo encoding__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","encoding","http://www.w3.org/2001/XMLSchema","string",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo maxBatchSize__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","maxBatchSize","http://www.w3.org/2001/XMLSchema","int",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo sobjects__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","sobjects","urn:enterprise.soap.sforce.com","DescribeGlobalSObjectResult",0,-1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, sobjects__typeInfo)) {
      setSobjects((com.sforce.soap.enterprise.DescribeGlobalSObjectResult[])__typeMapper.readObject(__in, sobjects__typeInfo, com.sforce.soap.enterprise.DescribeGlobalSObjectResult[].class));
    }
  }

...
public class SendEmailResult implements com.sforce.ws.bind.XMLizable {
  ...
  /**
   * element  : errors of type {urn:enterprise.soap.sforce.com}SendEmailError
   * java type: com.sforce.soap.enterprise.SendEmailError[]
   */
  private static final com.sforce.ws.bind.TypeInfo errors__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","errors","urn:enterprise.soap.sforce.com","SendEmailError",0,-1,true);

  private boolean errors__is_set = false;

  private com.sforce.soap.enterprise.SendEmailError[] errors = new com.sforce.soap.enterprise.SendEmailError[0];
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, errors__typeInfo)) {
      setErrors((com.sforce.soap.enterprise.SendEmailError[])__typeMapper.readObject(__in, errors__typeInfo, com.sforce.soap.enterprise.SendEmailError[].class));
    }
    __in.peekTag();

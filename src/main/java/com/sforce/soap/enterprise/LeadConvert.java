...
public class LeadConvert implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo accountId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","accountId","urn:enterprise.soap.sforce.com","ID",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo contactId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","contactId","urn:enterprise.soap.sforce.com","ID",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo convertedStatus__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","convertedStatus","http://www.w3.org/2001/XMLSchema","string",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo doNotCreateOpportunity__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","doNotCreateOpportunity","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo leadId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","leadId","urn:enterprise.soap.sforce.com","ID",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo opportunityName__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","opportunityName","http://www.w3.org/2001/XMLSchema","string",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo overwriteLeadSource__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","overwriteLeadSource","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo ownerId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","ownerId","urn:enterprise.soap.sforce.com","ID",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo sendNotificationEmail__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","sendNotificationEmail","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);

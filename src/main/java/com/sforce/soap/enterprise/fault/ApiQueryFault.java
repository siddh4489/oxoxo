 ...
 */
public class ApiQueryFault extends com.sforce.soap.enterprise.fault.ApiFault {  private static final long serialVersionUID = 1L;
  /**
   * Constructor
   */
  ...
  private static final com.sforce.ws.bind.TypeInfo row__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:fault.enterprise.soap.sforce.com","row","http://www.w3.org/2001/XMLSchema","int",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo column__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:fault.enterprise.soap.sforce.com","column","http://www.w3.org/2001/XMLSchema","int",1,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:fault.enterprise.soap.sforce.com", "ApiQueryFault");

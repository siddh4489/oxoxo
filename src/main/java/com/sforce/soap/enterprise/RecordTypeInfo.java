...
public class RecordTypeInfo implements com.sforce.ws.bind.XMLizable {
   ...
   * java type: boolean
   */
  private static final com.sforce.ws.bind.TypeInfo master__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","master","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
    ...
    __typeMapper.writeBoolean(__out, master__typeInfo, master, master__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    __in.peekTag();
    if (__typeMapper.verifyElement(__in, master__typeInfo)) {
      setMaster((boolean)__typeMapper.readBoolean(__in, master__typeInfo, boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" master=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(master)+"'\n");
    sb.append(" name=");

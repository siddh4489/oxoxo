...
public class ProcessRequest implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo comments__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","comments","http://www.w3.org/2001/XMLSchema","string",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo nextApproverIds__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","nextApproverIds","urn:enterprise.soap.sforce.com","ID",0,-1,true);

...
public class DescribeSoftphoneLayoutResult implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo callTypes__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","callTypes","urn:enterprise.soap.sforce.com","DescribeSoftphoneLayoutCallType",1,-1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.verifyElement(__in, callTypes__typeInfo)) {
      setCallTypes((com.sforce.soap.enterprise.DescribeSoftphoneLayoutCallType[])__typeMapper.readObject(__in, callTypes__typeInfo, com.sforce.soap.enterprise.DescribeSoftphoneLayoutCallType[].class));
    }
    __in.peekTag();

 ...
 */
public class Almond__Training_Plan_Assignment__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__Training_Plan_Assignment__c() {
  }
  ...
  /**
   * element  : almond__Last_Updated__c of type {http://www.w3.org/2001/XMLSchema}dateTime
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Last_Updated__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Last_Updated__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

  private boolean almond__Last_Updated__c__is_set = false;

  private java.util.Calendar almond__Last_Updated__c;

  public java.util.Calendar getAlmond__Last_Updated__c() {
    return almond__Last_Updated__c;
  }

  

  public void setAlmond__Last_Updated__c(java.util.Calendar almond__Last_Updated__c) {
    this.almond__Last_Updated__c = almond__Last_Updated__c;
    almond__Last_Updated__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__Training_Plan_Assignment__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, almond__Last_Updated__c__typeInfo, almond__Last_Updated__c, almond__Last_Updated__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Last_Updated__c__typeInfo)) {
      setAlmond__Last_Updated__c((java.util.Calendar)__typeMapper.readObject(__in, almond__Last_Updated__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" almond__Last_Updated__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Last_Updated__c)+"'\n");

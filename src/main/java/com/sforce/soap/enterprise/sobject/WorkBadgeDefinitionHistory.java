 ...
 */
public class WorkBadgeDefinitionHistory extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public WorkBadgeDefinitionHistory() {
  }
  ...
  /**
   * element  : WorkBadgeDefinition of type {urn:sobject.enterprise.soap.sforce.com}WorkBadgeDefinition
   * java type: com.sforce.soap.enterprise.sobject.WorkBadgeDefinition
   */
  private static final com.sforce.ws.bind.TypeInfo WorkBadgeDefinition__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkBadgeDefinition","urn:sobject.enterprise.soap.sforce.com","WorkBadgeDefinition",0,1,true);

  private boolean WorkBadgeDefinition__is_set = false;

  private com.sforce.soap.enterprise.sobject.WorkBadgeDefinition WorkBadgeDefinition;

  public com.sforce.soap.enterprise.sobject.WorkBadgeDefinition getWorkBadgeDefinition() {
    return WorkBadgeDefinition;
  }

  

  public void setWorkBadgeDefinition(com.sforce.soap.enterprise.sobject.WorkBadgeDefinition WorkBadgeDefinition) {
    this.WorkBadgeDefinition = WorkBadgeDefinition;
    WorkBadgeDefinition__is_set = true;
  }
  
  /**
   * element  : WorkBadgeDefinitionId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo WorkBadgeDefinitionId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","WorkBadgeDefinitionId","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean WorkBadgeDefinitionId__is_set = false;

  private java.lang.String WorkBadgeDefinitionId;

  public java.lang.String getWorkBadgeDefinitionId() {
    return WorkBadgeDefinitionId;
  }

  

  public void setWorkBadgeDefinitionId(java.lang.String WorkBadgeDefinitionId) {
    this.WorkBadgeDefinitionId = WorkBadgeDefinitionId;
    WorkBadgeDefinitionId__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "WorkBadgeDefinitionHistory");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, WorkBadgeDefinition__typeInfo, WorkBadgeDefinition, WorkBadgeDefinition__is_set);
    __typeMapper.writeString(__out, WorkBadgeDefinitionId__typeInfo, WorkBadgeDefinitionId, WorkBadgeDefinitionId__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, WorkBadgeDefinition__typeInfo)) {
      setWorkBadgeDefinition((com.sforce.soap.enterprise.sobject.WorkBadgeDefinition)__typeMapper.readObject(__in, WorkBadgeDefinition__typeInfo, com.sforce.soap.enterprise.sobject.WorkBadgeDefinition.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, WorkBadgeDefinitionId__typeInfo)) {
      setWorkBadgeDefinitionId((java.lang.String)__typeMapper.readString(__in, WorkBadgeDefinitionId__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[WorkBadgeDefinitionHistory ");
    ...
    sb.append(" WorkBadgeDefinition=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(WorkBadgeDefinition)+"'\n");
    sb.append(" WorkBadgeDefinitionId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(WorkBadgeDefinitionId)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
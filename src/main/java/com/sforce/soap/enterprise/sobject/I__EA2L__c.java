 ...
 */
public class I__EA2L__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public I__EA2L__c() {
  ...
  /**
   * element  : i__Lead__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__Lead__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Lead__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean i__Lead__c__is_set = false;

  private java.lang.String i__Lead__c;

  public java.lang.String getI__Lead__c() {
    return i__Lead__c;
  }

  

  public void setI__Lead__c(java.lang.String i__Lead__c) {
    this.i__Lead__c = i__Lead__c;
    i__Lead__c__is_set = true;
  }
  
  /**
   * element  : i__Lead__r of type {urn:sobject.enterprise.soap.sforce.com}Lead
   * java type: com.sforce.soap.enterprise.sobject.Lead
   */
  private static final com.sforce.ws.bind.TypeInfo i__Lead__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Lead__r","urn:sobject.enterprise.soap.sforce.com","Lead",0,1,true);

  private boolean i__Lead__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Lead i__Lead__r;

  public com.sforce.soap.enterprise.sobject.Lead getI__Lead__r() {
    return i__Lead__r;
  }

  

  public void setI__Lead__r(com.sforce.soap.enterprise.sobject.Lead i__Lead__r) {
    this.i__Lead__r = i__Lead__r;
    i__Lead__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "i__EA2L__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, i__Lead__c__typeInfo, i__Lead__c, i__Lead__c__is_set);
    __typeMapper.writeObject(__out, i__Lead__r__typeInfo, i__Lead__r, i__Lead__r__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Lead__c__typeInfo)) {
      setI__Lead__c((java.lang.String)__typeMapper.readString(__in, i__Lead__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Lead__r__typeInfo)) {
      setI__Lead__r((com.sforce.soap.enterprise.sobject.Lead)__typeMapper.readObject(__in, i__Lead__r__typeInfo, com.sforce.soap.enterprise.sobject.Lead.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[I__EA2L__c ");
    ...
    sb.append(" i__Lead__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Lead__c)+"'\n");
    sb.append(" i__Lead__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Lead__r)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
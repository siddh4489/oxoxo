 ...
 */
public class CaseContactRole extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : Cases of type {urn:sobject.enterprise.soap.sforce.com}Case
   * java type: com.sforce.soap.enterprise.sobject.Case
   */
  private static final com.sforce.ws.bind.TypeInfo Cases__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Cases","urn:sobject.enterprise.soap.sforce.com","Case",0,1,true);

  private boolean Cases__is_set = false;

  private com.sforce.soap.enterprise.sobject.Case Cases;

  public com.sforce.soap.enterprise.sobject.Case getCases() {
    return Cases;
  }

  

  public void setCases(com.sforce.soap.enterprise.sobject.Case Cases) {
    this.Cases = Cases;
    Cases__is_set = true;
  }
  
  /**
   * element  : CasesId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo CasesId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CasesId","urn:enterprise.soap.sforce.com","ID",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "CaseContactRole");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, CasesId__typeInfo, CasesId, CasesId__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Cases__typeInfo)) {
      setCases((com.sforce.soap.enterprise.sobject.Case)__typeMapper.readObject(__in, Cases__typeInfo, com.sforce.soap.enterprise.sobject.Case.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, CasesId__typeInfo)) {
      setCasesId((java.lang.String)__typeMapper.readString(__in, CasesId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[CaseContactRole ");
    sb.append(super.toString());
    sb.append(" Cases=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Cases)+"'\n");
    sb.append(" CasesId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CasesId)+"'\n");
    sb.append(" Contact=");

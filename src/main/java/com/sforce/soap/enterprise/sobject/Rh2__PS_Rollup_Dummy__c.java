 ...
 */
public class Rh2__PS_Rollup_Dummy__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Rh2__PS_Rollup_Dummy__c() {
  }
  ...
  /**
   * element  : rh2__Parent_Dummy__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo rh2__Parent_Dummy__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","rh2__Parent_Dummy__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean rh2__Parent_Dummy__c__is_set = false;

  private java.lang.String rh2__Parent_Dummy__c;

  public java.lang.String getRh2__Parent_Dummy__c() {
    return rh2__Parent_Dummy__c;
  }

  

  public void setRh2__Parent_Dummy__c(java.lang.String rh2__Parent_Dummy__c) {
    this.rh2__Parent_Dummy__c = rh2__Parent_Dummy__c;
    rh2__Parent_Dummy__c__is_set = true;
  }
  
  /**
   * element  : rh2__Parent_Dummy__r of type {urn:sobject.enterprise.soap.sforce.com}rh2__PS_Rollup_Dummy__c
   * java type: com.sforce.soap.enterprise.sobject.Rh2__PS_Rollup_Dummy__c
   */
  private static final com.sforce.ws.bind.TypeInfo rh2__Parent_Dummy__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","rh2__Parent_Dummy__r","urn:sobject.enterprise.soap.sforce.com","rh2__PS_Rollup_Dummy__c",0,1,true);

  private boolean rh2__Parent_Dummy__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Rh2__PS_Rollup_Dummy__c rh2__Parent_Dummy__r;

  public com.sforce.soap.enterprise.sobject.Rh2__PS_Rollup_Dummy__c getRh2__Parent_Dummy__r() {
    return rh2__Parent_Dummy__r;
  }

  

  public void setRh2__Parent_Dummy__r(com.sforce.soap.enterprise.sobject.Rh2__PS_Rollup_Dummy__c rh2__Parent_Dummy__r) {
    this.rh2__Parent_Dummy__r = rh2__Parent_Dummy__r;
    rh2__Parent_Dummy__r__is_set = true;
  }
  ...
  /**
   * element  : rh2__Test_Numeric__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo rh2__Test_Numeric__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","rh2__Test_Numeric__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean rh2__Test_Numeric__c__is_set = false;

  private java.lang.Double rh2__Test_Numeric__c;

  public java.lang.Double getRh2__Test_Numeric__c() {
    return rh2__Test_Numeric__c;
  }

  

  public void setRh2__Test_Numeric__c(java.lang.Double rh2__Test_Numeric__c) {
    this.rh2__Test_Numeric__c = rh2__Test_Numeric__c;
    rh2__Test_Numeric__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "rh2__PS_Rollup_Dummy__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, rh2__Parent_Dummy__c__typeInfo, rh2__Parent_Dummy__c, rh2__Parent_Dummy__c__is_set);
    __typeMapper.writeObject(__out, rh2__Parent_Dummy__r__typeInfo, rh2__Parent_Dummy__r, rh2__Parent_Dummy__r__is_set);
    __typeMapper.writeObject(__out, rh2__Rollup_Dummies__r__typeInfo, rh2__Rollup_Dummies__r, rh2__Rollup_Dummies__r__is_set);
    __typeMapper.writeObject(__out, rh2__Test_Numeric__c__typeInfo, rh2__Test_Numeric__c, rh2__Test_Numeric__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, rh2__Parent_Dummy__c__typeInfo)) {
      setRh2__Parent_Dummy__c((java.lang.String)__typeMapper.readString(__in, rh2__Parent_Dummy__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, rh2__Parent_Dummy__r__typeInfo)) {
      setRh2__Parent_Dummy__r((com.sforce.soap.enterprise.sobject.Rh2__PS_Rollup_Dummy__c)__typeMapper.readObject(__in, rh2__Parent_Dummy__r__typeInfo, com.sforce.soap.enterprise.sobject.Rh2__PS_Rollup_Dummy__c.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, rh2__Test_Numeric__c__typeInfo)) {
      setRh2__Test_Numeric__c((java.lang.Double)__typeMapper.readObject(__in, rh2__Test_Numeric__c__typeInfo, java.lang.Double.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Rh2__PS_Rollup_Dummy__c ");
    ...
    sb.append(" rh2__Parent_Dummy__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(rh2__Parent_Dummy__c)+"'\n");
    sb.append(" rh2__Parent_Dummy__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(rh2__Parent_Dummy__r)+"'\n");
    sb.append(" rh2__Rollup_Dummies__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(rh2__Rollup_Dummies__r)+"'\n");
    sb.append(" rh2__Test_Numeric__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(rh2__Test_Numeric__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
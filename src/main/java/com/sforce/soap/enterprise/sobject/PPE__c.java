 ...
 */
public class PPE__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public PPE__c() {
  ...
  /**
   * element  : Date_Issued__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_Issued__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_Issued__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Date_Issued__c__is_set = false;

  private java.util.Calendar Date_Issued__c;

  public java.util.Calendar getDate_Issued__c() {
    return Date_Issued__c;
  }

  

  public void setDate_Issued__c(java.util.Calendar Date_Issued__c) {
    this.Date_Issued__c = Date_Issued__c;
    Date_Issued__c__is_set = true;
  }
  ...
  /**
   * element  : Order__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Order__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Order__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);
  ...
  /**
   * element  : PPE_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo PPE_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","PPE_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean PPE_Type__c__is_set = false;

  private java.lang.String PPE_Type__c;

  public java.lang.String getPPE_Type__c() {
    return PPE_Type__c;
  }

  

  public void setPPE_Type__c(java.lang.String PPE_Type__c) {
    this.PPE_Type__c = PPE_Type__c;
    PPE_Type__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "PPE__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Date_Issued__c__typeInfo, Date_Issued__c, Date_Issued__c__is_set);
    ...
    __typeMapper.writeString(__out, PPE_Type__c__typeInfo, PPE_Type__c, PPE_Type__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_Issued__c__typeInfo)) {
      setDate_Issued__c((java.util.Calendar)__typeMapper.readObject(__in, Date_Issued__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, PPE_Type__c__typeInfo)) {
      setPPE_Type__c((java.lang.String)__typeMapper.readString(__in, PPE_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Date_Issued__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_Issued__c)+"'\n");
    ...
    sb.append(" PPE_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(PPE_Type__c)+"'\n");

 ...
 */
public class TodayGoalShare extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public TodayGoalShare() {
  }
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}TodayGoal
   * java type: com.sforce.soap.enterprise.sobject.TodayGoal
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","TodayGoal",0,1,true);

  private boolean Parent__is_set = false;

  private com.sforce.soap.enterprise.sobject.TodayGoal Parent;

  public com.sforce.soap.enterprise.sobject.TodayGoal getParent() {
    return Parent;
  }

  

  public void setParent(com.sforce.soap.enterprise.sobject.TodayGoal Parent) {
    this.Parent = Parent;
    Parent__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "TodayGoalShare");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.TodayGoal)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.TodayGoal.class));
    }
    __in.peekTag();

 ...
 */
public class Mapquest__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Mapquest__c() {
  ...
  /**
   * element  : API_Key__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo API_Key__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","API_Key__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean API_Key__c__is_set = false;

  private java.lang.String API_Key__c;

  public java.lang.String getAPI_Key__c() {
    return API_Key__c;
  }

  

  public void setAPI_Key__c(java.lang.String API_Key__c) {
    this.API_Key__c = API_Key__c;
    API_Key__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Mapquest__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, API_Key__c__typeInfo, API_Key__c, API_Key__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, API_Key__c__typeInfo)) {
      setAPI_Key__c((java.lang.String)__typeMapper.readString(__in, API_Key__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Mapquest__c ");
    sb.append(super.toString());
    sb.append(" API_Endpoint__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(API_Endpoint__c)+"'\n");
    sb.append(" API_Key__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(API_Key__c)+"'\n");

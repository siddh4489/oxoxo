 ...
 */
public class Almond__Question_Line__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__Question_Line__c() {
  }
  ...
  /**
   * element  : almond__Questions__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Questions__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Questions__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean almond__Questions__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult almond__Questions__r;

  public com.sforce.soap.enterprise.QueryResult getAlmond__Questions__r() {
    return almond__Questions__r;
  }

  

  public void setAlmond__Questions__r(com.sforce.soap.enterprise.QueryResult almond__Questions__r) {
    this.almond__Questions__r = almond__Questions__r;
    almond__Questions__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__Question_Line__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, almond__Questions__r__typeInfo, almond__Questions__r, almond__Questions__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Questions__r__typeInfo)) {
      setAlmond__Questions__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, almond__Questions__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" almond__Questions__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Questions__r)+"'\n");

 ...
 */
public class Dlrs__LookupParent__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Dlrs__LookupParent__c() {
  }
  ...
  /**
   * element  : dlrs__Colours__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__Colours__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__Colours__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dlrs__Colours__c__is_set = false;

  private java.lang.String dlrs__Colours__c;

  public java.lang.String getDlrs__Colours__c() {
    return dlrs__Colours__c;
  }

  

  public void setDlrs__Colours__c(java.lang.String dlrs__Colours__c) {
    this.dlrs__Colours__c = dlrs__Colours__c;
    dlrs__Colours__c__is_set = true;
  }
  
  /**
   * element  : dlrs__LookupChildBig__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__LookupChildBig__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__LookupChildBig__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean dlrs__LookupChildBig__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult dlrs__LookupChildBig__r;

  public com.sforce.soap.enterprise.QueryResult getDlrs__LookupChildBig__r() {
    return dlrs__LookupChildBig__r;
  }

  

  public void setDlrs__LookupChildBig__r(com.sforce.soap.enterprise.QueryResult dlrs__LookupChildBig__r) {
    this.dlrs__LookupChildBig__r = dlrs__LookupChildBig__r;
    dlrs__LookupChildBig__r__is_set = true;
  }
  
  /**
   * element  : dlrs__LookupChildren__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__LookupChildren__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__LookupChildren__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean dlrs__LookupChildren__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult dlrs__LookupChildren__r;

  public com.sforce.soap.enterprise.QueryResult getDlrs__LookupChildren__r() {
    return dlrs__LookupChildren__r;
  }

  

  public void setDlrs__LookupChildren__r(com.sforce.soap.enterprise.QueryResult dlrs__LookupChildren__r) {
    this.dlrs__LookupChildren__r = dlrs__LookupChildren__r;
    dlrs__LookupChildren__r__is_set = true;
  }
  
  /**
   * element  : dlrs__Total2__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__Total2__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__Total2__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean dlrs__Total2__c__is_set = false;

  private java.lang.Double dlrs__Total2__c;

  public java.lang.Double getDlrs__Total2__c() {
    return dlrs__Total2__c;
  }

  

  public void setDlrs__Total2__c(java.lang.Double dlrs__Total2__c) {
    this.dlrs__Total2__c = dlrs__Total2__c;
    dlrs__Total2__c__is_set = true;
  }
  
  /**
   * element  : dlrs__Total__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__Total__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__Total__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean dlrs__Total__c__is_set = false;

  private java.lang.Double dlrs__Total__c;

  public java.lang.Double getDlrs__Total__c() {
    return dlrs__Total__c;
  }

  

  public void setDlrs__Total__c(java.lang.Double dlrs__Total__c) {
    this.dlrs__Total__c = dlrs__Total__c;
    dlrs__Total__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "dlrs__LookupParent__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, dlrs__Colours__c__typeInfo, dlrs__Colours__c, dlrs__Colours__c__is_set);
    __typeMapper.writeObject(__out, dlrs__LookupChildBig__r__typeInfo, dlrs__LookupChildBig__r, dlrs__LookupChildBig__r__is_set);
    __typeMapper.writeObject(__out, dlrs__LookupChildren__r__typeInfo, dlrs__LookupChildren__r, dlrs__LookupChildren__r__is_set);
    __typeMapper.writeObject(__out, dlrs__Total2__c__typeInfo, dlrs__Total2__c, dlrs__Total2__c__is_set);
    __typeMapper.writeObject(__out, dlrs__Total__c__typeInfo, dlrs__Total__c, dlrs__Total__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__Colours__c__typeInfo)) {
      setDlrs__Colours__c((java.lang.String)__typeMapper.readString(__in, dlrs__Colours__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__LookupChildBig__r__typeInfo)) {
      setDlrs__LookupChildBig__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, dlrs__LookupChildBig__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__LookupChildren__r__typeInfo)) {
      setDlrs__LookupChildren__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, dlrs__LookupChildren__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__Total2__c__typeInfo)) {
      setDlrs__Total2__c((java.lang.Double)__typeMapper.readObject(__in, dlrs__Total2__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__Total__c__typeInfo)) {
      setDlrs__Total__c((java.lang.Double)__typeMapper.readObject(__in, dlrs__Total__c__typeInfo, java.lang.Double.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Dlrs__LookupParent__c ");
    ...
    sb.append(" dlrs__Colours__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__Colours__c)+"'\n");
    sb.append(" dlrs__LookupChildBig__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__LookupChildBig__r)+"'\n");
    sb.append(" dlrs__LookupChildren__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__LookupChildren__r)+"'\n");
    sb.append(" dlrs__Total2__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__Total2__c)+"'\n");
    sb.append(" dlrs__Total__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__Total__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
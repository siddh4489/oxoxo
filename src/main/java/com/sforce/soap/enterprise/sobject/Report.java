 ...
 */
public class Report extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Report() {
  ...
  /**
   * element  : LastRunDate of type {http://www.w3.org/2001/XMLSchema}dateTime
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo LastRunDate__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","LastRunDate","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

  private boolean LastRunDate__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Report");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, LastRunDate__typeInfo)) {
      setLastRunDate((java.util.Calendar)__typeMapper.readObject(__in, LastRunDate__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(LastRunDate)+"'\n");

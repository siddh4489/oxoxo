 ...
 */
public class ProfileSkillUserFeed extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public ProfileSkillUserFeed() {
  }
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}ProfileSkillUser
  ...
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","ProfileSkillUser",0,1,true);

  private boolean Parent__is_set = false;

  private com.sforce.soap.enterprise.sobject.ProfileSkillUser Parent;

  public com.sforce.soap.enterprise.sobject.ProfileSkillUser getParent() {
    return Parent;
  }

  

  public void setParent(com.sforce.soap.enterprise.sobject.ProfileSkillUser Parent) {
    this.Parent = Parent;
    Parent__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "ProfileSkillUserFeed");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.ProfileSkillUser)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.ProfileSkillUser.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[ProfileSkillUserFeed ");

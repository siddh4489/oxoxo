 ...
 */
public class SFDC_PTO_Request__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public SFDC_PTO_Request__c() {
  }
  ...
  /**
   * element  : Date_of_Request__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_of_Request__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_of_Request__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Date_of_Request__c__is_set = false;

  private java.util.Calendar Date_of_Request__c;

  public java.util.Calendar getDate_of_Request__c() {
    return Date_of_Request__c;
  }

  

  public void setDate_of_Request__c(java.util.Calendar Date_of_Request__c) {
    this.Date_of_Request__c = Date_of_Request__c;
    Date_of_Request__c__is_set = true;
  }
  
  /**
   * element  : Days_Off__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Days_Off__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Days_Off__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Days_Off__c__is_set = false;

  private java.lang.Double Days_Off__c;

  public java.lang.Double getDays_Off__c() {
    return Days_Off__c;
  }

  

  public void setDays_Off__c(java.lang.Double Days_Off__c) {
    this.Days_Off__c = Days_Off__c;
    Days_Off__c__is_set = true;
  }
  ...
  /**
   * element  : Paid_Time_Off__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo Paid_Time_Off__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Paid_Time_Off__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean Paid_Time_Off__c__is_set = false;

  private java.lang.Boolean Paid_Time_Off__c;

  public java.lang.Boolean getPaid_Time_Off__c() {
    return Paid_Time_Off__c;
  }

  

  public void setPaid_Time_Off__c(java.lang.Boolean Paid_Time_Off__c) {
    this.Paid_Time_Off__c = Paid_Time_Off__c;
    Paid_Time_Off__c__is_set = true;
  }
  ...
  /**
   * element  : Request_End_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Request_End_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Request_End_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Request_End_Date__c__is_set = false;

  private java.util.Calendar Request_End_Date__c;

  public java.util.Calendar getRequest_End_Date__c() {
    return Request_End_Date__c;
  }

  

  public void setRequest_End_Date__c(java.util.Calendar Request_End_Date__c) {
    this.Request_End_Date__c = Request_End_Date__c;
    Request_End_Date__c__is_set = true;
  }
  
  /**
   * element  : Request_Start_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Request_Start_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Request_Start_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Request_Start_Date__c__is_set = false;

  private java.util.Calendar Request_Start_Date__c;

  public java.util.Calendar getRequest_Start_Date__c() {
    return Request_Start_Date__c;
  }

  

  public void setRequest_Start_Date__c(java.util.Calendar Request_Start_Date__c) {
    this.Request_Start_Date__c = Request_Start_Date__c;
    Request_Start_Date__c__is_set = true;
  }
  
  /**
   * element  : Request_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Request_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Request_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Request_Type__c__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "SFDC_PTO_Request__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Date_of_Request__c__typeInfo, Date_of_Request__c, Date_of_Request__c__is_set);
    __typeMapper.writeObject(__out, Days_Off__c__typeInfo, Days_Off__c, Days_Off__c__is_set);
    ...
    __typeMapper.writeObject(__out, Paid_Time_Off__c__typeInfo, Paid_Time_Off__c, Paid_Time_Off__c__is_set);
    ...
    __typeMapper.writeObject(__out, Request_End_Date__c__typeInfo, Request_End_Date__c, Request_End_Date__c__is_set);
    __typeMapper.writeObject(__out, Request_Start_Date__c__typeInfo, Request_Start_Date__c, Request_Start_Date__c__is_set);
    __typeMapper.writeString(__out, Request_Type__c__typeInfo, Request_Type__c, Request_Type__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_of_Request__c__typeInfo)) {
      setDate_of_Request__c((java.util.Calendar)__typeMapper.readObject(__in, Date_of_Request__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Days_Off__c__typeInfo)) {
      setDays_Off__c((java.lang.Double)__typeMapper.readObject(__in, Days_Off__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Paid_Time_Off__c__typeInfo)) {
      setPaid_Time_Off__c((java.lang.Boolean)__typeMapper.readObject(__in, Paid_Time_Off__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Request_End_Date__c__typeInfo)) {
      setRequest_End_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Request_End_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Request_Start_Date__c__typeInfo)) {
      setRequest_Start_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Request_Start_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Request_Type__c__typeInfo)) {
      setRequest_Type__c((java.lang.String)__typeMapper.readString(__in, Request_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Date_of_Request__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_of_Request__c)+"'\n");
    sb.append(" Days_Off__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Days_Off__c)+"'\n");
    ...
    sb.append(" Paid_Time_Off__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Paid_Time_Off__c)+"'\n");
    ...
    sb.append(" Request_End_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Request_End_Date__c)+"'\n");
    sb.append(" Request_Start_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Request_Start_Date__c)+"'\n");
    sb.append(" Request_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Request_Type__c)+"'\n");

 ...
 */
public class Employment_Paperwork2__History extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Employment_Paperwork2__History() {
  }
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}Employment_Paperwork2__c
   * java type: com.sforce.soap.enterprise.sobject.Employment_Paperwork2__c
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","Employment_Paperwork2__c",0,1,true);

  private boolean Parent__is_set = false;

  private com.sforce.soap.enterprise.sobject.Employment_Paperwork2__c Parent;

  public com.sforce.soap.enterprise.sobject.Employment_Paperwork2__c getParent() {
    return Parent;
  }

  

  public void setParent(com.sforce.soap.enterprise.sobject.Employment_Paperwork2__c Parent) {
    this.Parent = Parent;
    Parent__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Employment_Paperwork2__History");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.Employment_Paperwork2__c)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.Employment_Paperwork2__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Employment_Paperwork2__History ");

 ...
 */
public class TOD__TipOfTheDay__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public TOD__TipOfTheDay__c() {
  }
  ...
  /**
   * element  : TOD__Background_Color__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo TOD__Background_Color__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","TOD__Background_Color__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean TOD__Background_Color__c__is_set = false;

  private java.lang.String TOD__Background_Color__c;

  public java.lang.String getTOD__Background_Color__c() {
    return TOD__Background_Color__c;
  }

  

  public void setTOD__Background_Color__c(java.lang.String TOD__Background_Color__c) {
    this.TOD__Background_Color__c = TOD__Background_Color__c;
    TOD__Background_Color__c__is_set = true;
  }
  
  /**
   * element  : TOD__End__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo TOD__End__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","TOD__End__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean TOD__End__c__is_set = false;

  private java.util.Calendar TOD__End__c;

  public java.util.Calendar getTOD__End__c() {
    return TOD__End__c;
  }

  

  public void setTOD__End__c(java.util.Calendar TOD__End__c) {
    this.TOD__End__c = TOD__End__c;
    TOD__End__c__is_set = true;
  }
  
  /**
   * element  : TOD__Image_URL__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo TOD__Image_URL__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","TOD__Image_URL__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean TOD__Image_URL__c__is_set = false;

  private java.lang.String TOD__Image_URL__c;

  public java.lang.String getTOD__Image_URL__c() {
    return TOD__Image_URL__c;
  }

  

  public void setTOD__Image_URL__c(java.lang.String TOD__Image_URL__c) {
    this.TOD__Image_URL__c = TOD__Image_URL__c;
    TOD__Image_URL__c__is_set = true;
  }
  
  /**
   * element  : TOD__Quote__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo TOD__Quote__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","TOD__Quote__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean TOD__Quote__c__is_set = false;

  private java.lang.String TOD__Quote__c;

  public java.lang.String getTOD__Quote__c() {
    return TOD__Quote__c;
  }

  

  public void setTOD__Quote__c(java.lang.String TOD__Quote__c) {
    this.TOD__Quote__c = TOD__Quote__c;
    TOD__Quote__c__is_set = true;
  }
  
  /**
   * element  : TOD__Start__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo TOD__Start__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","TOD__Start__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean TOD__Start__c__is_set = false;

  private java.util.Calendar TOD__Start__c;

  public java.util.Calendar getTOD__Start__c() {
    return TOD__Start__c;
  }

  

  public void setTOD__Start__c(java.util.Calendar TOD__Start__c) {
    this.TOD__Start__c = TOD__Start__c;
    TOD__Start__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "TOD__TipOfTheDay__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, TOD__Background_Color__c__typeInfo, TOD__Background_Color__c, TOD__Background_Color__c__is_set);
    __typeMapper.writeObject(__out, TOD__End__c__typeInfo, TOD__End__c, TOD__End__c__is_set);
    __typeMapper.writeString(__out, TOD__Image_URL__c__typeInfo, TOD__Image_URL__c, TOD__Image_URL__c__is_set);
    __typeMapper.writeString(__out, TOD__Quote__c__typeInfo, TOD__Quote__c, TOD__Quote__c__is_set);
    __typeMapper.writeObject(__out, TOD__Start__c__typeInfo, TOD__Start__c, TOD__Start__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, TOD__Background_Color__c__typeInfo)) {
      setTOD__Background_Color__c((java.lang.String)__typeMapper.readString(__in, TOD__Background_Color__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, TOD__End__c__typeInfo)) {
      setTOD__End__c((java.util.Calendar)__typeMapper.readObject(__in, TOD__End__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, TOD__Image_URL__c__typeInfo)) {
      setTOD__Image_URL__c((java.lang.String)__typeMapper.readString(__in, TOD__Image_URL__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, TOD__Quote__c__typeInfo)) {
      setTOD__Quote__c((java.lang.String)__typeMapper.readString(__in, TOD__Quote__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, TOD__Start__c__typeInfo)) {
      setTOD__Start__c((java.util.Calendar)__typeMapper.readObject(__in, TOD__Start__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" TOD__Background_Color__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(TOD__Background_Color__c)+"'\n");
    sb.append(" TOD__End__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(TOD__End__c)+"'\n");
    sb.append(" TOD__Image_URL__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(TOD__Image_URL__c)+"'\n");
    sb.append(" TOD__Quote__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(TOD__Quote__c)+"'\n");
    sb.append(" TOD__Start__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(TOD__Start__c)+"'\n");
    sb.append(" Tags=");

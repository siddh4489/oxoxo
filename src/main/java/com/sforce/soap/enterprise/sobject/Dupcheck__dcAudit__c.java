 ...
 */
public class Dupcheck__dcAudit__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Dupcheck__dcAudit__c() {
  }
  ...
  /**
   * element  : dupcheck__AuditDate__c of type {http://www.w3.org/2001/XMLSchema}dateTime
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__AuditDate__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__AuditDate__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

  private boolean dupcheck__AuditDate__c__is_set = false;

  private java.util.Calendar dupcheck__AuditDate__c;

  public java.util.Calendar getDupcheck__AuditDate__c() {
    return dupcheck__AuditDate__c;
  }

  

  public void setDupcheck__AuditDate__c(java.util.Calendar dupcheck__AuditDate__c) {
    this.dupcheck__AuditDate__c = dupcheck__AuditDate__c;
    dupcheck__AuditDate__c__is_set = true;
  }
  ...
  /**
   * element  : dupcheck__TypeString__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dupcheck__TypeString__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dupcheck__TypeString__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dupcheck__TypeString__c__is_set = false;

  private java.lang.String dupcheck__TypeString__c;

  public java.lang.String getDupcheck__TypeString__c() {
    return dupcheck__TypeString__c;
  }

  

  public void setDupcheck__TypeString__c(java.lang.String dupcheck__TypeString__c) {
    this.dupcheck__TypeString__c = dupcheck__TypeString__c;
    dupcheck__TypeString__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "dupcheck__dcAudit__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, dupcheck__AuditDate__c__typeInfo, dupcheck__AuditDate__c, dupcheck__AuditDate__c__is_set);
    ...
    __typeMapper.writeString(__out, dupcheck__TypeString__c__typeInfo, dupcheck__TypeString__c, dupcheck__TypeString__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__AuditDate__c__typeInfo)) {
      setDupcheck__AuditDate__c((java.util.Calendar)__typeMapper.readObject(__in, dupcheck__AuditDate__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dupcheck__TypeString__c__typeInfo)) {
      setDupcheck__TypeString__c((java.lang.String)__typeMapper.readString(__in, dupcheck__TypeString__c__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Dupcheck__dcAudit__c ");
    ...
    sb.append(" dupcheck__AuditDate__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__AuditDate__c)+"'\n");
    ...
    sb.append(" dupcheck__TypeString__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dupcheck__TypeString__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
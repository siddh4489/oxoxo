 ...
 */
public class Opportunity_Swarm_Rule__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Opportunity_Swarm_Rule__c() {
  }
  ...
  /**
   * element  : Opportunity_Amount__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Opportunity_Amount__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Opportunity_Amount__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Opportunity_Amount__c__is_set = false;

  private java.lang.Double Opportunity_Amount__c;

  public java.lang.Double getOpportunity_Amount__c() {
    return Opportunity_Amount__c;
  }

  

  public void setOpportunity_Amount__c(java.lang.Double Opportunity_Amount__c) {
    this.Opportunity_Amount__c = Opportunity_Amount__c;
    Opportunity_Amount__c__is_set = true;
  }
  
  /**
   * element  : Opportunity_Stage__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Opportunity_Stage__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Opportunity_Stage__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Opportunity_Stage__c__is_set = false;

  private java.lang.String Opportunity_Stage__c;

  public java.lang.String getOpportunity_Stage__c() {
    return Opportunity_Stage__c;
  }

  

  public void setOpportunity_Stage__c(java.lang.String Opportunity_Stage__c) {
    this.Opportunity_Stage__c = Opportunity_Stage__c;
    Opportunity_Stage__c__is_set = true;
  }
  
  /**
   * element  : Opportunity_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Opportunity_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Opportunity_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Opportunity_Type__c__is_set = false;
  ...
  public void setOpportunity_Type__c(java.lang.String Opportunity_Type__c) {
    ...
    Opportunity_Type__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Opportunity_Swarm_Rule__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Opportunity_Amount__c__typeInfo, Opportunity_Amount__c, Opportunity_Amount__c__is_set);
    __typeMapper.writeString(__out, Opportunity_Stage__c__typeInfo, Opportunity_Stage__c, Opportunity_Stage__c__is_set);
    __typeMapper.writeString(__out, Opportunity_Type__c__typeInfo, Opportunity_Type__c, Opportunity_Type__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Opportunity_Amount__c__typeInfo)) {
      setOpportunity_Amount__c((java.lang.Double)__typeMapper.readObject(__in, Opportunity_Amount__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Opportunity_Stage__c__typeInfo)) {
      setOpportunity_Stage__c((java.lang.String)__typeMapper.readString(__in, Opportunity_Stage__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Opportunity_Type__c__typeInfo)) {
      setOpportunity_Type__c((java.lang.String)__typeMapper.readString(__in, Opportunity_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Opportunity_Swarm_Rule__c ");
    ...
    sb.append(" Opportunity_Amount__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Opportunity_Amount__c)+"'\n");
    sb.append(" Opportunity_Stage__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Opportunity_Stage__c)+"'\n");
    sb.append(" Opportunity_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Opportunity_Type__c)+"'\n");
    sb.append(" Owner=");

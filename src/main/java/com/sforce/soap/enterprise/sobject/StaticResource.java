 ...
 */
public class StaticResource extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  private static final com.sforce.ws.bind.TypeInfo CacheControl__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CacheControl","http://www.w3.org/2001/XMLSchema","string",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "StaticResource");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, CacheControl__typeInfo, CacheControl, CacheControl__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, CacheControl__typeInfo)) {
      setCacheControl((java.lang.String)__typeMapper.readString(__in, CacheControl__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CacheControl)+"'\n");

 ...
 */
public class Invoice_Payment__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Invoice_Payment__c() {
  }
  ...
  /**
   * element  : Invoice__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Invoice__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Invoice__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Invoice__c__is_set = false;
  ...
  public void setInvoice__c(java.lang.String Invoice__c) {
    ...
    Invoice__c__is_set = true;
  }
  
  /**
   * element  : Invoice__r of type {urn:sobject.enterprise.soap.sforce.com}Invoices__c
   * java type: com.sforce.soap.enterprise.sobject.Invoices__c
   */
  private static final com.sforce.ws.bind.TypeInfo Invoice__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Invoice__r","urn:sobject.enterprise.soap.sforce.com","Invoices__c",0,1,true);

  private boolean Invoice__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Invoices__c Invoice__r;

  public com.sforce.soap.enterprise.sobject.Invoices__c getInvoice__r() {
    return Invoice__r;
  }

  

  public void setInvoice__r(com.sforce.soap.enterprise.sobject.Invoices__c Invoice__r) {
    this.Invoice__r = Invoice__r;
    Invoice__r__is_set = true;
  }
  ...
  /**
   * element  : Payment_Amount__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Payment_Amount__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Payment_Amount__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Payment_Amount__c__is_set = false;

  private java.lang.Double Payment_Amount__c;

  public java.lang.Double getPayment_Amount__c() {
    return Payment_Amount__c;
  }

  

  public void setPayment_Amount__c(java.lang.Double Payment_Amount__c) {
    this.Payment_Amount__c = Payment_Amount__c;
    Payment_Amount__c__is_set = true;
  }
  
  /**
   * element  : Payment_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Payment_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Payment_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Payment_Date__c__is_set = false;

  private java.util.Calendar Payment_Date__c;

  public java.util.Calendar getPayment_Date__c() {
    return Payment_Date__c;
  }

  

  public void setPayment_Date__c(java.util.Calendar Payment_Date__c) {
    this.Payment_Date__c = Payment_Date__c;
    Payment_Date__c__is_set = true;
  }
  
  /**
   * element  : Payment_ID__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Payment_ID__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Payment_ID__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Payment_ID__c__is_set = false;

  private java.lang.String Payment_ID__c;

  public java.lang.String getPayment_ID__c() {
    return Payment_ID__c;
  }

  

  public void setPayment_ID__c(java.lang.String Payment_ID__c) {
    this.Payment_ID__c = Payment_ID__c;
    Payment_ID__c__is_set = true;
  }
  ...
  /**
   * element  : SF_Payment_ID__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo SF_Payment_ID__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","SF_Payment_ID__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean SF_Payment_ID__c__is_set = false;

  private java.lang.String SF_Payment_ID__c;

  public java.lang.String getSF_Payment_ID__c() {
    return SF_Payment_ID__c;
  }

  

  public void setSF_Payment_ID__c(java.lang.String SF_Payment_ID__c) {
    this.SF_Payment_ID__c = SF_Payment_ID__c;
    SF_Payment_ID__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Invoice_Payment__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Invoice__c__typeInfo, Invoice__c, Invoice__c__is_set);
    __typeMapper.writeObject(__out, Invoice__r__typeInfo, Invoice__r, Invoice__r__is_set);
    ...
    __typeMapper.writeObject(__out, Payment_Amount__c__typeInfo, Payment_Amount__c, Payment_Amount__c__is_set);
    __typeMapper.writeObject(__out, Payment_Date__c__typeInfo, Payment_Date__c, Payment_Date__c__is_set);
    __typeMapper.writeString(__out, Payment_ID__c__typeInfo, Payment_ID__c, Payment_ID__c__is_set);
    ...
    __typeMapper.writeString(__out, SF_Payment_ID__c__typeInfo, SF_Payment_ID__c, SF_Payment_ID__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Invoice__c__typeInfo)) {
      setInvoice__c((java.lang.String)__typeMapper.readString(__in, Invoice__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Invoice__r__typeInfo)) {
      setInvoice__r((com.sforce.soap.enterprise.sobject.Invoices__c)__typeMapper.readObject(__in, Invoice__r__typeInfo, com.sforce.soap.enterprise.sobject.Invoices__c.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Payment_Amount__c__typeInfo)) {
      setPayment_Amount__c((java.lang.Double)__typeMapper.readObject(__in, Payment_Amount__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Payment_Date__c__typeInfo)) {
      setPayment_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Payment_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Payment_ID__c__typeInfo)) {
      setPayment_ID__c((java.lang.String)__typeMapper.readString(__in, Payment_ID__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, SF_Payment_ID__c__typeInfo)) {
      setSF_Payment_ID__c((java.lang.String)__typeMapper.readString(__in, SF_Payment_ID__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Invoice__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Invoice__c)+"'\n");
    sb.append(" Invoice__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Invoice__r)+"'\n");
    sb.append(" IsDeleted=");
    ...
    sb.append(" Payment_Amount__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Payment_Amount__c)+"'\n");
    sb.append(" Payment_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Payment_Date__c)+"'\n");
    sb.append(" Payment_ID__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Payment_ID__c)+"'\n");
    ...
    sb.append(" SF_Payment_ID__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SF_Payment_ID__c)+"'\n");

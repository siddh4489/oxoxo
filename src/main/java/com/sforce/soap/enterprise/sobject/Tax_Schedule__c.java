 ...
 */
public class Tax_Schedule__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Tax_Schedule__c() {
  }
  ...
  /**
   * element  : County__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo County__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","County__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean County__c__is_set = false;

  private java.lang.String County__c;

  public java.lang.String getCounty__c() {
    return County__c;
  }

  

  public void setCounty__c(java.lang.String County__c) {
    this.County__c = County__c;
    County__c__is_set = true;
  }
  ...
  /**
   * element  : Tax_Code__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Tax_Code__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Tax_Code__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Tax_Code__c__is_set = false;

  private java.lang.String Tax_Code__c;

  public java.lang.String getTax_Code__c() {
    return Tax_Code__c;
  }

  

  public void setTax_Code__c(java.lang.String Tax_Code__c) {
    this.Tax_Code__c = Tax_Code__c;
    Tax_Code__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Tax_Schedule__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, County__c__typeInfo, County__c, County__c__is_set);
    ...
    __typeMapper.writeString(__out, Tax_Code__c__typeInfo, Tax_Code__c, Tax_Code__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, County__c__typeInfo)) {
      setCounty__c((java.lang.String)__typeMapper.readString(__in, County__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Tax_Code__c__typeInfo)) {
      setTax_Code__c((java.lang.String)__typeMapper.readString(__in, Tax_Code__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" County__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(County__c)+"'\n");
    sb.append(" CreatedBy=");
    ...
    sb.append(" Tax_Code__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Tax_Code__c)+"'\n");

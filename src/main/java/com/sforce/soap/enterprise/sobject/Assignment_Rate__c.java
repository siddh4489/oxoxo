 ...
 */
public class Assignment_Rate__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Assignment_Rate__c() {
  }
  ...
  /**
   * element  : Bill_Rate__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Bill_Rate__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Bill_Rate__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Bill_Rate__c__is_set = false;

  private java.lang.Double Bill_Rate__c;

  public java.lang.Double getBill_Rate__c() {
    return Bill_Rate__c;
  }

  

  public void setBill_Rate__c(java.lang.Double Bill_Rate__c) {
    this.Bill_Rate__c = Bill_Rate__c;
    Bill_Rate__c__is_set = true;
  }
  ...
  /**
   * element  : Pay_Code_Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Pay_Code_Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Pay_Code_Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Pay_Code_Name__c__is_set = false;

  private java.lang.String Pay_Code_Name__c;

  public java.lang.String getPay_Code_Name__c() {
    return Pay_Code_Name__c;
  }

  

  public void setPay_Code_Name__c(java.lang.String Pay_Code_Name__c) {
    this.Pay_Code_Name__c = Pay_Code_Name__c;
    Pay_Code_Name__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Assignment_Rate__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Bill_Rate__c__typeInfo, Bill_Rate__c, Bill_Rate__c__is_set);
    ...
    __typeMapper.writeString(__out, Pay_Code_Name__c__typeInfo, Pay_Code_Name__c, Pay_Code_Name__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Bill_Rate__c__typeInfo)) {
      setBill_Rate__c((java.lang.Double)__typeMapper.readObject(__in, Bill_Rate__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Pay_Code_Name__c__typeInfo)) {
      setPay_Code_Name__c((java.lang.String)__typeMapper.readString(__in, Pay_Code_Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Bill_Rate__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Bill_Rate__c)+"'\n");
    ...
    sb.append(" Pay_Code_Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Pay_Code_Name__c)+"'\n");

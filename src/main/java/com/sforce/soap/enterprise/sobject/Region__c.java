 ...
 */
public class Region__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Region__c() {
  ...
  /**
   * element  : Region_Manager__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Region_Manager__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Region_Manager__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Region_Manager__c__is_set = false;

  private java.lang.String Region_Manager__c;

  public java.lang.String getRegion_Manager__c() {
    return Region_Manager__c;
  }

  

  public void setRegion_Manager__c(java.lang.String Region_Manager__c) {
    this.Region_Manager__c = Region_Manager__c;
    Region_Manager__c__is_set = true;
  }
  
  /**
   * element  : Region_Manager__r of type {urn:sobject.enterprise.soap.sforce.com}User
   * java type: com.sforce.soap.enterprise.sobject.User
   */
  private static final com.sforce.ws.bind.TypeInfo Region_Manager__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Region_Manager__r","urn:sobject.enterprise.soap.sforce.com","User",0,1,true);

  private boolean Region_Manager__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.User Region_Manager__r;

  public com.sforce.soap.enterprise.sobject.User getRegion_Manager__r() {
    return Region_Manager__r;
  }

  

  public void setRegion_Manager__r(com.sforce.soap.enterprise.sobject.User Region_Manager__r) {
    this.Region_Manager__r = Region_Manager__r;
    Region_Manager__r__is_set = true;
  }
  
  /**
   * element  : States__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo States__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","States__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean States__c__is_set = false;

  private java.lang.String States__c;

  public java.lang.String getStates__c() {
    return States__c;
  }

  

  public void setStates__c(java.lang.String States__c) {
    this.States__c = States__c;
    States__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Region__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Region_Manager__c__typeInfo, Region_Manager__c, Region_Manager__c__is_set);
    __typeMapper.writeObject(__out, Region_Manager__r__typeInfo, Region_Manager__r, Region_Manager__r__is_set);
    __typeMapper.writeString(__out, States__c__typeInfo, States__c, States__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Region_Manager__c__typeInfo)) {
      setRegion_Manager__c((java.lang.String)__typeMapper.readString(__in, Region_Manager__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Region_Manager__r__typeInfo)) {
      setRegion_Manager__r((com.sforce.soap.enterprise.sobject.User)__typeMapper.readObject(__in, Region_Manager__r__typeInfo, com.sforce.soap.enterprise.sobject.User.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, States__c__typeInfo)) {
      setStates__c((java.lang.String)__typeMapper.readString(__in, States__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Region_Manager__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Region_Manager__c)+"'\n");
    sb.append(" Region_Manager__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Region_Manager__r)+"'\n");
    sb.append(" States__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(States__c)+"'\n");

 ...
 */
public class CallEmAll__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public CallEmAll__c() {
  ...
  /**
   * element  : API_Endpoint__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo API_Endpoint__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","API_Endpoint__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean API_Endpoint__c__is_set = false;

  private java.lang.String API_Endpoint__c;

  public java.lang.String getAPI_Endpoint__c() {
    return API_Endpoint__c;
  }

  

  public void setAPI_Endpoint__c(java.lang.String API_Endpoint__c) {
    this.API_Endpoint__c = API_Endpoint__c;
    API_Endpoint__c__is_set = true;
  }
  ...
  /**
   * element  : Pin__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Pin__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Pin__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Pin__c__is_set = false;

  private java.lang.String Pin__c;

  public java.lang.String getPin__c() {
    return Pin__c;
  }

  

  public void setPin__c(java.lang.String Pin__c) {
    this.Pin__c = Pin__c;
    Pin__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "CallEmAll__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeString(__out, API_Endpoint__c__typeInfo, API_Endpoint__c, API_Endpoint__c__is_set);
    ...
    __typeMapper.writeString(__out, Pin__c__typeInfo, Pin__c, Pin__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, API_Endpoint__c__typeInfo)) {
      setAPI_Endpoint__c((java.lang.String)__typeMapper.readString(__in, API_Endpoint__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Pin__c__typeInfo)) {
      setPin__c((java.lang.String)__typeMapper.readString(__in, Pin__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[CallEmAll__c ");
    sb.append(super.toString());
    sb.append(" API_Endpoint__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(API_Endpoint__c)+"'\n");
    ...
    sb.append(" Pin__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Pin__c)+"'\n");

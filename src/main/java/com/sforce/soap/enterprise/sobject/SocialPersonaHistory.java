 ...
 */
public class SocialPersonaHistory extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : SocialPersona of type {urn:sobject.enterprise.soap.sforce.com}SocialPersona
   * java type: com.sforce.soap.enterprise.sobject.SocialPersona
   */
  private static final com.sforce.ws.bind.TypeInfo SocialPersona__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","SocialPersona","urn:sobject.enterprise.soap.sforce.com","SocialPersona",0,1,true);

  private boolean SocialPersona__is_set = false;
  ...
  public void setSocialPersona(com.sforce.soap.enterprise.sobject.SocialPersona SocialPersona) {
    ...
    SocialPersona__is_set = true;
  }
  
  /**
   * element  : SocialPersonaId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo SocialPersonaId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","SocialPersonaId","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean SocialPersonaId__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "SocialPersonaHistory");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, SocialPersona__typeInfo, SocialPersona, SocialPersona__is_set);
    __typeMapper.writeString(__out, SocialPersonaId__typeInfo, SocialPersonaId, SocialPersonaId__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, SocialPersona__typeInfo)) {
      setSocialPersona((com.sforce.soap.enterprise.sobject.SocialPersona)__typeMapper.readObject(__in, SocialPersona__typeInfo, com.sforce.soap.enterprise.sobject.SocialPersona.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, SocialPersonaId__typeInfo)) {
      setSocialPersonaId((java.lang.String)__typeMapper.readString(__in, SocialPersonaId__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[SocialPersonaHistory ");
    ...
    sb.append(" SocialPersona=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SocialPersona)+"'\n");
    sb.append(" SocialPersonaId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SocialPersonaId)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
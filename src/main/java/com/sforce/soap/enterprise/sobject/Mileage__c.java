 ...
 */
public class Mileage__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Mileage__c() {
  ...
  /**
   * element  : Date_Miles_Incurred__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_Miles_Incurred__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_Miles_Incurred__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Date_Miles_Incurred__c__is_set = false;

  private java.util.Calendar Date_Miles_Incurred__c;

  public java.util.Calendar getDate_Miles_Incurred__c() {
    return Date_Miles_Incurred__c;
  }

  

  public void setDate_Miles_Incurred__c(java.util.Calendar Date_Miles_Incurred__c) {
    this.Date_Miles_Incurred__c = Date_Miles_Incurred__c;
    Date_Miles_Incurred__c__is_set = true;
  }
  ...
  /**
   * element  : Miles__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Miles__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Miles__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Miles__c__is_set = false;

  private java.lang.Double Miles__c;

  public java.lang.Double getMiles__c() {
    return Miles__c;
  }

  

  public void setMiles__c(java.lang.Double Miles__c) {
    this.Miles__c = Miles__c;
    Miles__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Mileage__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Date_Miles_Incurred__c__typeInfo, Date_Miles_Incurred__c, Date_Miles_Incurred__c__is_set);
    ...
    __typeMapper.writeObject(__out, Miles__c__typeInfo, Miles__c, Miles__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_Miles_Incurred__c__typeInfo)) {
      setDate_Miles_Incurred__c((java.util.Calendar)__typeMapper.readObject(__in, Date_Miles_Incurred__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Miles__c__typeInfo)) {
      setMiles__c((java.lang.Double)__typeMapper.readObject(__in, Miles__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Date_Miles_Incurred__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_Miles_Incurred__c)+"'\n");
    ...
    sb.append(" Miles__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Miles__c)+"'\n");
    sb.append(" Name=");

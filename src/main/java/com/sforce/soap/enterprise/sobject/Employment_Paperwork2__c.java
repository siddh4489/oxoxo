 ...
 */
public class Employment_Paperwork2__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Employment_Paperwork2__c() {
  }
  ...
  /**
   * element  : AttachmentId__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo AttachmentId__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AttachmentId__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean AttachmentId__c__is_set = false;

  private java.lang.String AttachmentId__c;

  public java.lang.String getAttachmentId__c() {
    return AttachmentId__c;
  }

  

  public void setAttachmentId__c(java.lang.String AttachmentId__c) {
    this.AttachmentId__c = AttachmentId__c;
    AttachmentId__c__is_set = true;
  }
  ...
  /**
   * element  : Document_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Document_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Document_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Document_Type__c__is_set = false;

  private java.lang.String Document_Type__c;

  public java.lang.String getDocument_Type__c() {
    return Document_Type__c;
  }

  

  public void setDocument_Type__c(java.lang.String Document_Type__c) {
    this.Document_Type__c = Document_Type__c;
    Document_Type__c__is_set = true;
  }
  ...
  /**
   * element  : Submitted_Date__c of type {http://www.w3.org/2001/XMLSchema}dateTime
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Submitted_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Submitted_Date__c","http://www.w3.org/2001/XMLSchema","dateTime",0,1,true);

  private boolean Submitted_Date__c__is_set = false;

  private java.util.Calendar Submitted_Date__c;

  public java.util.Calendar getSubmitted_Date__c() {
    return Submitted_Date__c;
  }

  

  public void setSubmitted_Date__c(java.util.Calendar Submitted_Date__c) {
    this.Submitted_Date__c = Submitted_Date__c;
    Submitted_Date__c__is_set = true;
  }
  ...
  /**
   * element  : View_Attachment__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo View_Attachment__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","View_Attachment__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean View_Attachment__c__is_set = false;

  private java.lang.String View_Attachment__c;

  public java.lang.String getView_Attachment__c() {
    return View_Attachment__c;
  }

  

  public void setView_Attachment__c(java.lang.String View_Attachment__c) {
    this.View_Attachment__c = View_Attachment__c;
    View_Attachment__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Employment_Paperwork2__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, AttachmentId__c__typeInfo, AttachmentId__c, AttachmentId__c__is_set);
    ...
    __typeMapper.writeString(__out, Document_Type__c__typeInfo, Document_Type__c, Document_Type__c__is_set);
    ...
    __typeMapper.writeObject(__out, Submitted_Date__c__typeInfo, Submitted_Date__c, Submitted_Date__c__is_set);
    ...
    __typeMapper.writeString(__out, View_Attachment__c__typeInfo, View_Attachment__c, View_Attachment__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, AttachmentId__c__typeInfo)) {
      setAttachmentId__c((java.lang.String)__typeMapper.readString(__in, AttachmentId__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Document_Type__c__typeInfo)) {
      setDocument_Type__c((java.lang.String)__typeMapper.readString(__in, Document_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Submitted_Date__c__typeInfo)) {
      setSubmitted_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Submitted_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, View_Attachment__c__typeInfo)) {
      setView_Attachment__c((java.lang.String)__typeMapper.readString(__in, View_Attachment__c__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Employment_Paperwork2__c ");
    ...
    sb.append(" AttachmentId__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AttachmentId__c)+"'\n");
    ...
    sb.append(" Document_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Document_Type__c)+"'\n");
    ...
    sb.append(" Submitted_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Submitted_Date__c)+"'\n");
    ...
    sb.append(" View_Attachment__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(View_Attachment__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
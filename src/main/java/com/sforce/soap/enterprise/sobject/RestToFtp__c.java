 ...
 */
public class RestToFtp__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public RestToFtp__c() {
  ...
  /**
   * element  : Ftp_Host_Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Ftp_Host_Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Ftp_Host_Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Ftp_Host_Name__c__is_set = false;

  private java.lang.String Ftp_Host_Name__c;

  public java.lang.String getFtp_Host_Name__c() {
    return Ftp_Host_Name__c;
  }

  

  public void setFtp_Host_Name__c(java.lang.String Ftp_Host_Name__c) {
    this.Ftp_Host_Name__c = Ftp_Host_Name__c;
    Ftp_Host_Name__c__is_set = true;
  }
  
  /**
   * element  : Ftp_Password__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Ftp_Password__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Ftp_Password__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Ftp_Password__c__is_set = false;
  ...
  public void setFtp_Password__c(java.lang.String Ftp_Password__c) {
    ...
    Ftp_Password__c__is_set = true;
  }
  
  /**
   * element  : Ftp_Port__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Ftp_Port__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Ftp_Port__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Ftp_Port__c__is_set = false;

  private java.lang.Double Ftp_Port__c;

  public java.lang.Double getFtp_Port__c() {
    return Ftp_Port__c;
  }

  

  public void setFtp_Port__c(java.lang.Double Ftp_Port__c) {
    this.Ftp_Port__c = Ftp_Port__c;
    Ftp_Port__c__is_set = true;
  }
  
  /**
   * element  : Ftp_User_Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Ftp_User_Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Ftp_User_Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Ftp_User_Name__c__is_set = false;

  private java.lang.String Ftp_User_Name__c;

  public java.lang.String getFtp_User_Name__c() {
    return Ftp_User_Name__c;
  }

  

  public void setFtp_User_Name__c(java.lang.String Ftp_User_Name__c) {
    this.Ftp_User_Name__c = Ftp_User_Name__c;
    Ftp_User_Name__c__is_set = true;
  }
  ...
  /**
   * element  : Rest_Endpoint_URL__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Rest_Endpoint_URL__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Rest_Endpoint_URL__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Rest_Endpoint_URL__c__is_set = false;

  private java.lang.String Rest_Endpoint_URL__c;

  public java.lang.String getRest_Endpoint_URL__c() {
    return Rest_Endpoint_URL__c;
  }

  

  public void setRest_Endpoint_URL__c(java.lang.String Rest_Endpoint_URL__c) {
    this.Rest_Endpoint_URL__c = Rest_Endpoint_URL__c;
    Rest_Endpoint_URL__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "RestToFtp__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Ftp_Host_Name__c__typeInfo, Ftp_Host_Name__c, Ftp_Host_Name__c__is_set);
    __typeMapper.writeString(__out, Ftp_Password__c__typeInfo, Ftp_Password__c, Ftp_Password__c__is_set);
    __typeMapper.writeObject(__out, Ftp_Port__c__typeInfo, Ftp_Port__c, Ftp_Port__c__is_set);
    __typeMapper.writeString(__out, Ftp_User_Name__c__typeInfo, Ftp_User_Name__c, Ftp_User_Name__c__is_set);
    ...
    __typeMapper.writeString(__out, Rest_Endpoint_URL__c__typeInfo, Rest_Endpoint_URL__c, Rest_Endpoint_URL__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Ftp_Host_Name__c__typeInfo)) {
      setFtp_Host_Name__c((java.lang.String)__typeMapper.readString(__in, Ftp_Host_Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Ftp_Password__c__typeInfo)) {
      setFtp_Password__c((java.lang.String)__typeMapper.readString(__in, Ftp_Password__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Ftp_Port__c__typeInfo)) {
      setFtp_Port__c((java.lang.Double)__typeMapper.readObject(__in, Ftp_Port__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Ftp_User_Name__c__typeInfo)) {
      setFtp_User_Name__c((java.lang.String)__typeMapper.readString(__in, Ftp_User_Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Rest_Endpoint_URL__c__typeInfo)) {
      setRest_Endpoint_URL__c((java.lang.String)__typeMapper.readString(__in, Rest_Endpoint_URL__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Ftp_Host_Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Ftp_Host_Name__c)+"'\n");
    sb.append(" Ftp_Password__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Ftp_Password__c)+"'\n");
    sb.append(" Ftp_Port__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Ftp_Port__c)+"'\n");
    sb.append(" Ftp_User_Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Ftp_User_Name__c)+"'\n");
    sb.append(" IsDeleted=");
    ...
    sb.append(" Rest_Endpoint_URL__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Rest_Endpoint_URL__c)+"'\n");

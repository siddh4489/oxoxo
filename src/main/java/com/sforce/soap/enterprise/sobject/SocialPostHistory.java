 ...
 */
public class SocialPostHistory extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : SocialPost of type {urn:sobject.enterprise.soap.sforce.com}SocialPost
   * java type: com.sforce.soap.enterprise.sobject.SocialPost
   */
  private static final com.sforce.ws.bind.TypeInfo SocialPost__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","SocialPost","urn:sobject.enterprise.soap.sforce.com","SocialPost",0,1,true);

  private boolean SocialPost__is_set = false;
  ...
  public void setSocialPost(com.sforce.soap.enterprise.sobject.SocialPost SocialPost) {
    ...
    SocialPost__is_set = true;
  }
  
  /**
   * element  : SocialPostId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo SocialPostId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","SocialPostId","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean SocialPostId__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "SocialPostHistory");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, SocialPost__typeInfo, SocialPost, SocialPost__is_set);
    __typeMapper.writeString(__out, SocialPostId__typeInfo, SocialPostId, SocialPostId__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, SocialPost__typeInfo)) {
      setSocialPost((com.sforce.soap.enterprise.sobject.SocialPost)__typeMapper.readObject(__in, SocialPost__typeInfo, com.sforce.soap.enterprise.sobject.SocialPost.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, SocialPostId__typeInfo)) {
      setSocialPostId((java.lang.String)__typeMapper.readString(__in, SocialPostId__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[SocialPostHistory ");
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SocialPost)+"'\n");
    sb.append(" SocialPostId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(SocialPostId)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
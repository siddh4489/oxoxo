 ...
 */
public class EventFeed extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public EventFeed() {
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}Event
   * java type: com.sforce.soap.enterprise.sobject.Event
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","Event",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "EventFeed");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.Event)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.Event.class));
    }
    __in.peekTag();

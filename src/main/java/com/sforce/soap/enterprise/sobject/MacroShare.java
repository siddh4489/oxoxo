 ...
 */
public class MacroShare extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public MacroShare() {
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}Macro
   * java type: com.sforce.soap.enterprise.sobject.Macro
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","Macro",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "MacroShare");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.Macro)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.Macro.class));
    }
    __in.peekTag();

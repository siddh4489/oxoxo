 ...
 */
public class Expense__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Expense__c() {
  ...
  /**
   * element  : Reimbursed__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo Reimbursed__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Reimbursed__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean Reimbursed__c__is_set = false;

  private java.lang.Boolean Reimbursed__c;

  public java.lang.Boolean getReimbursed__c() {
    return Reimbursed__c;
  }

  

  public void setReimbursed__c(java.lang.Boolean Reimbursed__c) {
    this.Reimbursed__c = Reimbursed__c;
    Reimbursed__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Expense__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Reimbursed__c__typeInfo, Reimbursed__c, Reimbursed__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Reimbursed__c__typeInfo)) {
      setReimbursed__c((java.lang.Boolean)__typeMapper.readObject(__in, Reimbursed__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Reimbursed__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Reimbursed__c)+"'\n");

 ...
 */
public class AcumenMerge__Supplier__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public AcumenMerge__Supplier__c() {
  }
    
  
  /**
   * element  : AcumenMerge__Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean AcumenMerge__Name__c__is_set = false;

  private java.lang.String AcumenMerge__Name__c;

  public java.lang.String getAcumenMerge__Name__c() {
    return AcumenMerge__Name__c;
  }

  

  public void setAcumenMerge__Name__c(java.lang.String AcumenMerge__Name__c) {
    this.AcumenMerge__Name__c = AcumenMerge__Name__c;
    AcumenMerge__Name__c__is_set = true;
  }
  
  /**
   * element  : AcumenMerge__RobotSupplier__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__RobotSupplier__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__RobotSupplier__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean AcumenMerge__RobotSupplier__c__is_set = false;

  private java.lang.String AcumenMerge__RobotSupplier__c;

  public java.lang.String getAcumenMerge__RobotSupplier__c() {
    return AcumenMerge__RobotSupplier__c;
  }

  

  public void setAcumenMerge__RobotSupplier__c(java.lang.String AcumenMerge__RobotSupplier__c) {
    this.AcumenMerge__RobotSupplier__c = AcumenMerge__RobotSupplier__c;
    AcumenMerge__RobotSupplier__c__is_set = true;
  }
  
  /**
   * element  : AcumenMerge__RobotSupplier__r of type {urn:sobject.enterprise.soap.sforce.com}AcumenMerge__Robot__c
   * java type: com.sforce.soap.enterprise.sobject.AcumenMerge__Robot__c
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__RobotSupplier__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__RobotSupplier__r","urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Robot__c",0,1,true);

  private boolean AcumenMerge__RobotSupplier__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.AcumenMerge__Robot__c AcumenMerge__RobotSupplier__r;

  public com.sforce.soap.enterprise.sobject.AcumenMerge__Robot__c getAcumenMerge__RobotSupplier__r() {
    return AcumenMerge__RobotSupplier__r;
  }

  

  public void setAcumenMerge__RobotSupplier__r(com.sforce.soap.enterprise.sobject.AcumenMerge__Robot__c AcumenMerge__RobotSupplier__r) {
    this.AcumenMerge__RobotSupplier__r = AcumenMerge__RobotSupplier__r;
    AcumenMerge__RobotSupplier__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "AcumenMerge__Supplier__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeString(__out, AcumenMerge__Name__c__typeInfo, AcumenMerge__Name__c, AcumenMerge__Name__c__is_set);
    __typeMapper.writeString(__out, AcumenMerge__RobotSupplier__c__typeInfo, AcumenMerge__RobotSupplier__c, AcumenMerge__RobotSupplier__c__is_set);
    __typeMapper.writeObject(__out, AcumenMerge__RobotSupplier__r__typeInfo, AcumenMerge__RobotSupplier__r, AcumenMerge__RobotSupplier__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__Name__c__typeInfo)) {
      setAcumenMerge__Name__c((java.lang.String)__typeMapper.readString(__in, AcumenMerge__Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__RobotSupplier__c__typeInfo)) {
      setAcumenMerge__RobotSupplier__c((java.lang.String)__typeMapper.readString(__in, AcumenMerge__RobotSupplier__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__RobotSupplier__r__typeInfo)) {
      setAcumenMerge__RobotSupplier__r((com.sforce.soap.enterprise.sobject.AcumenMerge__Robot__c)__typeMapper.readObject(__in, AcumenMerge__RobotSupplier__r__typeInfo, com.sforce.soap.enterprise.sobject.AcumenMerge__Robot__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[AcumenMerge__Supplier__c ");
    sb.append(super.toString());
    sb.append(" AcumenMerge__Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__Name__c)+"'\n");
    sb.append(" AcumenMerge__RobotSupplier__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__RobotSupplier__c)+"'\n");
    sb.append(" AcumenMerge__RobotSupplier__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__RobotSupplier__r)+"'\n");

 ...
 */
public class Chttrunfollow__UnfollowRuleJob__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Chttrunfollow__UnfollowRuleJob__c() {
  }
  ...
  /**
   * element  : chttrunfollow__DelayRuleJob__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo chttrunfollow__DelayRuleJob__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","chttrunfollow__DelayRuleJob__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean chttrunfollow__DelayRuleJob__c__is_set = false;

  private java.lang.Boolean chttrunfollow__DelayRuleJob__c;

  public java.lang.Boolean getChttrunfollow__DelayRuleJob__c() {
    return chttrunfollow__DelayRuleJob__c;
  }

  

  public void setChttrunfollow__DelayRuleJob__c(java.lang.Boolean chttrunfollow__DelayRuleJob__c) {
    this.chttrunfollow__DelayRuleJob__c = chttrunfollow__DelayRuleJob__c;
    chttrunfollow__DelayRuleJob__c__is_set = true;
  }
  
  /**
   * element  : chttrunfollow__NumFollows__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo chttrunfollow__NumFollows__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","chttrunfollow__NumFollows__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean chttrunfollow__NumFollows__c__is_set = false;

  private java.lang.Double chttrunfollow__NumFollows__c;

  public java.lang.Double getChttrunfollow__NumFollows__c() {
    return chttrunfollow__NumFollows__c;
  }

  

  public void setChttrunfollow__NumFollows__c(java.lang.Double chttrunfollow__NumFollows__c) {
    this.chttrunfollow__NumFollows__c = chttrunfollow__NumFollows__c;
    chttrunfollow__NumFollows__c__is_set = true;
  }
  
  /**
   * element  : chttrunfollow__NumRecords__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo chttrunfollow__NumRecords__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","chttrunfollow__NumRecords__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean chttrunfollow__NumRecords__c__is_set = false;

  private java.lang.Double chttrunfollow__NumRecords__c;

  public java.lang.Double getChttrunfollow__NumRecords__c() {
    return chttrunfollow__NumRecords__c;
  }

  

  public void setChttrunfollow__NumRecords__c(java.lang.Double chttrunfollow__NumRecords__c) {
    this.chttrunfollow__NumRecords__c = chttrunfollow__NumRecords__c;
    chttrunfollow__NumRecords__c__is_set = true;
  }
  
  /**
   * element  : chttrunfollow__NumRules__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo chttrunfollow__NumRules__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","chttrunfollow__NumRules__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean chttrunfollow__NumRules__c__is_set = false;

  private java.lang.Double chttrunfollow__NumRules__c;

  public java.lang.Double getChttrunfollow__NumRules__c() {
    return chttrunfollow__NumRules__c;
  }

  

  public void setChttrunfollow__NumRules__c(java.lang.Double chttrunfollow__NumRules__c) {
    this.chttrunfollow__NumRules__c = chttrunfollow__NumRules__c;
    chttrunfollow__NumRules__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "chttrunfollow__UnfollowRuleJob__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, chttrunfollow__DelayRuleJob__c__typeInfo, chttrunfollow__DelayRuleJob__c, chttrunfollow__DelayRuleJob__c__is_set);
    __typeMapper.writeObject(__out, chttrunfollow__NumFollows__c__typeInfo, chttrunfollow__NumFollows__c, chttrunfollow__NumFollows__c__is_set);
    __typeMapper.writeObject(__out, chttrunfollow__NumRecords__c__typeInfo, chttrunfollow__NumRecords__c, chttrunfollow__NumRecords__c__is_set);
    __typeMapper.writeObject(__out, chttrunfollow__NumRules__c__typeInfo, chttrunfollow__NumRules__c, chttrunfollow__NumRules__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, chttrunfollow__DelayRuleJob__c__typeInfo)) {
      setChttrunfollow__DelayRuleJob__c((java.lang.Boolean)__typeMapper.readObject(__in, chttrunfollow__DelayRuleJob__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, chttrunfollow__NumFollows__c__typeInfo)) {
      setChttrunfollow__NumFollows__c((java.lang.Double)__typeMapper.readObject(__in, chttrunfollow__NumFollows__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, chttrunfollow__NumRecords__c__typeInfo)) {
      setChttrunfollow__NumRecords__c((java.lang.Double)__typeMapper.readObject(__in, chttrunfollow__NumRecords__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, chttrunfollow__NumRules__c__typeInfo)) {
      setChttrunfollow__NumRules__c((java.lang.Double)__typeMapper.readObject(__in, chttrunfollow__NumRules__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Chttrunfollow__UnfollowRuleJob__c ");
    ...
    sb.append(" chttrunfollow__DelayRuleJob__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(chttrunfollow__DelayRuleJob__c)+"'\n");
    sb.append(" chttrunfollow__NumFollows__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(chttrunfollow__NumFollows__c)+"'\n");
    sb.append(" chttrunfollow__NumRecords__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(chttrunfollow__NumRecords__c)+"'\n");
    sb.append(" chttrunfollow__NumRules__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(chttrunfollow__NumRules__c)+"'\n");

 ...
 */
public class TopicLocalization extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public TopicLocalization() {
  }
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}Topic
   * java type: com.sforce.soap.enterprise.sobject.Topic
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","Topic",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "TopicLocalization");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.Topic)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.Topic.class));
    }
    __in.peekTag();

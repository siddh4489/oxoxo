 ...
 */
public class Employee_ID_Auto_Number__Tag extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Employee_ID_Auto_Number__Tag() {
  }
  ...
  /**
   * element  : Item of type {urn:sobject.enterprise.soap.sforce.com}Employee_ID_Auto_Number__c
   * java type: com.sforce.soap.enterprise.sobject.Employee_ID_Auto_Number__c
   */
  private static final com.sforce.ws.bind.TypeInfo Item__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Item","urn:sobject.enterprise.soap.sforce.com","Employee_ID_Auto_Number__c",0,1,true);

  private boolean Item__is_set = false;

  private com.sforce.soap.enterprise.sobject.Employee_ID_Auto_Number__c Item;

  public com.sforce.soap.enterprise.sobject.Employee_ID_Auto_Number__c getItem() {
    return Item;
  }

  

  public void setItem(com.sforce.soap.enterprise.sobject.Employee_ID_Auto_Number__c Item) {
    this.Item = Item;
    Item__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Employee_ID_Auto_Number__Tag");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Item__typeInfo)) {
      setItem((com.sforce.soap.enterprise.sobject.Employee_ID_Auto_Number__c)__typeMapper.readObject(__in, Item__typeInfo, com.sforce.soap.enterprise.sobject.Employee_ID_Auto_Number__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Employee_ID_Auto_Number__Tag ");

 ...
 */
public class Aos__Activity_Optimizer_System__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Aos__Activity_Optimizer_System__c() {
  }
  ...
  /**
   * element  : aos__Activity_Optimizer_Roles__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo aos__Activity_Optimizer_Roles__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","aos__Activity_Optimizer_Roles__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean aos__Activity_Optimizer_Roles__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult aos__Activity_Optimizer_Roles__r;

  public com.sforce.soap.enterprise.QueryResult getAos__Activity_Optimizer_Roles__r() {
    return aos__Activity_Optimizer_Roles__r;
  }

  

  public void setAos__Activity_Optimizer_Roles__r(com.sforce.soap.enterprise.QueryResult aos__Activity_Optimizer_Roles__r) {
    this.aos__Activity_Optimizer_Roles__r = aos__Activity_Optimizer_Roles__r;
    aos__Activity_Optimizer_Roles__r__is_set = true;
  }
  
  /**
   * element  : aos__Description__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo aos__Description__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","aos__Description__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean aos__Description__c__is_set = false;

  private java.lang.String aos__Description__c;

  public java.lang.String getAos__Description__c() {
    return aos__Description__c;
  }

  

  public void setAos__Description__c(java.lang.String aos__Description__c) {
    this.aos__Description__c = aos__Description__c;
    aos__Description__c__is_set = true;
  }
  
  /**
   * element  : aos__Optimized_Activities__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo aos__Optimized_Activities__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","aos__Optimized_Activities__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean aos__Optimized_Activities__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult aos__Optimized_Activities__r;

  public com.sforce.soap.enterprise.QueryResult getAos__Optimized_Activities__r() {
    return aos__Optimized_Activities__r;
  }

  

  public void setAos__Optimized_Activities__r(com.sforce.soap.enterprise.QueryResult aos__Optimized_Activities__r) {
    this.aos__Optimized_Activities__r = aos__Optimized_Activities__r;
    aos__Optimized_Activities__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "aos__Activity_Optimizer_System__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, aos__Activity_Optimizer_Roles__r__typeInfo, aos__Activity_Optimizer_Roles__r, aos__Activity_Optimizer_Roles__r__is_set);
    __typeMapper.writeString(__out, aos__Description__c__typeInfo, aos__Description__c, aos__Description__c__is_set);
    __typeMapper.writeObject(__out, aos__Optimized_Activities__r__typeInfo, aos__Optimized_Activities__r, aos__Optimized_Activities__r__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, aos__Activity_Optimizer_Roles__r__typeInfo)) {
      setAos__Activity_Optimizer_Roles__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, aos__Activity_Optimizer_Roles__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, aos__Description__c__typeInfo)) {
      setAos__Description__c((java.lang.String)__typeMapper.readString(__in, aos__Description__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, aos__Optimized_Activities__r__typeInfo)) {
      setAos__Optimized_Activities__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, aos__Optimized_Activities__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
  }
  ...
  public String toString() {
    ...
    sb.append(" aos__Activity_Optimizer_Roles__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(aos__Activity_Optimizer_Roles__r)+"'\n");
    sb.append(" aos__Description__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(aos__Description__c)+"'\n");
    sb.append(" aos__Optimized_Activities__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(aos__Optimized_Activities__r)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
 ...
 */
public class Background_Check__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Background_Check__c() {
  }
  ...
  /**
   * element  : Cost_of_Check__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Cost_of_Check__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Cost_of_Check__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Cost_of_Check__c__is_set = false;

  private java.lang.Double Cost_of_Check__c;

  public java.lang.Double getCost_of_Check__c() {
    return Cost_of_Check__c;
  }

  

  public void setCost_of_Check__c(java.lang.Double Cost_of_Check__c) {
    this.Cost_of_Check__c = Cost_of_Check__c;
    Cost_of_Check__c__is_set = true;
  }
  ...
  /**
   * element  : Date_of_Background_Check__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_of_Background_Check__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_of_Background_Check__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Date_of_Background_Check__c__is_set = false;

  private java.util.Calendar Date_of_Background_Check__c;

  public java.util.Calendar getDate_of_Background_Check__c() {
    return Date_of_Background_Check__c;
  }

  

  public void setDate_of_Background_Check__c(java.util.Calendar Date_of_Background_Check__c) {
    this.Date_of_Background_Check__c = Date_of_Background_Check__c;
    Date_of_Background_Check__c__is_set = true;
  }
  ...
  /**
   * element  : Notes_or_Instructions__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Notes_or_Instructions__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Notes_or_Instructions__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Notes_or_Instructions__c__is_set = false;

  private java.lang.String Notes_or_Instructions__c;

  public java.lang.String getNotes_or_Instructions__c() {
    return Notes_or_Instructions__c;
  }

  

  public void setNotes_or_Instructions__c(java.lang.String Notes_or_Instructions__c) {
    this.Notes_or_Instructions__c = Notes_or_Instructions__c;
    Notes_or_Instructions__c__is_set = true;
  }
  ...
  /**
   * element  : VendorOld__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo VendorOld__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","VendorOld__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean VendorOld__c__is_set = false;

  private java.lang.String VendorOld__c;

  public java.lang.String getVendorOld__c() {
    return VendorOld__c;
  }

  

  public void setVendorOld__c(java.lang.String VendorOld__c) {
    this.VendorOld__c = VendorOld__c;
    VendorOld__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Background_Check__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Cost_of_Check__c__typeInfo, Cost_of_Check__c, Cost_of_Check__c__is_set);
    __typeMapper.writeObject(__out, CreatedBy__typeInfo, CreatedBy, CreatedBy__is_set);
    __typeMapper.writeString(__out, CreatedById__typeInfo, CreatedById, CreatedById__is_set);
    __typeMapper.writeObject(__out, CreatedDate__typeInfo, CreatedDate, CreatedDate__is_set);
    __typeMapper.writeObject(__out, DOB__c__typeInfo, DOB__c, DOB__c__is_set);
    __typeMapper.writeObject(__out, Date_of_Background_Check__c__typeInfo, Date_of_Background_Check__c, Date_of_Background_Check__c__is_set);
    ...
    __typeMapper.writeString(__out, Notes_or_Instructions__c__typeInfo, Notes_or_Instructions__c, Notes_or_Instructions__c__is_set);
    ...
    __typeMapper.writeString(__out, VendorOld__c__typeInfo, VendorOld__c, VendorOld__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Cost_of_Check__c__typeInfo)) {
      setCost_of_Check__c((java.lang.Double)__typeMapper.readObject(__in, Cost_of_Check__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_of_Background_Check__c__typeInfo)) {
      setDate_of_Background_Check__c((java.util.Calendar)__typeMapper.readObject(__in, Date_of_Background_Check__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Notes_or_Instructions__c__typeInfo)) {
      setNotes_or_Instructions__c((java.lang.String)__typeMapper.readString(__in, Notes_or_Instructions__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, VendorOld__c__typeInfo)) {
      setVendorOld__c((java.lang.String)__typeMapper.readString(__in, VendorOld__c__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Background_Check__c ");
    ...
    sb.append(" Cost_of_Check__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Cost_of_Check__c)+"'\n");
    sb.append(" CreatedBy=");
    ...
    sb.append(" Date_of_Background_Check__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_of_Background_Check__c)+"'\n");
    ...
    sb.append(" Notes_or_Instructions__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Notes_or_Instructions__c)+"'\n");
    ...
    sb.append(" VendorOld__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(VendorOld__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
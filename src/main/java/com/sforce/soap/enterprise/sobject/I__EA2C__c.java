 ...
 */
public class I__EA2C__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public I__EA2C__c() {
  ...
  /**
   * element  : i__Account__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__Account__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Account__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean i__Account__c__is_set = false;

  private java.lang.String i__Account__c;

  public java.lang.String getI__Account__c() {
    return i__Account__c;
  }

  

  public void setI__Account__c(java.lang.String i__Account__c) {
    this.i__Account__c = i__Account__c;
    i__Account__c__is_set = true;
  }
  
  /**
   * element  : i__Account__r of type {urn:sobject.enterprise.soap.sforce.com}Account
   * java type: com.sforce.soap.enterprise.sobject.Account
   */
  private static final com.sforce.ws.bind.TypeInfo i__Account__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Account__r","urn:sobject.enterprise.soap.sforce.com","Account",0,1,true);

  private boolean i__Account__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Account i__Account__r;

  public com.sforce.soap.enterprise.sobject.Account getI__Account__r() {
    return i__Account__r;
  }

  

  public void setI__Account__r(com.sforce.soap.enterprise.sobject.Account i__Account__r) {
    this.i__Account__r = i__Account__r;
    i__Account__r__is_set = true;
  }
  ...
  /**
   * element  : i__Contact__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo i__Contact__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Contact__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean i__Contact__c__is_set = false;

  private java.lang.String i__Contact__c;

  public java.lang.String getI__Contact__c() {
    return i__Contact__c;
  }

  

  public void setI__Contact__c(java.lang.String i__Contact__c) {
    this.i__Contact__c = i__Contact__c;
    i__Contact__c__is_set = true;
  }
  
  /**
   * element  : i__Contact__r of type {urn:sobject.enterprise.soap.sforce.com}Contact
   * java type: com.sforce.soap.enterprise.sobject.Contact
   */
  private static final com.sforce.ws.bind.TypeInfo i__Contact__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","i__Contact__r","urn:sobject.enterprise.soap.sforce.com","Contact",0,1,true);

  private boolean i__Contact__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Contact i__Contact__r;

  public com.sforce.soap.enterprise.sobject.Contact getI__Contact__r() {
    return i__Contact__r;
  }

  

  public void setI__Contact__r(com.sforce.soap.enterprise.sobject.Contact i__Contact__r) {
    this.i__Contact__r = i__Contact__r;
    i__Contact__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "i__EA2C__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, i__Account__c__typeInfo, i__Account__c, i__Account__c__is_set);
    __typeMapper.writeObject(__out, i__Account__r__typeInfo, i__Account__r, i__Account__r__is_set);
    __typeMapper.writeString(__out, i__BothIds__c__typeInfo, i__BothIds__c, i__BothIds__c__is_set);
    __typeMapper.writeString(__out, i__Contact__c__typeInfo, i__Contact__c, i__Contact__c__is_set);
    __typeMapper.writeObject(__out, i__Contact__r__typeInfo, i__Contact__r, i__Contact__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Account__c__typeInfo)) {
      setI__Account__c((java.lang.String)__typeMapper.readString(__in, i__Account__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Account__r__typeInfo)) {
      setI__Account__r((com.sforce.soap.enterprise.sobject.Account)__typeMapper.readObject(__in, i__Account__r__typeInfo, com.sforce.soap.enterprise.sobject.Account.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Contact__c__typeInfo)) {
      setI__Contact__c((java.lang.String)__typeMapper.readString(__in, i__Contact__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, i__Contact__r__typeInfo)) {
      setI__Contact__r((com.sforce.soap.enterprise.sobject.Contact)__typeMapper.readObject(__in, i__Contact__r__typeInfo, com.sforce.soap.enterprise.sobject.Contact.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" i__Account__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Account__c)+"'\n");
    sb.append(" i__Account__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Account__r)+"'\n");
    sb.append(" i__BothIds__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__BothIds__c)+"'\n");
    sb.append(" i__Contact__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Contact__c)+"'\n");
    sb.append(" i__Contact__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(i__Contact__r)+"'\n");

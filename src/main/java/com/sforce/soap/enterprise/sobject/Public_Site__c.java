 ...
 */
public class Public_Site__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Public_Site__c() {
  }
  ...
  /**
   * element  : Key__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Key__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Key__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Key__c__is_set = false;

  private java.lang.String Key__c;

  public java.lang.String getKey__c() {
    return Key__c;
  }

  

  public void setKey__c(java.lang.String Key__c) {
    this.Key__c = Key__c;
    Key__c__is_set = true;
  }
  ...
  /**
   * element  : Registration_Page_Url__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Registration_Page_Url__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Registration_Page_Url__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Registration_Page_Url__c__is_set = false;

  private java.lang.String Registration_Page_Url__c;

  public java.lang.String getRegistration_Page_Url__c() {
    return Registration_Page_Url__c;
  }

  

  public void setRegistration_Page_Url__c(java.lang.String Registration_Page_Url__c) {
    this.Registration_Page_Url__c = Registration_Page_Url__c;
    Registration_Page_Url__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Public_Site__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Key__c__typeInfo, Key__c, Key__c__is_set);
    ...
    __typeMapper.writeString(__out, Registration_Page_Url__c__typeInfo, Registration_Page_Url__c, Registration_Page_Url__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Key__c__typeInfo)) {
      setKey__c((java.lang.String)__typeMapper.readString(__in, Key__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Registration_Page_Url__c__typeInfo)) {
      setRegistration_Page_Url__c((java.lang.String)__typeMapper.readString(__in, Registration_Page_Url__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Key__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Key__c)+"'\n");
    ...
    sb.append(" Registration_Page_Url__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Registration_Page_Url__c)+"'\n");

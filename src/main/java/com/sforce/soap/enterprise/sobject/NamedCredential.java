 ...
 */
public class NamedCredential extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : CalloutOptionsAllowMergeFieldsInBody of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo CalloutOptionsAllowMergeFieldsInBody__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CalloutOptionsAllowMergeFieldsInBody","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean CalloutOptionsAllowMergeFieldsInBody__is_set = false;
  ...
  public void setCalloutOptionsAllowMergeFieldsInBody(java.lang.Boolean CalloutOptionsAllowMergeFieldsInBody) {
    ...
    CalloutOptionsAllowMergeFieldsInBody__is_set = true;
  }
  
  /**
   * element  : CalloutOptionsAllowMergeFieldsInHeader of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo CalloutOptionsAllowMergeFieldsInHeader__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CalloutOptionsAllowMergeFieldsInHeader","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean CalloutOptionsAllowMergeFieldsInHeader__is_set = false;
  ...
  public void setCalloutOptionsAllowMergeFieldsInHeader(java.lang.Boolean CalloutOptionsAllowMergeFieldsInHeader) {
    ...
    CalloutOptionsAllowMergeFieldsInHeader__is_set = true;
  }
  
  /**
   * element  : CalloutOptionsGenerateAuthorizationHeader of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo CalloutOptionsGenerateAuthorizationHeader__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","CalloutOptionsGenerateAuthorizationHeader","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean CalloutOptionsGenerateAuthorizationHeader__is_set = false;
  ...
  public void setCalloutOptionsGenerateAuthorizationHeader(java.lang.Boolean CalloutOptionsGenerateAuthorizationHeader) {
    ...
    CalloutOptionsGenerateAuthorizationHeader__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "NamedCredential");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeObject(__out, CalloutOptionsAllowMergeFieldsInBody__typeInfo, CalloutOptionsAllowMergeFieldsInBody, CalloutOptionsAllowMergeFieldsInBody__is_set);
    __typeMapper.writeObject(__out, CalloutOptionsAllowMergeFieldsInHeader__typeInfo, CalloutOptionsAllowMergeFieldsInHeader, CalloutOptionsAllowMergeFieldsInHeader__is_set);
    __typeMapper.writeObject(__out, CalloutOptionsGenerateAuthorizationHeader__typeInfo, CalloutOptionsGenerateAuthorizationHeader, CalloutOptionsGenerateAuthorizationHeader__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, CalloutOptionsAllowMergeFieldsInBody__typeInfo)) {
      setCalloutOptionsAllowMergeFieldsInBody((java.lang.Boolean)__typeMapper.readObject(__in, CalloutOptionsAllowMergeFieldsInBody__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, CalloutOptionsAllowMergeFieldsInHeader__typeInfo)) {
      setCalloutOptionsAllowMergeFieldsInHeader((java.lang.Boolean)__typeMapper.readObject(__in, CalloutOptionsAllowMergeFieldsInHeader__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, CalloutOptionsGenerateAuthorizationHeader__typeInfo)) {
      setCalloutOptionsGenerateAuthorizationHeader((java.lang.Boolean)__typeMapper.readObject(__in, CalloutOptionsGenerateAuthorizationHeader__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" CalloutOptionsAllowMergeFieldsInBody=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CalloutOptionsAllowMergeFieldsInBody)+"'\n");
    sb.append(" CalloutOptionsAllowMergeFieldsInHeader=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CalloutOptionsAllowMergeFieldsInHeader)+"'\n");
    sb.append(" CalloutOptionsGenerateAuthorizationHeader=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(CalloutOptionsGenerateAuthorizationHeader)+"'\n");
    sb.append(" CreatedBy=");

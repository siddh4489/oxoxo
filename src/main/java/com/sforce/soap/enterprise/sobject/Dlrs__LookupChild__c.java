 ...
 */
public class Dlrs__LookupChild__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Dlrs__LookupChild__c() {
  }
  ...
  /**
   * element  : dlrs__Amount__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__Amount__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__Amount__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean dlrs__Amount__c__is_set = false;

  private java.lang.Double dlrs__Amount__c;

  public java.lang.Double getDlrs__Amount__c() {
    return dlrs__Amount__c;
  }

  

  public void setDlrs__Amount__c(java.lang.Double dlrs__Amount__c) {
    this.dlrs__Amount__c = dlrs__Amount__c;
    dlrs__Amount__c__is_set = true;
  }
  
  /**
   * element  : dlrs__Color__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__Color__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__Color__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean dlrs__Color__c__is_set = false;

  private java.lang.String dlrs__Color__c;

  public java.lang.String getDlrs__Color__c() {
    return dlrs__Color__c;
  }

  

  public void setDlrs__Color__c(java.lang.String dlrs__Color__c) {
    this.dlrs__Color__c = dlrs__Color__c;
    dlrs__Color__c__is_set = true;
  }
  
  /**
   * element  : dlrs__LookupParent__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__LookupParent__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__LookupParent__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean dlrs__LookupParent__c__is_set = false;

  private java.lang.String dlrs__LookupParent__c;

  public java.lang.String getDlrs__LookupParent__c() {
    return dlrs__LookupParent__c;
  }

  

  public void setDlrs__LookupParent__c(java.lang.String dlrs__LookupParent__c) {
    this.dlrs__LookupParent__c = dlrs__LookupParent__c;
    dlrs__LookupParent__c__is_set = true;
  }
  
  /**
   * element  : dlrs__LookupParent__r of type {urn:sobject.enterprise.soap.sforce.com}dlrs__LookupParent__c
   * java type: com.sforce.soap.enterprise.sobject.Dlrs__LookupParent__c
   */
  private static final com.sforce.ws.bind.TypeInfo dlrs__LookupParent__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","dlrs__LookupParent__r","urn:sobject.enterprise.soap.sforce.com","dlrs__LookupParent__c",0,1,true);

  private boolean dlrs__LookupParent__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Dlrs__LookupParent__c dlrs__LookupParent__r;

  public com.sforce.soap.enterprise.sobject.Dlrs__LookupParent__c getDlrs__LookupParent__r() {
    return dlrs__LookupParent__r;
  }

  

  public void setDlrs__LookupParent__r(com.sforce.soap.enterprise.sobject.Dlrs__LookupParent__c dlrs__LookupParent__r) {
    this.dlrs__LookupParent__r = dlrs__LookupParent__r;
    dlrs__LookupParent__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "dlrs__LookupChild__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, dlrs__Amount__c__typeInfo, dlrs__Amount__c, dlrs__Amount__c__is_set);
    __typeMapper.writeString(__out, dlrs__Color__c__typeInfo, dlrs__Color__c, dlrs__Color__c__is_set);
    __typeMapper.writeString(__out, dlrs__LookupParent__c__typeInfo, dlrs__LookupParent__c, dlrs__LookupParent__c__is_set);
    __typeMapper.writeObject(__out, dlrs__LookupParent__r__typeInfo, dlrs__LookupParent__r, dlrs__LookupParent__r__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__Amount__c__typeInfo)) {
      setDlrs__Amount__c((java.lang.Double)__typeMapper.readObject(__in, dlrs__Amount__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__Color__c__typeInfo)) {
      setDlrs__Color__c((java.lang.String)__typeMapper.readString(__in, dlrs__Color__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__LookupParent__c__typeInfo)) {
      setDlrs__LookupParent__c((java.lang.String)__typeMapper.readString(__in, dlrs__LookupParent__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, dlrs__LookupParent__r__typeInfo)) {
      setDlrs__LookupParent__r((com.sforce.soap.enterprise.sobject.Dlrs__LookupParent__c)__typeMapper.readObject(__in, dlrs__LookupParent__r__typeInfo, com.sforce.soap.enterprise.sobject.Dlrs__LookupParent__c.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Dlrs__LookupChild__c ");
    ...
    sb.append(" dlrs__Amount__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__Amount__c)+"'\n");
    sb.append(" dlrs__Color__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__Color__c)+"'\n");
    sb.append(" dlrs__LookupParent__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__LookupParent__c)+"'\n");
    sb.append(" dlrs__LookupParent__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(dlrs__LookupParent__r)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
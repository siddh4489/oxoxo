 ...
 */
public class Training__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Training__c() {
  ...
  /**
   * element  : Training_Began__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Training_Began__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Training_Began__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Training_Began__c__is_set = false;

  private java.util.Calendar Training_Began__c;

  public java.util.Calendar getTraining_Began__c() {
    return Training_Began__c;
  }

  

  public void setTraining_Began__c(java.util.Calendar Training_Began__c) {
    this.Training_Began__c = Training_Began__c;
    Training_Began__c__is_set = true;
  }
  
  /**
   * element  : Training_Concluded__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Training_Concluded__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Training_Concluded__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Training_Concluded__c__is_set = false;

  private java.util.Calendar Training_Concluded__c;

  public java.util.Calendar getTraining_Concluded__c() {
    return Training_Concluded__c;
  }

  

  public void setTraining_Concluded__c(java.util.Calendar Training_Concluded__c) {
    this.Training_Concluded__c = Training_Concluded__c;
    Training_Concluded__c__is_set = true;
  }
  
  /**
   * element  : Training_Location__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Training_Location__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Training_Location__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Training_Location__c__is_set = false;

  private java.lang.String Training_Location__c;

  public java.lang.String getTraining_Location__c() {
    return Training_Location__c;
  }

  

  public void setTraining_Location__c(java.lang.String Training_Location__c) {
    this.Training_Location__c = Training_Location__c;
    Training_Location__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Training__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Training_Began__c__typeInfo, Training_Began__c, Training_Began__c__is_set);
    __typeMapper.writeObject(__out, Training_Concluded__c__typeInfo, Training_Concluded__c, Training_Concluded__c__is_set);
    __typeMapper.writeString(__out, Training_Location__c__typeInfo, Training_Location__c, Training_Location__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Training_Began__c__typeInfo)) {
      setTraining_Began__c((java.util.Calendar)__typeMapper.readObject(__in, Training_Began__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Training_Concluded__c__typeInfo)) {
      setTraining_Concluded__c((java.util.Calendar)__typeMapper.readObject(__in, Training_Concluded__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Training_Location__c__typeInfo)) {
      setTraining_Location__c((java.lang.String)__typeMapper.readString(__in, Training_Location__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Training_Began__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Training_Began__c)+"'\n");
    sb.append(" Training_Concluded__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Training_Concluded__c)+"'\n");
    sb.append(" Training_Location__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Training_Location__c)+"'\n");

 ...
 */
public class Trade_Certification__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Trade_Certification__c() {
  }
  ...
  /**
   * element  : Issued_By_Required__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo Issued_By_Required__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Issued_By_Required__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean Issued_By_Required__c__is_set = false;

  private java.lang.Boolean Issued_By_Required__c;

  public java.lang.Boolean getIssued_By_Required__c() {
    return Issued_By_Required__c;
  }

  

  public void setIssued_By_Required__c(java.lang.Boolean Issued_By_Required__c) {
    this.Issued_By_Required__c = Issued_By_Required__c;
    Issued_By_Required__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Trade_Certification__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Issued_By_Required__c__typeInfo, Issued_By_Required__c, Issued_By_Required__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Issued_By_Required__c__typeInfo)) {
      setIssued_By_Required__c((java.lang.Boolean)__typeMapper.readObject(__in, Issued_By_Required__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Issued_By_Required__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Issued_By_Required__c)+"'\n");

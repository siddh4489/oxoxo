 ...
 */
public class Almond__Training_Plan_Achievement__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__Training_Plan_Achievement__c() {
  }
  ...
  /**
   * element  : almond__Main_Achievement__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Main_Achievement__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Main_Achievement__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean almond__Main_Achievement__c__is_set = false;

  private java.lang.Boolean almond__Main_Achievement__c;

  public java.lang.Boolean getAlmond__Main_Achievement__c() {
    return almond__Main_Achievement__c;
  }

  

  public void setAlmond__Main_Achievement__c(java.lang.Boolean almond__Main_Achievement__c) {
    this.almond__Main_Achievement__c = almond__Main_Achievement__c;
    almond__Main_Achievement__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__Training_Plan_Achievement__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, almond__Main_Achievement__c__typeInfo, almond__Main_Achievement__c, almond__Main_Achievement__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Main_Achievement__c__typeInfo)) {
      setAlmond__Main_Achievement__c((java.lang.Boolean)__typeMapper.readObject(__in, almond__Main_Achievement__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" almond__Main_Achievement__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Main_Achievement__c)+"'\n");

 ...
 */
public class PlatformCachePartition extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  private static final com.sforce.ws.bind.TypeInfo IsDefaultPartition__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","IsDefaultPartition","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);
  ...
  /**
   * element  : PlatforCachePartitionTypes of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo PlatforCachePartitionTypes__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","PlatforCachePartitionTypes","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "PlatformCachePartition");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, IsDefaultPartition__typeInfo, IsDefaultPartition, IsDefaultPartition__is_set);
    ...
    __typeMapper.writeObject(__out, PlatforCachePartitionTypes__typeInfo, PlatforCachePartitionTypes, PlatforCachePartitionTypes__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, IsDefaultPartition__typeInfo)) {
      setIsDefaultPartition((java.lang.Boolean)__typeMapper.readObject(__in, IsDefaultPartition__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, PlatforCachePartitionTypes__typeInfo)) {
      setPlatforCachePartitionTypes((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, PlatforCachePartitionTypes__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" IsDefaultPartition=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(IsDefaultPartition)+"'\n");
    sb.append(" IsDeleted=");
    ...
    sb.append(" PlatforCachePartitionTypes=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(PlatforCachePartitionTypes)+"'\n");

 ...
 */
public class NoteAndAttachment extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : IsNote of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo IsNote__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","IsNote","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean IsNote__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "NoteAndAttachment");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, IsNote__typeInfo, IsNote, IsNote__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, IsNote__typeInfo)) {
      setIsNote((java.lang.Boolean)__typeMapper.readObject(__in, IsNote__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" IsNote=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(IsNote)+"'\n");
    sb.append(" IsPrivate=");

...
public class UserListViewCriterion extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  private static final com.sforce.ws.bind.TypeInfo ColumnName__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ColumnName","http://www.w3.org/2001/XMLSchema","string",0,1,true);
   ...
   */
  private static final com.sforce.ws.bind.TypeInfo UserListView__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","UserListView","urn:sobject.enterprise.soap.sforce.com","UserListView",0,1,true);
   ...
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo UserListViewId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","UserListViewId","urn:enterprise.soap.sforce.com","ID",0,1,true);
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, UserListView__typeInfo, UserListView, UserListView__is_set);
    __typeMapper.writeString(__out, UserListViewId__typeInfo, UserListViewId, UserListViewId__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, ColumnName__typeInfo)) {
      setColumnName((java.lang.String)__typeMapper.readString(__in, ColumnName__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, UserListView__typeInfo)) {
      setUserListView((com.sforce.soap.enterprise.sobject.UserListView)__typeMapper.readObject(__in, UserListView__typeInfo, com.sforce.soap.enterprise.sobject.UserListView.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, UserListViewId__typeInfo)) {
      setUserListViewId((java.lang.String)__typeMapper.readString(__in, UserListViewId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ColumnName)+"'\n");
    sb.append(" CreatedBy=");
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(UserListView)+"'\n");
    sb.append(" UserListViewId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(UserListViewId)+"'\n");
    sb.append(" Value=");

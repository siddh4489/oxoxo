 ...
 */
public class Invoice_Payment__History extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Invoice_Payment__History() {
  }
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}Invoice_Payment__c
   * java type: com.sforce.soap.enterprise.sobject.Invoice_Payment__c
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","Invoice_Payment__c",0,1,true);

  private boolean Parent__is_set = false;

  private com.sforce.soap.enterprise.sobject.Invoice_Payment__c Parent;

  public com.sforce.soap.enterprise.sobject.Invoice_Payment__c getParent() {
    return Parent;
  }

  

  public void setParent(com.sforce.soap.enterprise.sobject.Invoice_Payment__c Parent) {
    this.Parent = Parent;
    Parent__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Invoice_Payment__History");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.Invoice_Payment__c)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.Invoice_Payment__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Invoice_Payment__History ");

 ...
 */
public class DuplicateRecordItem extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : DuplicateRecordSet of type {urn:sobject.enterprise.soap.sforce.com}DuplicateRecordSet
   * java type: com.sforce.soap.enterprise.sobject.DuplicateRecordSet
   */
  private static final com.sforce.ws.bind.TypeInfo DuplicateRecordSet__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSet","urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSet",0,1,true);

  private boolean DuplicateRecordSet__is_set = false;
  ...
  public void setDuplicateRecordSet(com.sforce.soap.enterprise.sobject.DuplicateRecordSet DuplicateRecordSet) {
    ...
    DuplicateRecordSet__is_set = true;
  }
  
  /**
   * element  : DuplicateRecordSetId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo DuplicateRecordSetId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","DuplicateRecordSetId","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean DuplicateRecordSetId__is_set = false;
  ...
  public void setDuplicateRecordSetId(java.lang.String DuplicateRecordSetId) {
    ...
    DuplicateRecordSetId__is_set = true;
  }
  ...
  /**
   * element  : Record of type {urn:sobject.enterprise.soap.sforce.com}Name
   * java type: com.sforce.soap.enterprise.sobject.Name
   */
  private static final com.sforce.ws.bind.TypeInfo Record__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Record","urn:sobject.enterprise.soap.sforce.com","Name",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "DuplicateRecordItem");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, DuplicateRecordSet__typeInfo, DuplicateRecordSet, DuplicateRecordSet__is_set);
    __typeMapper.writeString(__out, DuplicateRecordSetId__typeInfo, DuplicateRecordSetId, DuplicateRecordSetId__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, DuplicateRecordSet__typeInfo)) {
      setDuplicateRecordSet((com.sforce.soap.enterprise.sobject.DuplicateRecordSet)__typeMapper.readObject(__in, DuplicateRecordSet__typeInfo, com.sforce.soap.enterprise.sobject.DuplicateRecordSet.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, DuplicateRecordSetId__typeInfo)) {
      setDuplicateRecordSetId((java.lang.String)__typeMapper.readString(__in, DuplicateRecordSetId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Record__typeInfo)) {
      setRecord((com.sforce.soap.enterprise.sobject.Name)__typeMapper.readObject(__in, Record__typeInfo, com.sforce.soap.enterprise.sobject.Name.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(DuplicateRecordSet)+"'\n");
    sb.append(" DuplicateRecordSetId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(DuplicateRecordSetId)+"'\n");
    sb.append(" IsDeleted=");

 ...
 */
public class AccountFeed extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public AccountFeed() {
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "AccountFeed");

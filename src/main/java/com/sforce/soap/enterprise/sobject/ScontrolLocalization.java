 ...
 */
public class ScontrolLocalization extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public ScontrolLocalization() {
  }
  ...
  /**
   * element  : Scontrol of type {urn:sobject.enterprise.soap.sforce.com}Scontrol
   * java type: com.sforce.soap.enterprise.sobject.Scontrol
   */
  private static final com.sforce.ws.bind.TypeInfo Scontrol__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Scontrol","urn:sobject.enterprise.soap.sforce.com","Scontrol",0,1,true);

  private boolean Scontrol__is_set = false;

  private com.sforce.soap.enterprise.sobject.Scontrol Scontrol;

  public com.sforce.soap.enterprise.sobject.Scontrol getScontrol() {
    return Scontrol;
  }

  

  public void setScontrol(com.sforce.soap.enterprise.sobject.Scontrol Scontrol) {
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "ScontrolLocalization");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Scontrol__typeInfo, Scontrol, Scontrol__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Scontrol__typeInfo)) {
      setScontrol((com.sforce.soap.enterprise.sobject.Scontrol)__typeMapper.readObject(__in, Scontrol__typeInfo, com.sforce.soap.enterprise.sobject.Scontrol.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[ScontrolLocalization ");
    ...
    sb.append(" Scontrol=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Scontrol)+"'\n");

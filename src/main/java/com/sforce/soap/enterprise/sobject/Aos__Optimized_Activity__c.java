 ...
 */
public class Aos__Optimized_Activity__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Aos__Optimized_Activity__c() {
  }
  ...
  /**
   * element  : aos__Ignore_Time__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo aos__Ignore_Time__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","aos__Ignore_Time__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean aos__Ignore_Time__c__is_set = false;

  private java.lang.Boolean aos__Ignore_Time__c;

  public java.lang.Boolean getAos__Ignore_Time__c() {
    return aos__Ignore_Time__c;
  }

  

  public void setAos__Ignore_Time__c(java.lang.Boolean aos__Ignore_Time__c) {
    this.aos__Ignore_Time__c = aos__Ignore_Time__c;
    aos__Ignore_Time__c__is_set = true;
  }
  
  /**
   * element  : aos__Points_Per_Hour__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo aos__Points_Per_Hour__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","aos__Points_Per_Hour__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean aos__Points_Per_Hour__c__is_set = false;

  private java.lang.Double aos__Points_Per_Hour__c;

  public java.lang.Double getAos__Points_Per_Hour__c() {
    return aos__Points_Per_Hour__c;
  }

  

  public void setAos__Points_Per_Hour__c(java.lang.Double aos__Points_Per_Hour__c) {
    this.aos__Points_Per_Hour__c = aos__Points_Per_Hour__c;
    aos__Points_Per_Hour__c__is_set = true;
  }
  
  /**
   * element  : aos__Points_Per_Minute__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo aos__Points_Per_Minute__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","aos__Points_Per_Minute__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean aos__Points_Per_Minute__c__is_set = false;

  private java.lang.Double aos__Points_Per_Minute__c;

  public java.lang.Double getAos__Points_Per_Minute__c() {
    return aos__Points_Per_Minute__c;
  }

  

  public void setAos__Points_Per_Minute__c(java.lang.Double aos__Points_Per_Minute__c) {
    this.aos__Points_Per_Minute__c = aos__Points_Per_Minute__c;
    aos__Points_Per_Minute__c__is_set = true;
  }
  
  /**
   * element  : aos__Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo aos__Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","aos__Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean aos__Type__c__is_set = false;

  private java.lang.String aos__Type__c;

  public java.lang.String getAos__Type__c() {
    return aos__Type__c;
  }

  

  public void setAos__Type__c(java.lang.String aos__Type__c) {
    this.aos__Type__c = aos__Type__c;
    aos__Type__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "aos__Optimized_Activity__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, aos__Ignore_Time__c__typeInfo, aos__Ignore_Time__c, aos__Ignore_Time__c__is_set);
    __typeMapper.writeObject(__out, aos__Points_Per_Hour__c__typeInfo, aos__Points_Per_Hour__c, aos__Points_Per_Hour__c__is_set);
    __typeMapper.writeObject(__out, aos__Points_Per_Minute__c__typeInfo, aos__Points_Per_Minute__c, aos__Points_Per_Minute__c__is_set);
    __typeMapper.writeString(__out, aos__Type__c__typeInfo, aos__Type__c, aos__Type__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, aos__Ignore_Time__c__typeInfo)) {
      setAos__Ignore_Time__c((java.lang.Boolean)__typeMapper.readObject(__in, aos__Ignore_Time__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, aos__Points_Per_Hour__c__typeInfo)) {
      setAos__Points_Per_Hour__c((java.lang.Double)__typeMapper.readObject(__in, aos__Points_Per_Hour__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, aos__Points_Per_Minute__c__typeInfo)) {
      setAos__Points_Per_Minute__c((java.lang.Double)__typeMapper.readObject(__in, aos__Points_Per_Minute__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, aos__Type__c__typeInfo)) {
      setAos__Type__c((java.lang.String)__typeMapper.readString(__in, aos__Type__c__typeInfo, java.lang.String.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Aos__Optimized_Activity__c ");
    ...
    sb.append(" aos__Ignore_Time__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(aos__Ignore_Time__c)+"'\n");
    sb.append(" aos__Points_Per_Hour__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(aos__Points_Per_Hour__c)+"'\n");
    sb.append(" aos__Points_Per_Minute__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(aos__Points_Per_Minute__c)+"'\n");
    sb.append(" aos__Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(aos__Type__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
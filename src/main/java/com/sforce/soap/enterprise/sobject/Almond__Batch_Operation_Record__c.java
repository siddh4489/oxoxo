 ...
 */
public class Almond__Batch_Operation_Record__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__Batch_Operation_Record__c() {
  }
  ...
  /**
   * element  : almond__Record_Key__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Record_Key__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Record_Key__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean almond__Record_Key__c__is_set = false;

  private java.lang.String almond__Record_Key__c;

  public java.lang.String getAlmond__Record_Key__c() {
    return almond__Record_Key__c;
  }

  

  public void setAlmond__Record_Key__c(java.lang.String almond__Record_Key__c) {
    this.almond__Record_Key__c = almond__Record_Key__c;
    almond__Record_Key__c__is_set = true;
  }
  
  /**
   * element  : almond__Record_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Record_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Record_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean almond__Record_Type__c__is_set = false;

  private java.lang.String almond__Record_Type__c;

  public java.lang.String getAlmond__Record_Type__c() {
    return almond__Record_Type__c;
  }

  

  public void setAlmond__Record_Type__c(java.lang.String almond__Record_Type__c) {
    this.almond__Record_Type__c = almond__Record_Type__c;
    almond__Record_Type__c__is_set = true;
  }
  
  /**
   * element  : almond__Training_Plan_Batch_Operation__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Training_Plan_Batch_Operation__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Training_Plan_Batch_Operation__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean almond__Training_Plan_Batch_Operation__c__is_set = false;

  private java.lang.String almond__Training_Plan_Batch_Operation__c;

  public java.lang.String getAlmond__Training_Plan_Batch_Operation__c() {
    return almond__Training_Plan_Batch_Operation__c;
  }

  

  public void setAlmond__Training_Plan_Batch_Operation__c(java.lang.String almond__Training_Plan_Batch_Operation__c) {
    this.almond__Training_Plan_Batch_Operation__c = almond__Training_Plan_Batch_Operation__c;
    almond__Training_Plan_Batch_Operation__c__is_set = true;
  }
  
  /**
   * element  : almond__Training_Plan_Batch_Operation__r of type {urn:sobject.enterprise.soap.sforce.com}almond__Training_Plan_Batch_Operation__c
   * java type: com.sforce.soap.enterprise.sobject.Almond__Training_Plan_Batch_Operation__c
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Training_Plan_Batch_Operation__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Training_Plan_Batch_Operation__r","urn:sobject.enterprise.soap.sforce.com","almond__Training_Plan_Batch_Operation__c",0,1,true);

  private boolean almond__Training_Plan_Batch_Operation__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Almond__Training_Plan_Batch_Operation__c almond__Training_Plan_Batch_Operation__r;

  public com.sforce.soap.enterprise.sobject.Almond__Training_Plan_Batch_Operation__c getAlmond__Training_Plan_Batch_Operation__r() {
    return almond__Training_Plan_Batch_Operation__r;
  }

  

  public void setAlmond__Training_Plan_Batch_Operation__r(com.sforce.soap.enterprise.sobject.Almond__Training_Plan_Batch_Operation__c almond__Training_Plan_Batch_Operation__r) {
    this.almond__Training_Plan_Batch_Operation__r = almond__Training_Plan_Batch_Operation__r;
    almond__Training_Plan_Batch_Operation__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__Batch_Operation_Record__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, almond__Record_Key__c__typeInfo, almond__Record_Key__c, almond__Record_Key__c__is_set);
    __typeMapper.writeString(__out, almond__Record_Type__c__typeInfo, almond__Record_Type__c, almond__Record_Type__c__is_set);
    __typeMapper.writeString(__out, almond__Training_Plan_Batch_Operation__c__typeInfo, almond__Training_Plan_Batch_Operation__c, almond__Training_Plan_Batch_Operation__c__is_set);
    __typeMapper.writeObject(__out, almond__Training_Plan_Batch_Operation__r__typeInfo, almond__Training_Plan_Batch_Operation__r, almond__Training_Plan_Batch_Operation__r__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Record_Key__c__typeInfo)) {
      setAlmond__Record_Key__c((java.lang.String)__typeMapper.readString(__in, almond__Record_Key__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Record_Type__c__typeInfo)) {
      setAlmond__Record_Type__c((java.lang.String)__typeMapper.readString(__in, almond__Record_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Training_Plan_Batch_Operation__c__typeInfo)) {
      setAlmond__Training_Plan_Batch_Operation__c((java.lang.String)__typeMapper.readString(__in, almond__Training_Plan_Batch_Operation__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Training_Plan_Batch_Operation__r__typeInfo)) {
      setAlmond__Training_Plan_Batch_Operation__r((com.sforce.soap.enterprise.sobject.Almond__Training_Plan_Batch_Operation__c)__typeMapper.readObject(__in, almond__Training_Plan_Batch_Operation__r__typeInfo, com.sforce.soap.enterprise.sobject.Almond__Training_Plan_Batch_Operation__c.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Almond__Batch_Operation_Record__c ");
    ...
    sb.append(" almond__Record_Key__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Record_Key__c)+"'\n");
    sb.append(" almond__Record_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Record_Type__c)+"'\n");
    sb.append(" almond__Training_Plan_Batch_Operation__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Training_Plan_Batch_Operation__c)+"'\n");
    sb.append(" almond__Training_Plan_Batch_Operation__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Training_Plan_Batch_Operation__r)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
 ...
 */
public class SocialPostShare extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : Parent of type {urn:sobject.enterprise.soap.sforce.com}SocialPost
   * java type: com.sforce.soap.enterprise.sobject.SocialPost
   */
  private static final com.sforce.ws.bind.TypeInfo Parent__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Parent","urn:sobject.enterprise.soap.sforce.com","SocialPost",0,1,true);
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "SocialPostShare");
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Parent__typeInfo)) {
      setParent((com.sforce.soap.enterprise.sobject.SocialPost)__typeMapper.readObject(__in, Parent__typeInfo, com.sforce.soap.enterprise.sobject.SocialPost.class));
    }
    __in.peekTag();

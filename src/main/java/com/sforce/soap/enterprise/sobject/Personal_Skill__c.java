 ...
 */
public class Personal_Skill__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Personal_Skill__c() {
  }
  ...
  /**
   * element  : Skill_Name__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Skill_Name__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Skill_Name__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Skill_Name__c__is_set = false;

  private java.lang.String Skill_Name__c;

  public java.lang.String getSkill_Name__c() {
    return Skill_Name__c;
  }

  

  public void setSkill_Name__c(java.lang.String Skill_Name__c) {
    this.Skill_Name__c = Skill_Name__c;
    Skill_Name__c__is_set = true;
  }
  
  /**
   * element  : Skill__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Skill__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Skill__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean Skill__c__is_set = false;

  private java.lang.String Skill__c;

  public java.lang.String getSkill__c() {
    return Skill__c;
  }

  

  public void setSkill__c(java.lang.String Skill__c) {
    this.Skill__c = Skill__c;
    Skill__c__is_set = true;
  }
  
  /**
   * element  : Skill__r of type {urn:sobject.enterprise.soap.sforce.com}Trade_Skill__c
   * java type: com.sforce.soap.enterprise.sobject.Trade_Skill__c
   */
  private static final com.sforce.ws.bind.TypeInfo Skill__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Skill__r","urn:sobject.enterprise.soap.sforce.com","Trade_Skill__c",0,1,true);

  private boolean Skill__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Trade_Skill__c Skill__r;

  public com.sforce.soap.enterprise.sobject.Trade_Skill__c getSkill__r() {
    return Skill__r;
  }

  

  public void setSkill__r(com.sforce.soap.enterprise.sobject.Trade_Skill__c Skill__r) {
    this.Skill__r = Skill__r;
    Skill__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Personal_Skill__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, Skill_Name__c__typeInfo, Skill_Name__c, Skill_Name__c__is_set);
    __typeMapper.writeString(__out, Skill__c__typeInfo, Skill__c, Skill__c__is_set);
    __typeMapper.writeObject(__out, Skill__r__typeInfo, Skill__r, Skill__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Skill_Name__c__typeInfo)) {
      setSkill_Name__c((java.lang.String)__typeMapper.readString(__in, Skill_Name__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Skill__c__typeInfo)) {
      setSkill__c((java.lang.String)__typeMapper.readString(__in, Skill__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Skill__r__typeInfo)) {
      setSkill__r((com.sforce.soap.enterprise.sobject.Trade_Skill__c)__typeMapper.readObject(__in, Skill__r__typeInfo, com.sforce.soap.enterprise.sobject.Trade_Skill__c.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Skill_Name__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Skill_Name__c)+"'\n");
    sb.append(" Skill__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Skill__c)+"'\n");
    sb.append(" Skill__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Skill__r)+"'\n");

 ...
 */
public class Safety_Training__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Safety_Training__c() {
  }
    
  
  /**
   * element  : Action_Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Action_Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Action_Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Action_Type__c__is_set = false;

  private java.lang.String Action_Type__c;

  public java.lang.String getAction_Type__c() {
    return Action_Type__c;
  }

  

  public void setAction_Type__c(java.lang.String Action_Type__c) {
    this.Action_Type__c = Action_Type__c;
    Action_Type__c__is_set = true;
  }
  ...
  /**
   * element  : Date_Completed__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_Completed__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_Completed__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Date_Completed__c__is_set = false;

  private java.util.Calendar Date_Completed__c;

  public java.util.Calendar getDate_Completed__c() {
    return Date_Completed__c;
  }

  

  public void setDate_Completed__c(java.util.Calendar Date_Completed__c) {
    this.Date_Completed__c = Date_Completed__c;
    Date_Completed__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Safety_Training__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeString(__out, Action_Type__c__typeInfo, Action_Type__c, Action_Type__c__is_set);
    ...
    __typeMapper.writeObject(__out, Date_Completed__c__typeInfo, Date_Completed__c, Date_Completed__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, Action_Type__c__typeInfo)) {
      setAction_Type__c((java.lang.String)__typeMapper.readString(__in, Action_Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_Completed__c__typeInfo)) {
      setDate_Completed__c((java.util.Calendar)__typeMapper.readObject(__in, Date_Completed__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Safety_Training__c ");
    sb.append(super.toString());
    sb.append(" Action_Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Action_Type__c)+"'\n");
    ...
    sb.append(" Date_Completed__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_Completed__c)+"'\n");

 ...
 */
public class SFDC_Salary_History__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public SFDC_Salary_History__c() {
  }
    
  
  /**
   * element  : Annual_OTE__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Annual_OTE__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Annual_OTE__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Annual_OTE__c__is_set = false;

  private java.lang.Double Annual_OTE__c;

  public java.lang.Double getAnnual_OTE__c() {
    return Annual_OTE__c;
  }

  

  public void setAnnual_OTE__c(java.lang.Double Annual_OTE__c) {
    this.Annual_OTE__c = Annual_OTE__c;
    Annual_OTE__c__is_set = true;
  }
  ...
  /**
   * element  : Base_Salary__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Base_Salary__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Base_Salary__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Base_Salary__c__is_set = false;

  private java.lang.Double Base_Salary__c;

  public java.lang.Double getBase_Salary__c() {
    return Base_Salary__c;
  }

  

  public void setBase_Salary__c(java.lang.Double Base_Salary__c) {
    this.Base_Salary__c = Base_Salary__c;
    Base_Salary__c__is_set = true;
  }
  ...
  /**
   * element  : Quarterly_Bonus__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Quarterly_Bonus__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Quarterly_Bonus__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Quarterly_Bonus__c__is_set = false;

  private java.lang.Double Quarterly_Bonus__c;

  public java.lang.Double getQuarterly_Bonus__c() {
    return Quarterly_Bonus__c;
  }

  

  public void setQuarterly_Bonus__c(java.lang.Double Quarterly_Bonus__c) {
    this.Quarterly_Bonus__c = Quarterly_Bonus__c;
    Quarterly_Bonus__c__is_set = true;
  }
  ...
  /**
   * element  : Salary_End_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Salary_End_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Salary_End_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Salary_End_Date__c__is_set = false;

  private java.util.Calendar Salary_End_Date__c;

  public java.util.Calendar getSalary_End_Date__c() {
    return Salary_End_Date__c;
  }

  

  public void setSalary_End_Date__c(java.util.Calendar Salary_End_Date__c) {
    this.Salary_End_Date__c = Salary_End_Date__c;
    Salary_End_Date__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "SFDC_Salary_History__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeObject(__out, Annual_OTE__c__typeInfo, Annual_OTE__c, Annual_OTE__c__is_set);
    ...
    __typeMapper.writeObject(__out, Base_Salary__c__typeInfo, Base_Salary__c, Base_Salary__c__is_set);
    ...
    __typeMapper.writeObject(__out, Quarterly_Bonus__c__typeInfo, Quarterly_Bonus__c, Quarterly_Bonus__c__is_set);
    __typeMapper.writeObject(__out, RecordAssociatedGroups__typeInfo, RecordAssociatedGroups, RecordAssociatedGroups__is_set);
    __typeMapper.writeObject(__out, Salary_End_Date__c__typeInfo, Salary_End_Date__c, Salary_End_Date__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, Annual_OTE__c__typeInfo)) {
      setAnnual_OTE__c((java.lang.Double)__typeMapper.readObject(__in, Annual_OTE__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Base_Salary__c__typeInfo)) {
      setBase_Salary__c((java.lang.Double)__typeMapper.readObject(__in, Base_Salary__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Quarterly_Bonus__c__typeInfo)) {
      setQuarterly_Bonus__c((java.lang.Double)__typeMapper.readObject(__in, Quarterly_Bonus__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Salary_End_Date__c__typeInfo)) {
      setSalary_End_Date__c((java.util.Calendar)__typeMapper.readObject(__in, Salary_End_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[SFDC_Salary_History__c ");
    sb.append(super.toString());
    sb.append(" Annual_OTE__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Annual_OTE__c)+"'\n");
    ...
    sb.append(" Base_Salary__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Base_Salary__c)+"'\n");
    ...
    sb.append(" Quarterly_Bonus__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Quarterly_Bonus__c)+"'\n");
    sb.append(" RecordAssociatedGroups=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(RecordAssociatedGroups)+"'\n");
    sb.append(" Salary_End_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Salary_End_Date__c)+"'\n");

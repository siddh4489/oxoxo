 ...
 */
public class ContentFolderMember extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  ...
  /**
   * element  : ChildRecord of type {urn:sobject.enterprise.soap.sforce.com}ContentDocument
   * java type: com.sforce.soap.enterprise.sobject.ContentDocument
   */
  private static final com.sforce.ws.bind.TypeInfo ChildRecord__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ChildRecord","urn:sobject.enterprise.soap.sforce.com","ContentDocument",0,1,true);

  private boolean ChildRecord__is_set = false;
  ...
  public void setChildRecord(com.sforce.soap.enterprise.sobject.ContentDocument ChildRecord) {
    ...
    ChildRecord__is_set = true;
  }
  
  /**
   * element  : ChildRecordId of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo ChildRecordId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ChildRecordId","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean ChildRecordId__is_set = false;
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "ContentFolderMember");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeObject(__out, ChildRecord__typeInfo, ChildRecord, ChildRecord__is_set);
    __typeMapper.writeString(__out, ChildRecordId__typeInfo, ChildRecordId, ChildRecordId__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, ChildRecord__typeInfo)) {
      setChildRecord((com.sforce.soap.enterprise.sobject.ContentDocument)__typeMapper.readObject(__in, ChildRecord__typeInfo, com.sforce.soap.enterprise.sobject.ContentDocument.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, ChildRecordId__typeInfo)) {
      setChildRecordId((java.lang.String)__typeMapper.readString(__in, ChildRecordId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[ContentFolderMember ");
    sb.append(super.toString());
    sb.append(" ChildRecord=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ChildRecord)+"'\n");
    sb.append(" ChildRecordId=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ChildRecordId)+"'\n");
    sb.append(" CreatedBy=");

...
public class MacroInstruction extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  private static final com.sforce.ws.bind.TypeInfo Target__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Target","http://www.w3.org/2001/XMLSchema","string",0,1,true);
   ...
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo ValueRecord__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ValueRecord","http://www.w3.org/2001/XMLSchema","string",0,1,true);
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeString(__out, ValueRecord__typeInfo, ValueRecord, ValueRecord__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Target__typeInfo)) {
      setTarget((java.lang.String)__typeMapper.readString(__in, Target__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, ValueRecord__typeInfo)) {
      setValueRecord((java.lang.String)__typeMapper.readString(__in, ValueRecord__typeInfo, java.lang.String.class));
    }
  }
  ...
  public String toString() {
    ...
    sb.append(" Target=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Target)+"'\n");
    ...
    sb.append(" ValueRecord=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(ValueRecord)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
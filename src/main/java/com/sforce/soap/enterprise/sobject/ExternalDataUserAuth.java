...
public class ExternalDataUserAuth extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  /**
   * element  : ExternalDataSource of type {urn:sobject.enterprise.soap.sforce.com}Name
   * java type: com.sforce.soap.enterprise.sobject.Name
   */
  private static final com.sforce.ws.bind.TypeInfo ExternalDataSource__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","ExternalDataSource","urn:sobject.enterprise.soap.sforce.com","Name",0,1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, ExternalDataSource__typeInfo)) {
      setExternalDataSource((com.sforce.soap.enterprise.sobject.Name)__typeMapper.readObject(__in, ExternalDataSource__typeInfo, com.sforce.soap.enterprise.sobject.Name.class));
    }
    __in.peekTag();

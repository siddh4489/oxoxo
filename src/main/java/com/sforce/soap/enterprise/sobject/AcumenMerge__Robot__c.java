 ...
 */
public class AcumenMerge__Robot__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public AcumenMerge__Robot__c() {
  }
    
  
  /**
   * element  : AcumenMerge__Cost__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__Cost__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Cost__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean AcumenMerge__Cost__c__is_set = false;

  private java.lang.Double AcumenMerge__Cost__c;

  public java.lang.Double getAcumenMerge__Cost__c() {
    return AcumenMerge__Cost__c;
  }

  

  public void setAcumenMerge__Cost__c(java.lang.Double AcumenMerge__Cost__c) {
    this.AcumenMerge__Cost__c = AcumenMerge__Cost__c;
    AcumenMerge__Cost__c__is_set = true;
  }
  
  /**
   * element  : AcumenMerge__Mobility__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__Mobility__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Mobility__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean AcumenMerge__Mobility__c__is_set = false;

  private java.lang.String AcumenMerge__Mobility__c;

  public java.lang.String getAcumenMerge__Mobility__c() {
    return AcumenMerge__Mobility__c;
  }

  

  public void setAcumenMerge__Mobility__c(java.lang.String AcumenMerge__Mobility__c) {
    this.AcumenMerge__Mobility__c = AcumenMerge__Mobility__c;
    AcumenMerge__Mobility__c__is_set = true;
  }
  
  /**
   * element  : AcumenMerge__Number__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__Number__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Number__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean AcumenMerge__Number__c__is_set = false;

  private java.lang.Double AcumenMerge__Number__c;

  public java.lang.Double getAcumenMerge__Number__c() {
    return AcumenMerge__Number__c;
  }

  

  public void setAcumenMerge__Number__c(java.lang.Double AcumenMerge__Number__c) {
    this.AcumenMerge__Number__c = AcumenMerge__Number__c;
    AcumenMerge__Number__c__is_set = true;
  }
  
  /**
   * element  : AcumenMerge__Parent_Company__c of type {urn:enterprise.soap.sforce.com}ID
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__Parent_Company__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Parent_Company__c","urn:enterprise.soap.sforce.com","ID",0,1,true);

  private boolean AcumenMerge__Parent_Company__c__is_set = false;

  private java.lang.String AcumenMerge__Parent_Company__c;

  public java.lang.String getAcumenMerge__Parent_Company__c() {
    return AcumenMerge__Parent_Company__c;
  }

  

  public void setAcumenMerge__Parent_Company__c(java.lang.String AcumenMerge__Parent_Company__c) {
    this.AcumenMerge__Parent_Company__c = AcumenMerge__Parent_Company__c;
    AcumenMerge__Parent_Company__c__is_set = true;
  }
  
  /**
   * element  : AcumenMerge__Parent_Company__r of type {urn:sobject.enterprise.soap.sforce.com}Account
   * java type: com.sforce.soap.enterprise.sobject.Account
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__Parent_Company__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Parent_Company__r","urn:sobject.enterprise.soap.sforce.com","Account",0,1,true);

  private boolean AcumenMerge__Parent_Company__r__is_set = false;

  private com.sforce.soap.enterprise.sobject.Account AcumenMerge__Parent_Company__r;

  public com.sforce.soap.enterprise.sobject.Account getAcumenMerge__Parent_Company__r() {
    return AcumenMerge__Parent_Company__r;
  }

  

  public void setAcumenMerge__Parent_Company__r(com.sforce.soap.enterprise.sobject.Account AcumenMerge__Parent_Company__r) {
    this.AcumenMerge__Parent_Company__r = AcumenMerge__Parent_Company__r;
    AcumenMerge__Parent_Company__r__is_set = true;
  }
  
  /**
   * element  : AcumenMerge__Suppliers__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__Suppliers__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Suppliers__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean AcumenMerge__Suppliers__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult AcumenMerge__Suppliers__r;

  public com.sforce.soap.enterprise.QueryResult getAcumenMerge__Suppliers__r() {
    return AcumenMerge__Suppliers__r;
  }

  

  public void setAcumenMerge__Suppliers__r(com.sforce.soap.enterprise.QueryResult AcumenMerge__Suppliers__r) {
    this.AcumenMerge__Suppliers__r = AcumenMerge__Suppliers__r;
    AcumenMerge__Suppliers__r__is_set = true;
  }
  
  /**
   * element  : AcumenMerge__Type__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo AcumenMerge__Type__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","AcumenMerge__Type__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean AcumenMerge__Type__c__is_set = false;

  private java.lang.String AcumenMerge__Type__c;

  public java.lang.String getAcumenMerge__Type__c() {
    return AcumenMerge__Type__c;
  }

  

  public void setAcumenMerge__Type__c(java.lang.String AcumenMerge__Type__c) {
    this.AcumenMerge__Type__c = AcumenMerge__Type__c;
    AcumenMerge__Type__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "AcumenMerge__Robot__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    __typeMapper.writeObject(__out, AcumenMerge__Cost__c__typeInfo, AcumenMerge__Cost__c, AcumenMerge__Cost__c__is_set);
    __typeMapper.writeString(__out, AcumenMerge__Mobility__c__typeInfo, AcumenMerge__Mobility__c, AcumenMerge__Mobility__c__is_set);
    __typeMapper.writeObject(__out, AcumenMerge__Number__c__typeInfo, AcumenMerge__Number__c, AcumenMerge__Number__c__is_set);
    __typeMapper.writeString(__out, AcumenMerge__Parent_Company__c__typeInfo, AcumenMerge__Parent_Company__c, AcumenMerge__Parent_Company__c__is_set);
    __typeMapper.writeObject(__out, AcumenMerge__Parent_Company__r__typeInfo, AcumenMerge__Parent_Company__r, AcumenMerge__Parent_Company__r__is_set);
    __typeMapper.writeObject(__out, AcumenMerge__Suppliers__r__typeInfo, AcumenMerge__Suppliers__r, AcumenMerge__Suppliers__r__is_set);
    __typeMapper.writeString(__out, AcumenMerge__Type__c__typeInfo, AcumenMerge__Type__c, AcumenMerge__Type__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__Cost__c__typeInfo)) {
      setAcumenMerge__Cost__c((java.lang.Double)__typeMapper.readObject(__in, AcumenMerge__Cost__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__Mobility__c__typeInfo)) {
      setAcumenMerge__Mobility__c((java.lang.String)__typeMapper.readString(__in, AcumenMerge__Mobility__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__Number__c__typeInfo)) {
      setAcumenMerge__Number__c((java.lang.Double)__typeMapper.readObject(__in, AcumenMerge__Number__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__Parent_Company__c__typeInfo)) {
      setAcumenMerge__Parent_Company__c((java.lang.String)__typeMapper.readString(__in, AcumenMerge__Parent_Company__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__Parent_Company__r__typeInfo)) {
      setAcumenMerge__Parent_Company__r((com.sforce.soap.enterprise.sobject.Account)__typeMapper.readObject(__in, AcumenMerge__Parent_Company__r__typeInfo, com.sforce.soap.enterprise.sobject.Account.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__Suppliers__r__typeInfo)) {
      setAcumenMerge__Suppliers__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, AcumenMerge__Suppliers__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, AcumenMerge__Type__c__typeInfo)) {
      setAcumenMerge__Type__c((java.lang.String)__typeMapper.readString(__in, AcumenMerge__Type__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[AcumenMerge__Robot__c ");
    sb.append(super.toString());
    sb.append(" AcumenMerge__Cost__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__Cost__c)+"'\n");
    sb.append(" AcumenMerge__Mobility__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__Mobility__c)+"'\n");
    sb.append(" AcumenMerge__Number__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__Number__c)+"'\n");
    sb.append(" AcumenMerge__Parent_Company__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__Parent_Company__c)+"'\n");
    sb.append(" AcumenMerge__Parent_Company__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__Parent_Company__r)+"'\n");
    sb.append(" AcumenMerge__Suppliers__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__Suppliers__r)+"'\n");
    sb.append(" AcumenMerge__Type__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(AcumenMerge__Type__c)+"'\n");

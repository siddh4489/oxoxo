 ...
 */
public class Employment__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Employment__c() {
  }
  ...
  /**
   * element  : Contact__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Contact__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Contact__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);
  ...
  /**
   * element  : End_Date__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo End_Date__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","End_Date__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean End_Date__c__is_set = false;
  ...
  public void setEnd_Date__c(java.util.Calendar End_Date__c) {
    ...
    End_Date__c__is_set = true;
  }
  
  /**
   * element  : Ending_Pay__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Ending_Pay__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Ending_Pay__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Ending_Pay__c__is_set = false;

  private java.lang.Double Ending_Pay__c;

  public java.lang.Double getEnding_Pay__c() {
    return Ending_Pay__c;
  }

  

  public void setEnding_Pay__c(java.lang.Double Ending_Pay__c) {
    this.Ending_Pay__c = Ending_Pay__c;
    Ending_Pay__c__is_set = true;
  }
  ...
  /**
   * element  : Job_Title__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Job_Title__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Job_Title__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Job_Title__c__is_set = false;

  private java.lang.String Job_Title__c;

  public java.lang.String getJob_Title__c() {
    return Job_Title__c;
  }

  

  public void setJob_Title__c(java.lang.String Job_Title__c) {
    this.Job_Title__c = Job_Title__c;
    Job_Title__c__is_set = true;
  }
  ...
  /**
   * element  : Reason_for_Leaving__c of type {http://www.w3.org/2001/XMLSchema}string
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo Reason_for_Leaving__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Reason_for_Leaving__c","http://www.w3.org/2001/XMLSchema","string",0,1,true);

  private boolean Reason_for_Leaving__c__is_set = false;

  private java.lang.String Reason_for_Leaving__c;

  public java.lang.String getReason_for_Leaving__c() {
    return Reason_for_Leaving__c;
  }

  

  public void setReason_for_Leaving__c(java.lang.String Reason_for_Leaving__c) {
    this.Reason_for_Leaving__c = Reason_for_Leaving__c;
    Reason_for_Leaving__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Employment__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, End_Date__c__typeInfo, End_Date__c, End_Date__c__is_set);
    __typeMapper.writeObject(__out, Ending_Pay__c__typeInfo, Ending_Pay__c, Ending_Pay__c__is_set);
    ...
    __typeMapper.writeString(__out, Job_Title__c__typeInfo, Job_Title__c, Job_Title__c__is_set);
    ...
    __typeMapper.writeString(__out, Reason_for_Leaving__c__typeInfo, Reason_for_Leaving__c, Reason_for_Leaving__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, End_Date__c__typeInfo)) {
      setEnd_Date__c((java.util.Calendar)__typeMapper.readObject(__in, End_Date__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Ending_Pay__c__typeInfo)) {
      setEnding_Pay__c((java.lang.Double)__typeMapper.readObject(__in, Ending_Pay__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Job_Title__c__typeInfo)) {
      setJob_Title__c((java.lang.String)__typeMapper.readString(__in, Job_Title__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    if (__typeMapper.isElement(__in, Phone__c__typeInfo)) {
      setPhone__c((java.lang.String)__typeMapper.readString(__in, Phone__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Reason_for_Leaving__c__typeInfo)) {
      setReason_for_Leaving__c((java.lang.String)__typeMapper.readString(__in, Reason_for_Leaving__c__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" End_Date__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(End_Date__c)+"'\n");
    sb.append(" Ending_Pay__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Ending_Pay__c)+"'\n");
    ...
    sb.append(" Job_Title__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Job_Title__c)+"'\n");
    ...
    sb.append(" Reason_for_Leaving__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Reason_for_Leaving__c)+"'\n");

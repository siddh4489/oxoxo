 ...
 */
public class Medical_Bills_Paid__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Medical_Bills_Paid__c() {
  }
  ...
  /**
   * element  : Date_Paid__c of type {http://www.w3.org/2001/XMLSchema}date
   * java type: java.util.Calendar
   */
  private static final com.sforce.ws.bind.TypeInfo Date_Paid__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Date_Paid__c","http://www.w3.org/2001/XMLSchema","date",0,1,true);

  private boolean Date_Paid__c__is_set = false;

  private java.util.Calendar Date_Paid__c;

  public java.util.Calendar getDate_Paid__c() {
    return Date_Paid__c;
  }

  

  public void setDate_Paid__c(java.util.Calendar Date_Paid__c) {
    this.Date_Paid__c = Date_Paid__c;
    Date_Paid__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Medical_Bills_Paid__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Date_Paid__c__typeInfo, Date_Paid__c, Date_Paid__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Date_Paid__c__typeInfo)) {
      setDate_Paid__c((java.util.Calendar)__typeMapper.readObject(__in, Date_Paid__c__typeInfo, java.util.Calendar.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("[Medical_Bills_Paid__c ");
    ...
    sb.append(" Date_Paid__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Date_Paid__c)+"'\n");

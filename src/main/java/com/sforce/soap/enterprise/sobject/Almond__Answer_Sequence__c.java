 ...
 */
public class Almond__Answer_Sequence__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Almond__Answer_Sequence__c() {
  }
  ...
  /**
   * element  : almond__Answer_Sequence_Items__r of type {urn:enterprise.soap.sforce.com}QueryResult
   * java type: com.sforce.soap.enterprise.QueryResult
   */
  private static final com.sforce.ws.bind.TypeInfo almond__Answer_Sequence_Items__r__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","almond__Answer_Sequence_Items__r","urn:enterprise.soap.sforce.com","QueryResult",0,1,true);

  private boolean almond__Answer_Sequence_Items__r__is_set = false;

  private com.sforce.soap.enterprise.QueryResult almond__Answer_Sequence_Items__r;

  public com.sforce.soap.enterprise.QueryResult getAlmond__Answer_Sequence_Items__r() {
    return almond__Answer_Sequence_Items__r;
  }

  

  public void setAlmond__Answer_Sequence_Items__r(com.sforce.soap.enterprise.QueryResult almond__Answer_Sequence_Items__r) {
    this.almond__Answer_Sequence_Items__r = almond__Answer_Sequence_Items__r;
    almond__Answer_Sequence_Items__r__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "almond__Answer_Sequence__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, almond__Answer_Sequence_Items__r__typeInfo, almond__Answer_Sequence_Items__r, almond__Answer_Sequence_Items__r__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, almond__Answer_Sequence_Items__r__typeInfo)) {
      setAlmond__Answer_Sequence_Items__r((com.sforce.soap.enterprise.QueryResult)__typeMapper.readObject(__in, almond__Answer_Sequence_Items__r__typeInfo, com.sforce.soap.enterprise.QueryResult.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" almond__Answer_Sequence_Items__r=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(almond__Answer_Sequence_Items__r)+"'\n");

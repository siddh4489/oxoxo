 ...
 */
public class Recruiting_Order__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Recruiting_Order__c() {
  }
  ...
  /**
   * element  : Number_Filled__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Number_Filled__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Number_Filled__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Number_Filled__c__is_set = false;

  private java.lang.Double Number_Filled__c;

  public java.lang.Double getNumber_Filled__c() {
    return Number_Filled__c;
  }

  

  public void setNumber_Filled__c(java.lang.Double Number_Filled__c) {
    this.Number_Filled__c = Number_Filled__c;
    Number_Filled__c__is_set = true;
  }
  
  /**
   * element  : Number_Requested__c of type {http://www.w3.org/2001/XMLSchema}double
   * java type: java.lang.Double
   */
  private static final com.sforce.ws.bind.TypeInfo Number_Requested__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","Number_Requested__c","http://www.w3.org/2001/XMLSchema","double",0,1,true);

  private boolean Number_Requested__c__is_set = false;

  private java.lang.Double Number_Requested__c;

  public java.lang.Double getNumber_Requested__c() {
    return Number_Requested__c;
  }

  

  public void setNumber_Requested__c(java.lang.Double Number_Requested__c) {
    this.Number_Requested__c = Number_Requested__c;
    Number_Requested__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "Recruiting_Order__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, Number_Filled__c__typeInfo, Number_Filled__c, Number_Filled__c__is_set);
    __typeMapper.writeObject(__out, Number_Requested__c__typeInfo, Number_Requested__c, Number_Requested__c__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, Number_Filled__c__typeInfo)) {
      setNumber_Filled__c((java.lang.Double)__typeMapper.readObject(__in, Number_Filled__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, Number_Requested__c__typeInfo)) {
      setNumber_Requested__c((java.lang.Double)__typeMapper.readObject(__in, Number_Requested__c__typeInfo, java.lang.Double.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Number_Filled__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Number_Filled__c)+"'\n");
    sb.append(" Number_Requested__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Number_Requested__c)+"'\n");

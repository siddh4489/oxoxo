...
public class Product2 extends com.sforce.soap.enterprise.sobject.SObject {
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    if (__typeMapper.isElement(__in, Family__typeInfo)) {
      setFamily((java.lang.String)__typeMapper.readString(__in, Family__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append(" Family=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(Family)+"'\n");
    ...
    sb.append(" PricebookEntries=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(PricebookEntries)+"'\n");

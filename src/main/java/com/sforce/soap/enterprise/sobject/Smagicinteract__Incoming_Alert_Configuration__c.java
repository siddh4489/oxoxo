 ...
 */
public class Smagicinteract__Incoming_Alert_Configuration__c extends com.sforce.soap.enterprise.sobject.SObject {
  /**
   * Constructor
   */
  public Smagicinteract__Incoming_Alert_Configuration__c() {
  }
  ...
  /**
   * element  : smagicinteract__isCustomize__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo smagicinteract__isCustomize__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","smagicinteract__isCustomize__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean smagicinteract__isCustomize__c__is_set = false;

  private java.lang.Boolean smagicinteract__isCustomize__c;

  public java.lang.Boolean getSmagicinteract__isCustomize__c() {
    return smagicinteract__isCustomize__c;
  }

  

  public void setSmagicinteract__isCustomize__c(java.lang.Boolean smagicinteract__isCustomize__c) {
    this.smagicinteract__isCustomize__c = smagicinteract__isCustomize__c;
    smagicinteract__isCustomize__c__is_set = true;
  }
  
  /**
   * element  : smagicinteract__isDisable__c of type {http://www.w3.org/2001/XMLSchema}boolean
   * java type: java.lang.Boolean
   */
  private static final com.sforce.ws.bind.TypeInfo smagicinteract__isDisable__c__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:sobject.enterprise.soap.sforce.com","smagicinteract__isDisable__c","http://www.w3.org/2001/XMLSchema","boolean",0,1,true);

  private boolean smagicinteract__isDisable__c__is_set = false;

  private java.lang.Boolean smagicinteract__isDisable__c;

  public java.lang.Boolean getSmagicinteract__isDisable__c() {
    return smagicinteract__isDisable__c;
  }

  

  public void setSmagicinteract__isDisable__c(java.lang.Boolean smagicinteract__isDisable__c) {
    this.smagicinteract__isDisable__c = smagicinteract__isDisable__c;
    smagicinteract__isDisable__c__is_set = true;
  }
  ...
  public void write(javax.xml.namespace.QName __element,
    ...
    __typeMapper.writeXsiType(__out, "urn:sobject.enterprise.soap.sforce.com", "smagicinteract__Incoming_Alert_Configuration__c");
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
   ...
   super.writeFields(__out, __typeMapper);
    ...
    __typeMapper.writeObject(__out, smagicinteract__isCustomize__c__typeInfo, smagicinteract__isCustomize__c, smagicinteract__isCustomize__c__is_set);
    __typeMapper.writeObject(__out, smagicinteract__isDisable__c__typeInfo, smagicinteract__isDisable__c, smagicinteract__isDisable__c__is_set);
  }
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
   ...
   super.loadFields(__in, __typeMapper);
    ...
    __in.peekTag();
    if (__typeMapper.isElement(__in, smagicinteract__isCustomize__c__typeInfo)) {
      setSmagicinteract__isCustomize__c((java.lang.Boolean)__typeMapper.readObject(__in, smagicinteract__isCustomize__c__typeInfo, java.lang.Boolean.class));
    }
    __in.peekTag();
    if (__typeMapper.isElement(__in, smagicinteract__isDisable__c__typeInfo)) {
      setSmagicinteract__isDisable__c((java.lang.Boolean)__typeMapper.readObject(__in, smagicinteract__isDisable__c__typeInfo, java.lang.Boolean.class));
    }
  }

  public String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder();
    sb.append("[Smagicinteract__Incoming_Alert_Configuration__c ");
    ...
    sb.append(" smagicinteract__isCustomize__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(smagicinteract__isCustomize__c)+"'\n");
    sb.append(" smagicinteract__isDisable__c=");
    sb.append("'"+com.sforce.ws.util.Verbose.toString(smagicinteract__isDisable__c)+"'\n");
    sb.append("]\n");
    return sb.toString();
  }
}
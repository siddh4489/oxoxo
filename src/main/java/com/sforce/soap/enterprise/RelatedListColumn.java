...
public class RelatedListColumn implements com.sforce.ws.bind.XMLizable {
   ...
   * java type: java.lang.String
   */
  private static final com.sforce.ws.bind.TypeInfo fieldApiName__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","fieldApiName","http://www.w3.org/2001/XMLSchema","string",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo format__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","format","http://www.w3.org/2001/XMLSchema","string",1,1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo lookupId__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","lookupId","http://www.w3.org/2001/XMLSchema","string",0,1,true);
  ...
  protected void writeFields(com.sforce.ws.parser.XmlOutputStream __out,
    ...
    __typeMapper.writeString(__out, fieldApiName__typeInfo, fieldApiName, fieldApiName__is_set);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    __in.peekTag();
    if (__typeMapper.verifyElement(__in, fieldApiName__typeInfo)) {
      setFieldApiName((java.lang.String)__typeMapper.readString(__in, fieldApiName__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
    ...
    if (__typeMapper.isElement(__in, lookupId__typeInfo)) {
      setLookupId((java.lang.String)__typeMapper.readString(__in, lookupId__typeInfo, java.lang.String.class));
    }
    __in.peekTag();
  ...
  public String toString() {
    ...
    sb.append("'"+com.sforce.ws.util.Verbose.toString(fieldApiName)+"'\n");
    sb.append(" format=");

...
public class DescribeDataCategoryGroupStructures_element implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo pairs__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","pairs","urn:enterprise.soap.sforce.com","DataCategoryGroupSobjectTypePair",0,100,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo topCategoriesOnly__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","topCategoriesOnly","http://www.w3.org/2001/XMLSchema","boolean",1,1,true);
  ...
  protected void loadFields(com.sforce.ws.parser.XmlInputStream __in,
    ...
    if (__typeMapper.isElement(__in, pairs__typeInfo)) {
      setPairs((com.sforce.soap.enterprise.DataCategoryGroupSobjectTypePair[])__typeMapper.readObject(__in, pairs__typeInfo, com.sforce.soap.enterprise.DataCategoryGroupSobjectTypePair[].class));
    }
    __in.peekTag();

...
public class MergeResult implements com.sforce.ws.bind.XMLizable {
  ...
  private static final com.sforce.ws.bind.TypeInfo mergedRecordIds__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","mergedRecordIds","urn:enterprise.soap.sforce.com","ID",0,-1,true);
  ...
  private static final com.sforce.ws.bind.TypeInfo updatedRelatedIds__typeInfo =
    new com.sforce.ws.bind.TypeInfo("urn:enterprise.soap.sforce.com","updatedRelatedIds","urn:enterprise.soap.sforce.com","ID",0,-1,true);
